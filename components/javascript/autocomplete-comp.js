...
class ZcatAutocomplete extends _node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_1__.Component {
  ...
  static methods(arg1) {
    return Object.assign(super.methods({
      onSearchInput(event, lyteElement) {
        let val = lyteElement ? lyteElement.getData('value') : '';
      ...
      onSearchFocus(event, lyteElement) {
        let zcatProp = this.getData('zcatProp');
