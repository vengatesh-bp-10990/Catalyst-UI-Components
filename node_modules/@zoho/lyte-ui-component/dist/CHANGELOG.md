...
## [4.8.0](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/compare/V3_7_X...V3_8_X) (2025-12-01)

### Bug Fixes

*  Issue in scope of closing modal when multiple modals getting closed at once ([b5a9fc54f](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/b5a9fc54f))
*  default z index for first modal from js removed ([999b7e8a9](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/999b7e8a9))
*  Auto align issue fix ([ab7d185bb](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/ab7d185bb))
*  Trapfocus before transition end causing issue fix ([fd95ce460](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/fd95ce460))
*  undefined check for offset object added ([f686c8541](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/f686c8541))
*  scope of variable in for issue fix ([359acdcf7](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/359acdcf7))
*  undefined check for ltPropOffset added ([f52939654](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/f52939654))
*  trapFocus issue fix ([200e5f5b2](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/200e5f5b2))
* **lyte progressbar**:   Circle progressbar focus height issue when navigated through keyboard - fixed ([01c6ce71e](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/01c6ce71e))

### Refactoring

* **lyte connect**:   ltPropOriginPoint refactored ([787168ff69](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/787168ff69))
*  beta-modal v4 migration ([e2248cebb](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/e2248cebb))

### New Features

* **lyte connect**:   sequential flow branchIcon support provided ([1ff651053d](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/1ff651053d))
*  css variable for z index support ([d47d7df59](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/d47d7df59))
*  zIndex changed to css variable ([a95dfb812](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/a95dfb812))

### Migration

*  v3 migrate lyte-tabs ([1ccd38185](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/1ccd38185))



## 4.9.0 Version (2026-01-02)

### Bug Fixes

* **lyte accordion**:   Now clicking on accordion item will not throw error ([e8d91d361](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/e8d91d361))
* **lyte tooltip**:   wrong global variable declaration issue fix ([5feabfe63](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/5feabfe63))
*  now aria valuenow, max, min value will be set as numeric value ([f82e7fa60](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/f82e7fa60))
*  variable initiate fix ([852c39af6a](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/852c39af6aec5a440fcd2dc505b08578a436793d))
* **lyte slider**:   now aria valuenow, max, min value will be set as numeric value ([d32d2b7d2](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/d32d2b7d2))
*  trapFocus changed to default behaviour  ([fb89903b6](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/fb89903b6))
*  Trapfocus for multiple modal issue fix ([8d5a225c0](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/8d5a225c0))
* **lyte beta modal**:   Trapfocus added to document instead of modal wrapper ([43937ca0a](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/43937ca0a))

### Changes

* **build_js**:   Ui-components' source files will not be present in parent app's dist/ folder ([2a921cf7e](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/2a921cf7e))

### Removed

* **lyte tooltip**:   now tooltip will not set aria-expanded attribute( which is not needed for tooltip ) ([81ceba151](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/81ceba151))

### Dependency Updates

*  plugins version updated to 2.3.21 ([ecb1e71c8](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/ecb1e71c83cb77f5b8b8356257a02e91535e26b6))

### Style Changes

* **lyte tag**:   Sass file added ([0e239a432](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/0e239a4323e35d4902d016c896c7d1c1b7d2f8ee))
* **lyte fileupload**:   Sass file added ([db1b2c17f](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/db1b2c17f2ef4bedcabb8ea72d7234b7d81c7285))


## 4.10.0 Version (2026-02-02)

### Bug Fixes

* **lyte connect**:   resetSelected param fixed ([2cdcae5b9c](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/2cdcae5b9caa2ffd9317968d5560b0ea8ae17688))
*  trapFocus changed to default behaviour  ([fb89903b6](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/fb89903b6))
*  Trapfocus for multiple modal issue fix ([8d5a225c0](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/8d5a225c0))
*  Aria described by undefined issue fix ([6b7998976](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/6b79989762107343105abc81ccf59854af6fe54c))
*  Migrated beta popover latest master v3 to v4 ([fcefa9967](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/fcefa9967af3756f39f88d4f44d7a748d3a9b076))
*  _this undefined issue fix ([832217b77](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/832217b77f0021801ca595b63178101f804e8a72))
*  Added check for ariaKeyDown for close ([692eb32e7](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/692eb32e71a01be501653618f25a865ea88ff0da))
* **lyte beta modal**:   Trapfocus added to document instead of modal wrapper ([43937ca0a](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/43937ca0a))

### New Features

*  Added ltPropDragHandle property alone  ([fa48a409b](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/fa48a409b0da8c48b2953000beb665e3e8fa93e5))
*  Added ltPropOffsetForParent property alone  ([aa24a5ad4](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/aa24a5ad4fcb15d9e4d58a89ba268e805a184458))

### Dependency Updates

*  plugins version updated to 2.3.22 ([828d48417](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/828d484179f3e99b67f15c7a0c8fa88cdb794ee8))


## 4.11.0 Version (2026-03-03)

### New Features

* **lyte connect**:   updated with V3 ([bfc01883af](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/bfc01883afd550f47c73267e5077e295bb34e133))

### Bug Fixes

* **lyte connect**:   sequential dragelem Conn fix ([4446f31421](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/4446f314215b50172c4d3766d65f63c2f4b2e007))
* **lyte connect**:   sequential flow droppable animation fix ([07cf04d362](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/07cf04d362e3338e30b9b90a3e9830a8824960ad))
* **lyte connect**:   sequential preview update ,draggable and undo fixes ([4495236d8a](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/4495236d8a2fb8c9794d48fe8cfbd9e4e1882c3d))
* **lyte connect**:   sequentialflow preview update fix ([0b89d40e84](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/0b89d40e84fd6c3e093fcbd422077b5e08474e53))
* **lyte colorpicker**:   corrupted image files updated ([b50cf871e](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/b50cf871efc8fd10e1266ab67a879bad258eda21))
*  Resize splitter issue fix ([5d628cf61](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/5d628cf61965a1d7f7833875dacbe602577458a0))
*  This.$node changed to value from constructor param  ([a51777d5d](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/a51777d5df05ba6a0d7e3bb108800ffd3a65be25))
*  Changed the data type of the ltPropReOpen from string to boolean  ([25b536201](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/25b536201b4614e2009ed5a4afd0013c251cc395))
*  When ltPropSize for row or column element is given as 0 the remaining size calculation not getting set issue fixed ([35446fe93](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/35446fe9359b0c6a55cb984ff1d296a37faee398))
*  Changed actualModalDiv spelling issue in mutation observer ([713585610](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/713585610c71599dd92016488899a7b1c472e079))
*  Added css variable for beta modal freeze layer ([81c772f24](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/81c772f241da7a8ca1366d21a9d82d81740b8169))
*  Aria attribute issue fix ([78f399669](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/78f39966968751ea11928c51782a06159aa819a9))
*  Aria attribute issue fix ([8ee4d1103](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/8ee4d11031d8e65a6494e4d4a88d46e9dca76b79))
*  Added Aria attributes for dialogue and close icon ([5b409a81d](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/5b409a81d65304ec6c1043282952fe4b2b20c472))
*  ltPropAriaAttribute issue fix ([963a9071e](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/963a9071e719748df90cc7f06affdef40d03666e))
*  Aria role missing issue fix ([ffb2f161a](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/ffb2f161a36c5a47eac32227e2fe86bdd02822b9))
*  Role attributes added to popover ([565631318](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/565631318ae1a3ec6f83fe3b65df8282ad7d2148))

### Refactorings

* **lyte connect**:   sequential draggable ui update ([e0c189e245](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/e0c189e245611e9cc210ded445744a4dbecde676))

### Dependency Updates

*  plugins version updated to 2.3.23 ([9d2b9e0c2](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/9d2b9e0c28052dc80a4e82ce3cf8cba51c072225))
*  updated plugins version to 2.3.24 ([875bcd4c2](https://git.csez.zohocorpin.com/lyte.js/lyte-ui-component/commit/875bcd4c24ef953495af100a13f0c954a01f635b))
