"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-notification-center"],{

/***/ 5852862:
/*!***********************************************************!*\
  !*** ./components/javascript/lyte-notification-center.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteNotificationCenterComponent": () => (/* binding */ LyteNotificationCenterComponent)
/* harmony export */ });
...
/* harmony import */ var _node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/@slyte/component/index.js */ 26591616);
...
class LyteNotificationCenterComponent extends _node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			...
			* @default false
			*/
			ltPropShow: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: false }),
			/**
			 * @componentProperty {boolean} ltPropBindToBody
			 * @version 1.0.0
			 * @default false
			 */
			ltPropBindToBody: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: false }),
			/**
			 * @componentProperty {array} ltPropData
			 * @version 1.0.0
			 * @default []
			 */
			ltPropData: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', { default: [], watch: true }),
			/**
			 * @componentProperty {boolean} ltPropYield
			 * @version 1.0.0
			 * @default false
			 */
			ltPropYield: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)("boolean", { "default": false }),
			/**
			 * @componentProperty {string} ltPropDuration
			 * @version 1.0.0
			 * @default 10ms
			 */
			ltPropDuration: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string'),
			/**
			 * @componentProperty {boolean} ltPropCloseOnBodyClick
			 * @version 1.0.0
			 * @default false
			 */
			ltPropCloseOnBodyClick: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: false }),
			/**
			 * @componentProperty {object} ltPropActionBtn
			 * @version 1.0.0
			 * @default {}
			 */
			ltPropActionBtn: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object', { default: {} }),
			/**
			 * @componentProperty {boolean} ltPropShowWormhole
			 * @version 1.0.0
			 * @default false
			 */
			ltPropShowWormhole: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: false }),
			/**
			 * @componentProperty {array} notificationStackArr
			 * @version 1.0.0
			 * @default false
			 */
			notificationStackArr: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', { default: [], watch: true }),
			/**
			 * @componentProperty {boolean} ltPropShowPanel
			 * @version 1.0.0
			 * @default false
			 */
			ltPropShowPanel: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: false }),
			/**
			 * @componentProperty {boolean} ltPropDefaultState
			 * @version 1.0.0
			 * @default false
			 */
			ltPropDefaultState: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: 'close' }),
			/**
			 * @componentProperty {string} ltPropAnimation
			 * @version 1.0.0
			 * @default false
			 */
			ltPropAnimation: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', { default: 'fade' }),
			/**
			 * @componentProperty {string} ltPropWrapperClass
			 * @version 1.0.0
			 * @default false
			 */
			ltPropWrapperClass: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string'),
			/**
			 * @componentProperty {string} ltPropPosition
			 * @version 1.0.0
			 * @default false
			 */
			ltPropPosition: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', { default: "topRight" }),
			/**
			 * @componentProperty {boolean} timeoutActive
			 * @version 1.0.0
			 * @default false
			 */
			timeoutActive: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', { default: 'false' }),
		}), arg1);
	}

    didConnect() {
		this.setData('notificationStackArr', this.$addon.deepCopyObject(this.getData('ltPropData')));
        ...
        return Object.assign(super.actions({
            ...
            cancelAction: function (evt, _this, index) {
                ...
                if ($L(this.childComp).find('.lyteNotificationOpened')) {
                    (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(this.getData('ltPropData'), 'removeAt', index);
                }
            },
            ...
            clearClosedNotification: function (ele, _this, Arrindex, index) {
                ...
                new Promise((resolve) => {
                    ...
                    setTimeout(() => {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(data[Arrindex], 'removeAt', index, data.length);
                        if (nextSibling) {
            ...
            removeItem: async function (ele, _this, Arrindex, index) {
                ...
                try {
                    ...
                    (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(thisScope.getData('ltPropData')[Arrindex], 'removeAt', index);
                }
            },
            ...
            removePopItem: function (ele, _this, Arrindex, index) {
                ...
                (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(this.getData('notificationStackArr')[Arrindex], 'removeAt', index);
            ...
            cancelPopAction: function (ele, _this, Arrindex, index) {
                ...
                (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(this.getData('notificationStackArr'), 'replaceAt', Arrindex, [[]]);
            }
        }), arg1);
    }
    ...
    adjustParentHeight(parentNode, decrease) {
		parentNode.style.height = parentNode.getBoundingClientRect().height - decrease + 'px';
	}

    hideButtonWrapper(buttonWrapper, parentNode, decreseHeight) {
    ...
    handleSingleItem(parentNode, nextParentNode, decreseHeight) {
			...
			for (let i = 0; i < removeEle.length; i++) {
				setTimeout(() => {
					...
					setTimeout(() => {
						...
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(this.getData('ltPropData')[0], 'removeAt', i - j++);
					}, 300);
				}, i * 300);
			}
		}
        ...
        return Object.assign(super.observers({
            ...
            dataObserver: function (arg) {
                ...
                if (arg.insertedItems) {
                    ...
                    (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(notificationArr, 'insertAt', arg.index, arg.insertedItems);
                }
                ...
                setTimeout(() => {
                    if (this.getData('ltPropData').length === 0) {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(data, "insertAt", 0, [[]]);
                                ...
                                setTimeout(function () {
                                    ...
                                    element[i].addEventListener('transitionend', function (event) {
                                        if (event.propertyName == 'opacity') {
                                            ...
                                            ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayUtils)(removeNode, 'removeAt', removeNode.length - 1);
                                        }
                                    })
                                }, cancelDuration * 1000);
                            }
...
LyteNotificationCenterComponent._template = "<template tag-name=\"lyte-notification-center\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropBindToBody}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-wormhole on-before-append=\"{{method(&quot;beforeWormholeAppend&quot;)}}\" lt-prop-show=\"{{ltPropShowWormhole}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <div class=\"lyteNotificationCenter\"> <div class=\"lyteNotificationPopDiv\"> <template items=\"{{notificationStackArr}}\" item=\"array\" index=\"index\" is=\"for\" _new=\"true\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(array.length,'>',0)}}\" is=\"case\" lc-id=\"lc_id_0\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(array.length,'>',1)}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-button class=\"lyteNotificationPopCancelBtn\" onclick=\"{{action('cancelPopAction',event,this,index,ind)}}\"> <template is=\"registerYield\" yield-name=\"text\"> </template> </lyte-button> </template></template><div class=\"lyteNotificationPopUpCenterWrapper\"> <template items=\"{{array}}\" item=\"item\" index=\"ind\" is=\"for\" _new=\"true\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteNotificationPopUpItem\"> <div class=\"lyteNotificationPopCloseIcon\" onclick=\"{{action('removePopItem',item,this,index,ind)}}\"> </div> <lyte-yield yield-name=\"notify\" list-value=\"{{item}}\"></lyte-yield> </div> </template></template></template> </div> </template></template></template> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropShowPanel}}\" is=\"case\" lc-id=\"lc_id_0\"> <template items=\"{{ltPropData}}\" item=\"array\" index=\"index\" is=\"for\" _new=\"true\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(array.length,'>',0)}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteNotificationParentContainer\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(array.length,'>=',2)}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteNotificationbtnWrapper\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropActionBtn.showLess}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-button class=\"lyteNotificationShowLessBtn\" onclick=\"{{action('showLessAction',event,this)}}\"> <template is=\"registerYield\" yield-name=\"text\"> Show less </template> </lyte-button> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropActionBtn.cancelAll}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-button class=\"lyteNotificationCancelBtn\" onclick=\"{{action('cancelAction',event,this,index,ind)}}\"> <template is=\"registerYield\" yield-name=\"text\"> </template> </lyte-button> </template></template></div></template></template><div class=\"lyteNotificationClearWrapper\" onclick=\"{{action('clearClosedNotification',item,this,index)}}\"> <span class=\"lyteNotificationClosedClearIcon\"></span> </div> <div class=\"lyteNotificationCenterWrapper\" onclick=\"{{action('expandAction',event,this,array)}}\"> <template items=\"{{array}}\" item=\"item\" index=\"ind\" is=\"for\" _new=\"true\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteNotificationItem\"> <div class=\"lyteNotificationCloseIcon\" onclick=\"{{action('removeItem',item,this,index,ind)}}\"></div> <lyte-yield yield-name=\"notify\" list-value=\"{{item}}\"></lyte-yield> </div> </template></template></template> </div> </div> </template></template></template> </template></template></div> </template> </lyte-wormhole> </template></template></template>";;
LyteNotificationCenterComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[{"t":"a","p":[1,1,1]},{"t":"f","p":[1,1,1],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"a","p":[2,1],"cn":"lc_id_0"},{"t":"f","p":[2,1],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"a","p":[1,3],"cn":"lc_id_0"},{"t":"i","p":[1,3],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"f","p":[1],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"s","p":[0,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"s","p":[0,2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"a","p":[1,2],"cn":"lc_id_0"},{"t":"a","p":[1,4],"cn":"lc_id_0"},{"t":"a","p":[1,4,1],"cn":"lc_id_0"},{"t":"f","p":[1,4,1],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"a","p":[1,3],"cn":"lc_id_0"},{"t":"i","p":[1,3],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[1,0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteNotificationCenterComponent._observedAttributes = [
    "ltPropShow",
    "ltPropBindToBody",
    "ltPropData",
    "ltPropYield",
...
LyteNotificationCenterComponent.register("lyte-notification-center", {
    hash: "LyteNotificationCenterComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(5852862)));
