"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/table-tree"],{

/***/ 13598701:
/*!*********************************************!*\
  !*** ./components/javascript/table-tree.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TableTreeComponent": () => (/* binding */ TableTreeComponent)
/* harmony export */ });
...
class TableTreeComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			ltPropHeader : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array'),
			ltPropFixedHeader : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default:[]}),
			ltPropContent : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array'),
			ltPropData :(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array'),
			ltPropColwidth : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string'), 
			ltPropTreeData :(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array'),
			ltPropIsChild: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)( 'boolean' ,{default:false}),
			ltPropHeaderLength:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number'),
			ltPropColumnReorder:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default:false}),
			ltPropTableResize:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default:false}),
			ltPropDragData:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default:undefined}),
			ltPropisDrag:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default:false}),
			instance : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default:{"obj":{}}}),
			ltPropDragDrop : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default:false}),
			ltPropisDropped : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default:false})
    ...
    init() {
		...
		var tempdata=[],stack=[];
		var customSanitizer  = new Sanitizer(
            { GLOBAL_TAGS  : ["lyte-comp","span"],"GLOBAL_ATTRIBUTES" : ["style"] ,"ALLOWED_STYLE":"ALL"}
        );
    ...
    tabledata(treedata, tempdata, stack) {
			...
			rightend.addEventListener('click',function(event){
				...
				while(that.index<thead.length){
					if(thead[that.index].getAttribute('fixed')=="true"){
						lyteSelf.$addon.arrayUtils( fixedheader,'push',thead[that.index].textContent);
						that.fixed_tableheader();
						if((fixeddiv.offsetWidth>=container.offsetWidth)){
							lyteSelf.$addon.arrayUtils(fixedheader,'pop')
						}
    ...
    fixed_tableheader() {
		...
		Array.prototype.forEach.call(fixedtable.querySelectorAll('th'),function(th){
			thead[window.index].style.width=th.offsetWidth+'px';
			window.index++;
		})
    ...
    lyte_draggable() {
		...
		$L(".dragdrop").draggable({
				...
				helper  : function (elem ){ 
					...
					that.dragIndex=window.dragdrop_fun.findElement(target_id,that.table_content);
			 	...
			 	onStart : function(element){
			 		...
			 		window.target_id=parseFloat(element.dataset.id);
			 		that.dragged_row=that.table_content[window.dragdrop_fun.findElement(window.target_id,that.table_content)];
			 		var parent_index= window.dragdrop_fun.findElement(that.dragged_row.parent,that.table_content);
					...
					var childElems=[];
			 		if(that.target_children!=undefined){
						...
						that.child_elements=window.dragdrop_fun.findchild(childElems.pop(),childElems,[],that.table_content);
    ...
    lyte_droppable() {
        ...
        $L(".dragdrop").droppable({
				...
				onDrop  : function(draggedElem, droppableElem) {
					var dropIndex=window.dragdrop_fun.findElement(droppableElem.dataset.id,that.table_content);
					var dropElem_record=that.table_content[dropIndex];
					if(that.dragged_row.lytetreeid!=droppableElem.dataset.id){
						if(window.dragdrop_fun.findischild(dropElem_record,that.child_elements,that.table_content)==-1){
							var index=0;
							...
							if(dropIndex>that.dragIndex){
								...
								lyteSelf.$addon.arrayUtils(that.table_content ,'removeAt',that.dragIndex,1);
								...
								lyteSelf.$addon.arrayUtils(that.table_content ,'insertAt',dropIndex,that.dragged_row);
								...
								if(that.child_elements!=undefined){
									while(that.child_elements[index]!=undefined){
										...
										lyteSelf.$addon.arrayUtils(that.table_content ,'insertAt',dropIndex,that.child_elements[index]);
                    ...
                    if(((fixeddiv.getBoundingClientRect().x + fixeddiv.offsetWidth)>(tempheader.getBoundingClientRect().x)) ){
                        ...
                        if(tempheader.getAttribute('fixed')=="true"){
                                if(tempheader.getAttribute('tree-col')=="true"){
                                    this.$addon.arrayUtils( fixedheader,'push',{'body':tempheader.textContent,'istree':'true'});
                                }else{
                                    this.$addon.arrayUtils( fixedheader,'push',{'body':tempheader.textContent});
                                }
                                this.fixed_tableheader();
                                if((fixeddiv.offsetWidth>=container.offsetWidth)){
                                    this.$addon.arrayUtils(fixedheader,'pop')
                                }
                    ...
                    function MouseUp(event) {
                        ...
                        if(event.target.tagName=='TH'){
                                ...
                                if(target_start<=div_mid){
                                    ...
                                    arrayUtils(header ,'removeAt',sourceindex,1);
                                    
                                    arrayUtils(header,'insertAt',targetindex,removed_header);
                                    that.tableheader();
...
TableTreeComponent._template = "<template tag-name=\"table-tree\"> <div class=\"parallelcontainer\" onscroll=\"{{action('ScrollHeader',event)}}\"> <div class=\"fixeddiv\"> <table class=\"fixedtable\" cellpadding=\"0\"> <thead> </thead> <tbody> <tr is=\"switch\" lyte-switch=\"true\" l-c=\"true\" _new=\"true\"></tr></tbody> </table> </div> <div class=\"tablediv\"> <table class=\"ltPropScrollableHeader\" cellpadding=\"0\"> <thead> </thead> <tbody> <tr class=\"thead\"> <td is=\"for\" lyte-for=\"true\" items=\"{{ltPropHeader}}\" item=\"item\" index=\"index\" _new=\"true\" depth=\"3\"></td> </tr> </tbody> </table> </div> </div> <div class=\"container\" onscroll=\"{{action('fixHeader',event)}}\"> <div class=\"fixeddiv\"> <table cellpadding=\"0\" class=\"fixedtable\"> <thead> </thead> <tbody> <tr is=\"switch\" lyte-switch=\"true\" l-c=\"true\" _new=\"true\"></tr><tr is=\"for\" lyte-for=\"true\" items=\"{{ltPropData}}\" item=\"item\" index=\"index\" _new=\"true\" depth=\"2\"></tr> </tbody> </table> </div> <div class=\"tablediv\"> <table cellpadding=\"0\" class=\"lyteScrollableTreeTable\"> <thead> </thead> <tbody> <tr class=\"thead\"> <td is=\"for\" lyte-for=\"true\" items=\"{{ltPropHeader}}\" item=\"item\" index=\"index\" _new=\"true\" depth=\"3\"></td> </tr> <tr is=\"for\" lyte-for=\"true\" items=\"{{ltPropData}}\" item=\"item\" index=\"index\" _new=\"true\" depth=\"2\"></tr> </tbody> </table> </div> </div> <div class=\"scrollbar\"> <div class=\"scroll\"></div> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropisDrag,'==',true)}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"dragContent\" lt-header=\"{{ltPropHeader}}\" drag-data=\"{{ltPropDragData}}\" id=\"dragelement\"> </lyte-yield> </template></template></template><style >table-tree {\n  display: block;\n  height: inherit;\n  margin:0;\n  margin-left: 500px;\n}\nlyte-tree-table{\n  display: table;\n \n  border: none;\n  \n}\nlyte-tree-tr {\n  display: table-row;\n \n  \n  \n}\n\nlyte-tree-thead {\n  display: table-header-group;\n \n  background-color: gray;\n}\nlyte-tree-th {\n  \n    background-color:#c4c4c4;\n  \n  display: table-cell;\n  word-wrap: normal;\n  overflow: hidden;\n\n  \n}\n.leftend{\n /* background-image: url('/components/images/arrow-l.gif');\n  background-repeat: no-repeat;\n  background-position: center;*/\n/*padding-<left|right>: <width of image>px;*/\n}\n.rigthend{\n /* background-image: url('/components/images/arrow-r.gif');\n  background-repeat: no-repeat;\n  background-position: center;*/\n/*padding-<left|right>: <width of image>px;*/\n}\nlyte-tree-body {\n  display: table-row-group;\n  }\n lyte-tree-td {\n \n  display: table-cell;\n   \n  \n}\n.col-reoder-div{\n  position: absolute;\n  background-color: white;\n  opacity: 2px;\n  height: 25px;\n  text-align: center;\n  border: 2px black solid;\n  z-index: 12;\n}\n.fixedtable {\nbox-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 0px 0px 0 rgba(0, 0, 0, 0.19);\n\n}\n.container{\n  width: 600px;\n  \n  overflow-y: scroll;\n   overflow-x: hidden;\n  position: relative;\n}\n\n.tablediv::-webkit-scrollbar {\n    display: none;\n}\n.parallelcontainer::-webkit-scrollbar {\n    display: none;\n}\n\n.fixeddiv{\n    /*width: 0px;*/\n    position: absolute;\n    background: white;\n    z-index: 10;\n    \n\n}\n.tablediv{\n    overflow: auto;\n    width: 100%;\n\n}\n.parallelcontainer{\n\n  position: absolute;\nz-index: 11;\n\nbackground-color: white;\n}\nbutton{\n  padding: 0px;\n  height: 10px;\n  width: 16px;\n  text-align: center;\n}\n.scroll{\n\n  min-width: 50px;\n  height: 10px; \n    position: absolute;\n\n  \n}\n.scrollbar{\n  bottom: 0;\n  height: 10px;\n}\n\ntable{\n  position: relative;\n  /*word-wrap: break-word;*/\n  white-space: nowrap;\n /* margin-left: 500px;*/\n}\n\nth{\n  background-color:#c4c4c4;\n  border-bottom: 0px;\n  height: 50px;\n}\ntable-tree{\n  display: block;\n}\ntd {\n  \n    height: 50px;\n    border-bottom: 1px solid gray;\n  }</style>";;
TableTreeComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"s","p":[1,1,1,3,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"tX","p":[1,0]}],"actualTemplate":"<template is=\"for\" depth=\"3\"><table><tbody><tr> <th>{{item.body}}</th> </tr></tbody></table></template>","tagName":"TR","cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"actualTemplate":"<template is=\"switch\"><template case=\"{{expHandlers(ltPropFixedHeader.length,'!=',0)}}\" is=\"case\" lc-id=\"lc_id_0\" depth=\"2\"><table><tbody> <tr class=\"thead\"> <td is=\"for\" lyte-for=\"true\" items=\"{{ltPropFixedHeader}}\" item=\"item\" index=\"index\" _new=\"true\" depth=\"3\"></td> </tr> </tbody></table></template></template>","in":6,"sibl":[5]},{"t":"a","p":[1,3,1,3,1,1]},{"t":"f","p":[1,3,1,3,1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"actualTemplate":"<template is=\"for\" depth=\"3\"><table><tbody><tr> <th fixed=\"{{item.fixed}}\" tree-col=\"{{item.istree}}\">{{item.body}}</th> </tr></tbody></table></template>","tagName":"TR","in":5,"sibl":[4]},{"t":"a","p":[3]},{"t":"s","p":[3,1,1,3,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"tX","p":[1,0]}],"actualTemplate":"<template is=\"for\" depth=\"3\"><table><tbody><tr> <th>{{item.body}}</th> </tr></tbody></table></template>","tagName":"TR","cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"actualTemplate":"<template is=\"switch\"><template case=\"{{expHandlers(ltPropFixedHeader.length,'!=',0)}}\" is=\"case\" lc-id=\"lc_id_0\" depth=\"2\"><table><tbody> <tr class=\"thead\"> <td is=\"for\" lyte-for=\"true\" items=\"{{ltPropFixedHeader}}\" item=\"item\" index=\"index\" _new=\"true\" depth=\"3\"></td> </tr> </tbody></table></template></template>","in":4,"sibl":[3]},{"t":"a","p":[3,1,1,3,2]},{"t":"f","p":[3,1,1,3,2],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":1,"sibl":[0]},{"t":"a","p":[1,2]},{"t":"i","p":[1,2],"in":0}],"dc":[0],"hc":true,"trans":true,"actualTemplate":"<template is=\"for\" depth=\"3\"><table><tbody><tr> <td> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(items.istree,'==','true')}}\" is=\"case\" lc-id=\"lc_id_0\"> {{unescape(generatespan(item.depth),undefined,instance.obj)}} </template></template><lyte-yield yield-name=\"bodyContent\" obj=\"{{item[items.body]}}\"></lyte-yield> </td> </tr></tbody></table></template>","tagName":"TR","in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"actualTemplate":"<template is=\"switch\"><template case=\"{{expHandlers(ltPropFixedHeader.length,'!=',0)}}\" is=\"case\" lc-id=\"lc_id_0\" depth=\"2\"><table><tbody> <tr helper-attr=\"{{parentchild(this,item)}}\"> <td is=\"for\" lyte-for=\"true\" items=\"{{ltPropFixedHeader}}\" item=\"items\" index=\"index\" _new=\"true\" depth=\"3\"></td> </tr> </tbody></table></template></template>","in":0}],"dc":[0],"hc":true,"trans":true,"actualTemplate":"<template is=\"for\" depth=\"2\"><table><tbody> <tr is=\"switch\" lyte-switch=\"true\" l-c=\"true\" _new=\"true\"></tr></tbody></table></template>","tagName":"TBODY","in":3,"sibl":[2]},{"t":"a","p":[3,3,1,3,1,1]},{"t":"f","p":[3,3,1,3,1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"actualTemplate":"<template is=\"for\" depth=\"3\"><table><tbody><tr> <th fixed=\"{{item.fixed}}\" tree-col=\"{{item.istree}}\">{{item.body}}</th> </tr></tbody></table></template>","tagName":"TR","in":2,"sibl":[1]},{"t":"a","p":[3,3,1,3,3]},{"t":"f","p":[3,3,1,3,3],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"f","p":[1,1],"dN":[{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":1,"sibl":[0]},{"t":"a","p":[1,2]},{"t":"i","p":[1,2],"in":0}],"dc":[0],"hc":true,"trans":true,"actualTemplate":"<template is=\"for\" depth=\"3\"><table><tbody><tr> <td> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(items.istree,'==','true')}}\" is=\"case\" lc-id=\"lc_id_0\"> {{unescape(generatespan(item.depth),undefined,instance.obj)}} </template></template><lyte-yield yield-name=\"bodyContent\" obj=\"{{item[items.body]}}\"></lyte-yield> </td> </tr></tbody></table></template>","tagName":"TR","in":0}],"dc":[0],"hc":true,"trans":true,"actualTemplate":"<template is=\"for\" depth=\"2\"><table><tbody> <tr helper-attr=\"{{parentchild(this,item,item.isdropped)}}\" class=\"dragdrop\" data-id=\"{{item.lytetreeid}}\"> <td is=\"for\" lyte-for=\"true\" items=\"{{ltPropHeader}}\" item=\"items\" index=\"index\" _new=\"true\" depth=\"3\"></td> </tr> </tbody></table></template>","tagName":"TBODY","in":1,"sibl":[0]},{"t":"s","p":[7],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[3,1,0]}];;

TableTreeComponent._observedAttributes = [
    "ltPropHeader",
    "ltPropFixedHeader",
    "ltPropContent",
    "ltPropData",
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("generatespan",function(depth){
	var element="";
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("parentchild",function(node,item,isdropped){ 
	
		var parent=item.parent;
		var data=this.$node.getData('ltPropData');
		if(parent!=undefined){
			var index=0;
...
TableTreeComponent.register("table-tree", {
    hash: "TableTreeComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(13598701)));
