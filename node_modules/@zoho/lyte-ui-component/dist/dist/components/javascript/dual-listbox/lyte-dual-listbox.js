"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/dual-listbox/lyte-dual-listbox"],{

/***/ 72817000:
/*!*****************************************************************!*\
  !*** ./components/javascript/dual-listbox/lyte-dual-listbox.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteDualListboxComponent": () => (/* binding */ LyteDualListboxComponent)
/* harmony export */ });
...
class LyteDualListboxComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    super();
    this._lyteUtilFunctions = ['moveAllElementsLeft','moveAllElementsRight','moveElementToRight','moveElementToLeft','keyboardEvents','clearAllActive','pinElement','resetListbox'];
  }
  ...
  data(arg1) {
    return Object.assign(super.data({ 
       ...
       * @default []
       */
      ltPropLeftData: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', {
        default: []
      }),
      /**
       ...
       * @default []
       */
      ltPropRightData: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', {
        default: []
      }),
      /**
       ...
       * @default []
       */
      ltPropPinnedData : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array' , {
        default : []
      }),
      /**
       ...
       * @default false
       */
      ltPropSortable: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      /**
       ...
       * @default false
       */
      ltPropShortcut: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      /**
       * @componentProperty {string} associateParent
       * @default 'value'
       */
      associateParent: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default: 'value'
      }),
      /**
       ...
       * @default false
       */
      ltPropShowToolbar: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      /**
       ...
       */
      ltPropSearchScope: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default: 'lyteListboxLeftPanel'
      }),
      /**
       ...
       */
      ltPropToolbarItems: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', {
        default: ['moveRight', 'moveLeft', 'moveTop', 'moveBottom' , 'moveAllRight' , 'moveAllLeft']
      }),
       /**
       ...
       * @default -1
       */
      ltPropMaxCount: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number', {
        default: -1
      }),
       /**
       ...
       * @default true
       */
      ltPropDoubleClick: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: true
      }),
       /**
       ...
       * @default false
       */
      ltPropSelectAllChild : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{
        default: false
      }),
      /**
       ...
       */
      ltPropNoResultMessage : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
       ...
       */
      ltPropAriaRoleDescription : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : 'Dual listbox'
      }),
      /**
       ...
       * @default false
       */
      ltPropKeepOriginal : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      /**
       ...
       * @default 'required'
       */
      ltPropMandateKey : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : 'required'
      }),
      /**
       ...
       * @default -1
       */
      ltPropMinimumRequiredCount : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number' , {
        default : -1
      }),
      /**
       ...
       * @default false 
       */
      ltPropRestrictMandatoryElement : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false 
      }),
       /**
       ...
       * @default ''
       */
      ltPropIgnoreSorting : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ''
      }),
      /**
       ...
       */
      ltPropTooltipMessage : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default : 'Select limit reached'
      }),
      /**
       ...
       * @default false
       */
      ltPropAllowMandateSortable : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      /**
       ...
       * @default false
       */
      ltPropHasPinOption : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      /**
       ...
       * @default true
       */
      ltPropShowIcon : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : true
      }),
      /**
       ...
       * @default {}
       */
      ltPropSearch : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)("object",{default:{}}),

      ltPropYield : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : true
      }),
      /**
       ...
       * @default ""
       */
      ltPropDisplayKey : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ""
      }),
      ltPropInfiniteScroll : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      ltPropInfiniteScrollElementCount: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number', {
        default: 20
      }),

      ltPropShowSearch: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default : true
      }),


      enableInfiniteScroll: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
    
      infiniteScrollPopulateData : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object' ,{
        default : {}
      }),


      listboxLeftAriaDescendant:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default : ''
      }),
      listboxRightAriaDescendant:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default : ''
      }),
      ariaLabelledById : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ''
      }),
      focusActiveBoolean : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      ariaLiveContentBoolean : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      ariaLiveContent : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ''
      }),

      dragHasStarted : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',  {
        default : false
      }),
      noResultsFound : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      noResultsFoundRight : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      moveRight: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      moveLeft: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      moveTop: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      moveBottom: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      deleteElement: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      moreLBElements: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean', {
        default: false
      }),
      selectedIndexLeft: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', {
        default: []
      }),
      selectedIndexRight: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array', {
        default: []
      }),
      leftShiftSelectIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default: ""
      }),
      rightShiftSelectIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string', {
        default: ""
      }),
      insertAtLeftInd: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number', {
        default: 0
      }),
      insertAtRightInd: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number', {
        default: 0
      }),
      elementPosition : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number', {
        default : 0
      }),
      activeSide : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ''
      }),
      previousClickedElemDomInd : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number' , {
        default : 0
      }),
      focusedOnTab : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      initialClientX : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number' , {
        default : 0
      }),
      initialClientY : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number' , {
        default : 0
      }),
      firstUpDownClick : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      showRemoveBtn : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      userDefinedMinCount : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      itemsMaxed : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      initialMouseDownVals : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{
        default : {}
      }),
      draggedElemDim : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object' , {
        default : {}
      }),

      draggedSource : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ''
      }),
      draggedDestination : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' , {
        default : ''
      }),
      elementRemoved : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      }),
      draggedDatas :(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array' , {
        default : []
      }),
      rightToLeftMoveData : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object' , {
        default : {}
      }),
      draggedFromIndex : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array' , {
        default : []
      }),
      useSelf : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean' , {
        default : false
      })
    }), arg1);
  }
  ...
  init() {
    ...
    this.$node.moveElementToRight = function(obj){
      ...
      if(onBeforeRightVal !== false){
        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropLeftData') , 'removeObjects' , obj)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData')  , 'push' , obj)
    ...
    this.$node.moveElementToLeft = function(obj){
      ...
      if(onBeforeLeftVal !== false){
        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'removeObjects' , obj)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropLeftData')  , 'push' , obj)
    ...
    if (this.getData('ltPropShortcut')) {
        window._lyteUiUtils.addEventListenerGlobal('keydown' , this.$node.keyboardEvents)
    }
    ...
    window._lyteUiUtils.addEventListenerGlobal('click' , this.$node.clearAllActive)
    ...
    this.$node.pinElement = function(elem , index , pin){
      if(!this.getData('ltPropHasPinOption')){
        if($L(elem).hasClass('lyteListBoxRightWrap')){
          ...
          var obj = (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'removeAt' , ind , 1)
          ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'insertAt' , index , obj[0])
          ...
          var obj = (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropLeftData') , 'removeAt' , ind , 1)
          ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropLeftData') , 'insertAt' , index , obj[0])
        }
      } else {
        if($L(elem).hasClass('lyteListBoxRightWrap')){
          if(pin){
            ...
            var ind = parseInt($L(elem).find('.lyteListBoxRightElement').attr('index'))
            var obj = (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'removeAt' , ind , 1)
            ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropPinnedData') , 'push' , obj)
          } else {
            // $L(this).find('.lyteListBoxRightWrap').eq(index).removeClass(this.getData('ltPropIgnoreSorting'))
            var ind = parseInt($L(elem).find('.lyteListBoxRightElement').attr('index'))
            var obj = (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropPinnedData') , 'removeAt' , ind , 1)
            ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'insertAt' , index , obj)
  ...
  initializeLSFRP() { // initialize listSelection for Right Panel
  ...
  reInitializeLSFRP() {  // reinitialize listSelection for Right Panel
  ...
  mouseDownFunction(event) {
    ...
    if($L(event.target).closest('.lyteListBoxRightWrap')[0] || $L(event.target).closest('.lyteListBoxLeftWrap')[0]){
      ...
      if($L(event.target).closest('.lyteListBoxRightWrap')[0] && $L(event.target).closest('.lyteListBoxRightWrap').hasClass('lyteLBRightActive')){
        ...
        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('draggedElemDim') , 'add' , 'width' , dim.width)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('draggedElemDim') , 'add' , 'height' , dim.height)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('draggedElemDim') , 'add' , 'left' , dim.left)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('draggedElemDim') , 'add' , 'right' , dim.right)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('draggedElemDim') , 'add' , 'top' , dim.top)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('draggedElemDim') , 'add' , 'bottom' , dim.bottom)


        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('initialMouseDownVals') , 'add' , 'prevHeight' , 0)

        if( activeElements[0] && (activeElements[0] !== $L(event.target).closest('.lyteLBRightActive')[0])){
          (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('initialMouseDownVals') , 'add' , 'prevHeight' , dim.height*activeElements.indexOf($L(event.target).closest('.lyteLBRightActive')[0]))
        }

        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('initialMouseDownVals') , 'add' , 'clientX' , event.clientX)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('initialMouseDownVals') , 'add' , 'clientY' , event.clientY)
        ...
        if( activeElements[0] && (activeElements[0] !== $L(event.target).closest('.lyteLBLeftActive')[0])){
          (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('initialMouseDownVals') , 'add' , 'prevHeight' , dim.height*activeElements.indexOf($L(event.target).closest('.lyteLBLeftActive')[0]))
        }
            ...
            if(!$L(event.target).hasClass('lyteLBPlaceHolder') && targetElem){
              ...
              if($L(_this.$node).find('.lyteListboxUnpinnedWrapper').eq(0).find('.lyteListBoxRightWrap:last-child')[0] === $L(event.target).closest('.lyteListBoxRightWrap')[0]){
                ...
                if(event.clientY > lastElemDim.top + (lastElemDim.height/2)){
                  window._lyteUiUtils.insertAfter(targetElem , placeHolder)
                } else {
                  lbRightPanel.insertBefore(placeHolder ,  targetElem)
                }
              } else {
          ...
          if($L(event.target).closest(appendParentNode)[0]){
            ...
            if(!$L(event.target).hasClass('lyteLBPlaceHolder') && $L(event.target).closest('.lyteListBoxRightWrap')[0]){
              ...
              if($L(_this.$node).find('.'+_this.getData('draggedSource')).eq(0).find('.lyteListBoxRightWrap:last-child')[0] === $L(event.target).closest('.lyteListBoxRightWrap')[0]){
                ...
                var lastElemDim = lastElem[0].getBoundingClientRect()
                if(event.clientY > lastElemDim.top + (lastElemDim.height/2)){
                  window._lyteUiUtils.insertAfter($L(event.target).closest('.lyteListBoxRightWrap')[0] , placeHolder)
                } else {
  ...
  dropElementsToRight() {
    ...
    (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'insertAt' , dropIndex , this.getData('draggedDatas'))
  }

  dropElementsToLeft() {
    var toMoveDatasObj = this.getData('rightToLeftMoveData')
    if(toMoveDatasObj.mandateData && toMoveDatasObj.mandateData.obj){
      (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'insertAt' , toMoveDatasObj.mandateData.index , toMoveDatasObj.mandateData.obj)
      ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('draggedDatas') , 'removeObjects' , toMoveDatasObj.mandateData.obj)
    }
    (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropLeftData') , 'push' , toMoveDatasObj.toMoveDatas)
  }
  ...
  pinnedElementSortable() {
    ...
    (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropPinnedData') , 'insertAt' , dropIndex , this.getData('draggedDatas'))
  }
    ...
    switch(this.getData('draggedSource')){
      case 'lyteListboxPinnedWrapper': 
        ...
        for(var i=0;i<draggedDatas.length;i++){
          (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('draggedFromIndex') , 'push' , this.getData('ltPropPinnedData').indexOf(draggedDatas[i]))
          ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.getData('ltPropPinnedData') , 'removeObjects' , draggedDatas[i]);
        }
      break;
      case 'lyteListboxUnpinnedWrapper':
        ...
        this.setData('draggedDatas' , draggedDatas)
        for(var i=0;i<draggedDatas.length;i++){
          (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('draggedFromIndex') , 'push' , this.getData('ltPropRightData').indexOf(draggedDatas[i]))
          ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.getData('ltPropRightData') , 'removeObjects' , draggedDatas[i]);
        }
      break;
      case 'lyteListboxleftElementWrap':
        draggedDatas = this.getActiveElements($L(this.$node).find('.lyteLBLeftActive'), 'ltPropLeftData');
        this.setData('draggedDatas' , draggedDatas)
        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.getData('ltPropLeftData') , 'removeObjects' , draggedDatas);
      break;
    }
  }

  putBackInSamePlace(data) {
    ...
    for(var i=draggedDatas.length-1;i>=0;i--){
      (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData(data) , 'insertAt' , draggedIndex[i] , draggedDatas[i])
    }
  }
  ...
  moveAllElementsRight(th) {
    if(this.getData('useSelf')){
        if(this.getData('enableInfiniteScroll')){
        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropRightData') , 'push' , this.getData('ltPropLeftData'))
  ...
  moveAllElementsLeft(th) {
    if(this.getData('useSelf')){
        this.clearSearch()
        if(this.getData('enableInfiniteScroll')){
          (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('ltPropLeftData') , 'push' , this.getData('ltPropRightData'))
      ...
      moveElementUp: function(thisBtn) {
        if(this.getData('useSelf')){
          ...
          if ($L(lB).find('.lyteListboxUnpinnedWrapper').find('.lyteLBRightActive').length === 1) {
              ...
              (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData'), 'removeAt', index[0], 1);
              (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData'), 'insertAt', index[0] - 1, elementData);
            ...
            if (!(th.panelSide(leftClickedElement) === 'left')) {
              ...
              if (index.length > 1) {
                if (index[1] > 0) {
                  ...
                  ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData')[index[0]].childrenList, 'removeAt', index[1], 1);
                  (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData')[index[0]].childrenList, 'insertAt', index[1] - 1, elementData);
          ...
          for (var i = 0; i < activeElement.length; i++) {
            ...
            if ((index.length > 1) || ($L(activeElement[i]).hasClass('lyteListBoxLeftParentElement'))) {
              ...
              if (($L(activeElement[i]).hasClass('lyteListBoxLeftParentElement')) && (($L(childWrap[0]).find('.lyteLeftLvl2').length < 1) || ($L(childWrap[0]).find('.lyteLBLeftActive').length === $L(childWrap[0]).find('.lyteLeftLvl2').length))) {
                ...
                (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData'), 'removeAt', index[0], 1);
              }
              if (index.length > 1) {
                elementData = th.getData('ltPropLeftData')[index[0]].childrenList[index[1]];
                (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData')[index[0]].childrenList, 'removeAt', index[1], 1);
              }
            } else {
              elementData = th.getData('ltPropLeftData')[index[0]];
              (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData'), 'removeAt', index[0], 1);
  ...
  animateBackgroundManual(side, ind, destination) {
        ...
        if (this.panelSide(clickedEle) === "left") {
          ...
          if (!isCurrentElementDisabled) {
            ...
            if ($L(clickedEle).hasClass('lyteListBoxLeftElement') && !$L(clickedEle).hasClass('lyteLBLeftActive')) {
              ...
              ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('selectedIndexLeft'), 'push', leftEles.indexOf(clickedEle))
              this.setData('leftShiftSelectIndex', '')
              ...
              ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('selectedIndexLeft'), 'removeAt', $L(clickedEle).data().selectOrder - 1, 1)
              $L(clickedEle).data()
            }
          }
          ...
          if ((!(this.getData('ltPropRightData')[notDisabled][this.getData('ltPropMandateKey')]))) {
            ...
            if ($L(clickedEle).hasClass('lyteListBoxRightElement') && !$L(clickedEle).hasClass('lyteLBRightActive')) {
              ...
              ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('selectedIndexRight'), 'push', rightEles.indexOf(clickedEle))
              ...
              ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('selectedIndexRight'), 'removeAt', $L(clickedEle).data().selectOrder - 1, 1)
              $L(clickedEle).data()
            }
  ...
  sESPF(activeEles, toMoveDatas, mainData, dropIndex, allElements, destination) {
    /*
    ...
    if(activeEles && activeEles.length > 0){
      ...
      for (var i = 0; i < activeEles.length; i++) {
        ...
        if ((!($L(activeEles[i]).hasClass('lyteListBoxLeftParentElement'))) && (!($L(activeEles[i]).hasClass('lyteListBoxRightParentElement')))) {
          ...
          (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData(mainData), 'removeAt', ind, 1);
        }
      }
      ...
      (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData(mainData), 'insertAt', dropIndex, toMoveDatas);
    }
      ...
      for (var i = 0; i < activeEles.length; i++) {
        ...
        if (($L(activeEles[i]).hasClass('lyteListBoxLeftWrap')) && (!$L(activeEles[i]).closest('.lyteListBoxLeftWrap').hasClass('lyteLBDisabledElement'))) {
          if ((ind.length > 1)) {
            ...
            if (elementData) {
              (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData'), 'insertAt', th.getData('insertAtRightInd'), elementData);
              ...
              (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData')[ind[0]].childrenList, 'removeAt', ind[1], 1);
              $L(lB).find('.lyteLBLeftActive').removeClass('lyteLBLeftActive')
            ...
            if (!(currentData.childrenList)) { 
              ...
              ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData'), 'push', elementData);
              th.animateBackgroundManual('right' , th.getData('insertAtRightInd') , '.lyteListboxUnpinnedWrapper');
              th.updateInsertIndex();
              (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData'), 'removeAt', ind, 1);
      ...
      if(onBeforeLeftVal !== false){
        ...
        for (var i = 0; i < activeEles.length; i++) {
          ...
          if ($L(activeEles[i]).find('.lyteListBoxRightElement').attr('setParent').length > 0) {
            ...
            ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData')[parI].childrenList, 'push', elementData);
            // Lyte.arrayUtils(th.getData('ltPropLeftData')[parI].childrenList, 'insertAt', 0 , elementData);
            (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropRightData'), 'removeAt', ind, 1);
            ...
            elementData = th.getData('ltPropRightData')[ind]
            ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(th.getData('ltPropLeftData'), 'push', elementData);
...
LyteDualListboxComponent._template = "<template tag-name=\"lyte-dual-listbox\" role=\"listbox\"> <div class=\"lyteListboxWrapper\"> <div class=\"lyteListboxLeftPanel lyteListboxPanels\" id=\"lyte_listbox_left_panel\" aria-label=\"left panel\" aria-multiselectable=\"true\" aria-orientation=\"vertical\" onfocus=\"{{action('focusPanel',this)}}\" onfocusout=\"{{action('blurPanel',this)}}\" aria-activedescendant=\"{{listboxLeftAriaDescendant}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropShowSearch}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-search class=\"lyteListBoxSearch\" lt-prop=\"{{stringify(ltPropSearch)}}\" lt-prop-class=\"lyteListboxInput\" lt-prop-close-icon=\"true\" lt-prop-query-selector=\"{&quot;scope&quot; : &quot;.{{ltPropSearchScope}}&quot;, &quot;search&quot; : &quot;.lyteListBoxLeftWrap&quot;, &quot;target&quot; : &quot;.lyteListBoxLeftWrap&quot;}\" lt-prop-check-from-parent=\"true\" lt-prop-component=\"duallistbox\" lt-prop-trim=\"true\" on-search=\"{{method('onSearch')}}\"></lyte-search></template></template><div class=\"lyteListboxleftElementWrap lyteListboxSortablePanels\"> <template items=\"{{ltPropLeftData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <div class=\"lyteListBoxLeftWrap {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'par','left')}}\"> <div class=\"lyteListBoxLeftElement lyteLeftLvl1 {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'child','left')}}\" ondblclick=\"{{action('moveElementRight',this,'doubleClick')}}\" onmouseup=\"{{action('elementFN',this,event)}}\" onmousedown=\"{{action('elementFN',this,event)}}\" index=\"{{lyteListBoxIndex(index)}}\" dom-index=\"\" id=\"\" role=\"option\" aria-selected=\"false\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield class=\"lyteListboxYield\" yield-name=\"leftWidget\" left-widget-value=\"{{item}}\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteListboxDisplayNode\"> {{item[ltPropDisplayKey]}} </div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropShowIcon}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-add class=\"lyteLbAdd\" onclick=\"{{action('addElementToRight',this,event)}}\"></lyte-lb-add></template></template></div> </div> </template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{noResultsFound}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteListBoxNoResultsFound\">{{ltPropNoResultMessage}}</div></template></template></div> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropShowToolbar}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteListboxToolbar\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moveRight}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTNavBtn lyteLBTBMoveRight\" tabindex=\"0\" role=\"button\" aria-label=\"move selected elements right\" onclick=\"{{action('moveElementRight',this,'toolbarClick')}}\" lt-prop-title=\"Move Right\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moveLeft}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTNavBtn lyteLBTBMoveLeft\" tabindex=\"0\" role=\"button\" aria-label=\"move selected elements left\" onclick=\"{{action('moveElementLeft',this,'toolbarClick')}}\" lt-prop-title=\"Move Left\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moveTop}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTNavBtn lyteLBTBMoveUp\" tabindex=\"0\" role=\"button\" aria-label=\"move selected elements up\" onclick=\"{{action('moveElementUp',this)}}\" lt-prop-title=\"Move Up\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moveBottom}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTNavBtn lyteLBTBMoveDown\" tabindex=\"0\" role=\"button\" aria-label=\"move selected elements down\" onclick=\"{{action('moveElementDown',this)}}\" lt-prop-title=\"Move Down\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moveAllRight}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTBMoveAllRight\" tabindex=\"0\" role=\"button\" aria-label=\"move all elements right\" onclick=\"{{action('moveAllElementsRight',this)}}\" lt-prop-title=\"Move All Right\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"> ar </div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moveAllLeft}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTBMoveAllLeft\" tabindex=\"0\" role=\"button\" aria-label=\"move all elements left\" onclick=\"{{action('moveAllElementsLeft',this)}}\" lt-prop-title=\"Move All Left\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"> al </div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{deleteElement}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteLBToolbarItems lyteLBTBDeleteMarked\" tabindex=\"0\" role=\"button\" aria-label=\"delete the selected element\" onclick=\"{{action('deleteElement')}}\" lt-prop-title=\"Delete\" lt-prop-tooltip-config=\"{ &quot;position&quot;:&quot;bottom&quot;}\"></div></template></template></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(expHandlers(ltPropHasPinOption,'!'),'&amp;&amp;',expHandlers(ltPropInfiniteScroll,'!'))}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteListboxRightPanel lyteListboxUnpinnedWrapper lyteListboxPanels lyteListboxSortablePanels\" tabindex=\"0\" id=\"lyte_listbox_right_panel\" aria-label=\"right panel\" aria-orientation=\"vertical\" onfocus=\"{{action('focusPanel',this)}}\" onfocusout=\"{{action('blurPanel',this)}}\" aria-activedescendant=\"{{listboxRightAriaDescendant}}\"> <template items=\"{{ltPropRightData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <div class=\"lyteListBoxRightWrap {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'par','right',ltPropAllowMandateSortable)}}\"> <div class=\"lyteListBoxRightElement lyteRightLvl1 {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'child','right',ltPropAllowMandateSortable)}}\" ondblclick=\"{{action('moveElementLeft',this,'doubleClick')}}\" onmouseup=\"{{action('elementFN',this,event)}}\" onmousedown=\"{{action('elementFN',this,event)}}\" index=\"{{lyteListBoxIndex(index)}}\" setparent=\"{{lyteListBoxParentIndex(this,item,ltPropAssociateParent)}}\" dom-index=\"\" id=\"\" role=\"option\" aria-selected=\"false\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield class=\"lyteListboxYield\" yield-name=\"rightWidget\" right-widget-value=\"{{item}}\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteListboxDisplayNode\"> {{item[ltPropDisplayKey]}} </div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item[ltPropMandateKey],'!')}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-remove class=\"lyteLbAdd\" onclick=\"{{action('removeElementFromRight',this,event)}}\"></lyte-lb-remove></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item[ltPropMandateKey],'&amp;&amp;',showRemoveBtn)}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-remove class=\"lyteLbAdd\" onclick=\"{{action('removeElementFromRight',this,event)}}\"></lyte-lb-remove></template></template></div> </div> </template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{noResultsFoundRight}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteListBoxNoResultsFound\">{{ltPropNoResultMessage}}</div></template></template></div> </template><template case=\"{{enableInfiniteScroll}}\" is=\"case\" lc-id=\"lc_id_1\"> <div class=\"lyteListboxRightPanel lyteListboxUnpinnedWrapper lyteListboxPanels lyteListboxSortablePanels\" tabindex=\"0\" id=\"lyte_listbox_right_panel\" aria-label=\"right panel\" aria-orientation=\"vertical\" onfocus=\"{{action('focusPanel',this)}}\" onfocusout=\"{{action('blurPanel',this)}}\" aria-activedescendant=\"{{listboxRightAriaDescendant}}\"> <template object=\"{{infiniteScrollPopulateData}}\" value=\"value\" key=\"index\" is=\"forIn\" _new=\"true\"> <div class=\"lyteListBoxRightWrap {{lyteListBoxRequiredClassHelper(value.data,ltPropMandateKey,minCountReached,'par','right',ltPropAllowMandateSortable)}}\"> <div class=\"lyteListBoxRightElement lyteRightLvl1 {{lyteListBoxRequiredClassHelper(value.data,ltPropMandateKey,minCountReached,'child','right',ltPropAllowMandateSortable)}}\" ondblclick=\"{{action('moveElementLeft',this,'doubleClick')}}\" onmouseup=\"{{action('elementFN',this,event)}}\" onmousedown=\"{{action('elementFN',this,event)}}\" index=\"{{value.index}}\" setparent=\"{{lyteListBoxParentIndex(this,value.data,ltPropAssociateParent)}}\" dom-index=\"\" id=\"\" role=\"option\" aria-selected=\"false\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield class=\"lyteListboxYield\" yield-name=\"rightWidget\" right-widget-value=\"{{value.data}}\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteListboxDisplayNode\"> {{value.data[ltPropDisplayKey]}} </div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(value.data[ltPropMandateKey],'!')}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-remove class=\"lyteLbAdd\" onclick=\"{{action('removeElementFromRight',this,event)}}\"></lyte-lb-remove></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(value.data[ltPropMandateKey],'&amp;&amp;',showRemoveBtn)}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-remove class=\"lyteLbAdd\" onclick=\"{{action('removeElementFromRight',this,event)}}\"></lyte-lb-remove></template></template></div> </div> </template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{noResultsFoundRight}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteListBoxNoResultsFound\">{{ltPropNoResultMessage}}</div></template></template></div> </template><template default=\"\"> <div class=\"lyteListboxRightPanel lyteListboxPanels lyteLBRightPanelWithPinOption\" tabindex=\"0\" id=\"lyte_listbox_right_panel\" aria-label=\"right panel\" aria-orientation=\"vertical\" onfocus=\"{{action('focusPanel',this)}}\" onfocusout=\"{{action('blurPanel',this)}}\" aria-activedescendant=\"{{listboxRightAriaDescendant}}\"> <div class=\"lyteListboxPinnedWrapper lyteListboxSortablePanels\"> <template items=\"{{ltPropPinnedData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <div class=\"lyteListBoxRightWrap lyteListBoxRightPinnedWrap {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'par','right',ltPropAllowMandateSortable)}}\"> <div class=\"lyteListBoxRightElement lyteRightLvl1 {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'child','right',ltPropAllowMandateSortable)}}\" onmouseup=\"{{action('elementFN',this,event)}}\" onmousedown=\"{{action('elementFN',this,event)}}\" index=\"{{lyteListBoxIndex(index)}}\" setparent=\"{{lyteListBoxParentIndex(this,item,ltPropAssociateParent)}}\" dom-index=\"\" id=\"\" role=\"option\" aria-selected=\"false\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield class=\"lyteListboxYield\" yield-name=\"rightWidget\" right-widget-value=\"{{item}}\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteListboxDisplayNode\"> {{item[ltPropDisplayKey]}} </div> </template></template></div> </div> </template> </div> <div class=\"lyteListboxUnpinnedWrapper lyteListboxSortablePanels\"> <template items=\"{{ltPropRightData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <div class=\"lyteListBoxRightWrap {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'par','right',ltPropAllowMandateSortable)}}\"> <div class=\"lyteListBoxRightElement lyteRightLvl1 {{lyteListBoxRequiredClassHelper(item,ltPropMandateKey,minCountReached,'child','right',ltPropAllowMandateSortable)}}\" ondblclick=\"{{action('moveElementLeft',this,'doubleClick')}}\" onmouseup=\"{{action('elementFN',this,event)}}\" onmousedown=\"{{action('elementFN',this,event)}}\" index=\"{{lyteListBoxIndex(index)}}\" setparent=\"{{lyteListBoxParentIndex(this,item,ltPropAssociateParent)}}\" dom-index=\"\" id=\"\" role=\"option\" aria-selected=\"false\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield class=\"lyteListboxYield\" yield-name=\"rightWidget\" right-widget-value=\"{{item}}\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteListboxDisplayNode\"> {{item[ltPropDisplayKey]}} </div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(expHandlers(item[ltPropMandateKey],'!'),'&amp;&amp;',ltPropShowIcon)}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-remove class=\"lyteLbAdd\" onclick=\"{{action('removeElementFromRight',this,event)}}\"></lyte-lb-remove></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(expHandlers(item[ltPropMandateKey],'&amp;&amp;',showRemoveBtn),'&amp;&amp;',ltPropShowIcon)}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-lb-remove class=\"lyteLbAdd\" onclick=\"{{action('removeElementFromRight',this,event)}}\"></lyte-lb-remove></template></template></div> </div> </template> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{noResultsFoundRight}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteListBoxNoResultsFound\">{{ltPropNoResultMessage}}</div></template></template></div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{moreLBElements}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-badge class=\"lyteListboxBadge\" lt-prop-position=\"topRight\" lt-prop-max-length=\"3\"></lyte-badge></template></template></div> </template>";;
LyteDualListboxComponent._dynamicNodes = [{"t":"a","p":[1,1]},{"t":"s","p":[1,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":5,"sibl":[4]},{"t":"a","p":[1,1,2,1]},{"t":"f","p":[1,1,2,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"s","p":[1,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,1,2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[1,0],"hc":true,"trans":true,"in":4,"sibl":[3]},{"t":"s","p":[1,1,2,3],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[0,0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":3,"sibl":[2]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"s","p":[0,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[5],"cn":"lc_id_0"},{"t":"s","p":[0,2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[4],"cn":"lc_id_0"},{"t":"s","p":[0,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[3],"cn":"lc_id_0"},{"t":"s","p":[0,4],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[2],"cn":"lc_id_0"},{"t":"s","p":[0,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[1],"cn":"lc_id_0"},{"t":"s","p":[0,6],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[0],"cn":"lc_id_0"},{"t":"s","p":[0,7],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":2,"sibl":[1]},{"t":"s","p":[1,4],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"s","p":[1,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"s","p":[1,1,2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[2,1,0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[0,0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"a","p":[1],"cn":"lc_id_1"},{"t":"a","p":[1,1],"cn":"lc_id_1"},{"t":"fI","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"s","p":[1,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"s","p":[1,1,2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[2,1,0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_1"},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[0,0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0,"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"a","p":[1,1,1],"cn":"default"},{"t":"f","p":[1,1,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"s","p":[1,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":2,"sibl":[1],"cn":"default"},{"t":"a","p":[1,3,1],"cn":"default"},{"t":"f","p":[1,3,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"s","p":[1,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"s","p":[1,1,2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[2,1,0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"default"},{"t":"s","p":[1,5],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[0,0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[1],"hc":true,"trans":true},"lc_id_1":{"dc":[1],"hc":true,"trans":true},"default":{"dc":[2,1],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0","lc_id_1"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,5],"c":{"lc_id_0":{"dN":[{"t":"cD","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[5,4,1,0]}];;

LyteDualListboxComponent._observedAttributes = [
  "ltPropLeftData",
  "ltPropRightData",
  "ltPropPinnedData",
  "ltPropSortable",
  ...
  "ltPropMaxCount",
  "ltPropDoubleClick",
  "ltPropSelectAllChild",
  "ltPropNoResultMessage",
  "ltPropAriaRoleDescription",
  "ltPropKeepOriginal",
  "ltPropMandateKey",
  ...
  "ltPropInfiniteScrollElementCount",
  "ltPropShowSearch",
  "enableInfiniteScroll",
  "infiniteScrollPopulateData",
  "listboxLeftAriaDescendant",
  "listboxRightAriaDescendant",
  "ariaLabelledById",
  "focusActiveBoolean",
  "ariaLiveContentBoolean",
  "ariaLiveContent",
  "dragHasStarted",
  "noResultsFound",
  "noResultsFoundRight",
  ...
  "selectedIndexLeft",
  "selectedIndexRight",
  "leftShiftSelectIndex",
  "rightShiftSelectIndex",
  "insertAtLeftInd",
  "insertAtRightInd",
  "elementPosition",
  "activeSide",
  "previousClickedElemDomInd",
  "focusedOnTab",
  "initialClientX",
  "initialClientY",
  "firstUpDownClick",
...
LyteDualListboxComponent.register("lyte-dual-listbox", {
  hash: "LyteDualListboxComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(72817000)));
