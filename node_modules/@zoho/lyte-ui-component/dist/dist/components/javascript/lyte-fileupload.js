"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-fileupload"],{

/***/ 56751818:
/*!**************************************************!*\
  !*** ./components/javascript/lyte-fileupload.js ***!
  \**************************************************/
 ...
 */
class LyteFileuploadComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    ...
    didConnect() {
		...
		this.$node.predefined = function (files) {
			...
			for(var index=0;index<files.length;index++){
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.data.predefinedList,"push",files[index]);
			}
		}.bind(this);
        /**
		* @utility addFiles
    ...
    data(arg1) {
		return Object.assign(super.data({
			 ...
			 */
			ltPropName: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', { "default": "file" }),
			/**
			 * @componentProperty {boolean} ltPropMultiple=true
			 */
			ltPropMultiple: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { "default": true }),
			/**
			 * @componentProperty {string} ltPropAccept
			 */
			ltPropAccept: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', { "default": '' }),
			/**
			 * @componentProperty {string} ltPropId
			*/
			ltPropId: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', { "default": '' }),
			/**
			 * @componentProperty {string} ltPropClass
			 */
			ltPropClass: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', { "default": '' }),
			/**
			 * @componentProperty {Box | Btn | Input} ltPropAppearance=Box
			 */
			ltPropAppearance: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', {
			 ...
			 */
			ltPropDisabled: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { "default": false }),
			// file uploader data
			/**
			 * @componentProperty {boolean} ltPropYield=false
			 */
			ltPropYield : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'boolean', { "default" : false } ),
			// ltPropMultipleUpload : Lyte.attr( 'boolean', { default : true } ),
			/**
			 * @componentProperty {number} ltPropFileLimit
			*/
			ltPropFileLimit : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'number', { "default" : window._lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'fileLimit', undefined ) } ),
			/** 
			 * @componentProperty {number} ltPropMinimumFileSize=0
			 * @version 2.2.11
			*/
			ltPropMinimumFileSize : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'number',{"default": window._lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'minimumFileSize', 0 ) } ),
			/** 
			 * @componentProperty {number} ltPropTotalFilesSize
			 * @version 3.2.1
			*/
			ltPropTotalFilesSize : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string'),
			/** 
			 * @componentProperty {number} ltPropParallel=2
			*/
			ltPropParallel : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'number', { "default" : 2 } ),
			/** 
			 * @componentProperty {boolean} ltPropAutoUpload=true
			*/
			ltPropAutoUpload : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'boolean', { "default" : true } ),
			/** 
			 * @componentProperty {boolean} ltPropTriggerUpload=false
			*/
			ltPropTriggerUpload : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'boolean', { "default" : false } ),
			/** 
			 * @componentProperty {string} ltPropParamName=file
			 */
			ltPropParamName : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'string', { 
			 ...
			 */
			ltPropThumb : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'boolean', { "default" : false } ),
			/** 
			 * @componentProperty {number} ltPropTabindex=0
			 */
			ltPropTabindex : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'number', { "default" : 0 } ),
			/** 
			 * @componentProperty {number} ltPropRetry=2
			 */
			ltPropRetry : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'number', { 
			 ...
			 */
			ltPropFileUnit : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'string', { "default" : '' } ),
			/**
			 * @componentProperty {number} ltPropDigits=1
			 */
			ltPropDigits : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'number', { 
			 ...
			 */
			ltPropMessage: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', {
			 ...
			 */
			ltPropFailureMessage: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', {
			 ...
			 */
			ltPropRetryText: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', {
				"default": window._lyteUiUtils.resolveDefaultValue('lyte-fileupload', 'retryText', "Retry")
			}),
			ltPropFiles: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array", { "default": [] }),
			/**
			 * @componentProperty {boolean} ltPropChunk=false
			 */
			ltPropFolder: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false }),
			// chunking
			/**
			 * @componentProperty {boolean} ltPropChunk=false
			 */
			ltPropChunk: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { "default": false }),
			/**
			 * @componentProperty {number} ltPropChunkSize=2000000
			 */
			ltPropChunkSize: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number', { "default": 2000000 }),
			/**
			 * @componentProperty {boolean} ltPropParallelChunkUpload=false
			 */
			ltPropParallelChunkUpload: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { "default": false }),
			/**
			 * @componentProperty {number} ltPropParallelChunkCount=Infinity
			 */
			ltPropParallelChunkCount: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number', { "default": Infinity }),
			/**
			 * @componentProperty {number} ltPropChunkRetry=2
			 */
			ltPropChunkRetry: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number', { "default": 2 }),

			// preventing multiple upload
			/**
			 * @componentProperty {boolean} ltPropUploadMultiple=false
			 */
			ltPropUploadMultiple: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { "default": false }),
			/**
			 * @componentProperty {number} ltPropUploadMultipleCount=Infinity
			 */
			ltPropUploadMultipleCount: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number', { "default": Infinity }),
			/**
			 ...
			 */
			ltPropAjax: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('object', { "default": { url: '' } }),
			/**
			 * @componentProperty {boolean} ltPropAllowReplace=false
			 */
			ltPropAllowReplace: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false }),
			/**
			 * @componentProperty {number} ltPropFilesCount=Infinity
			 * @version 3.25.0
			 */
			ltPropFilesCount : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("number",{"default" : Infinity}),
			/**
            * @componentProperty {object} ltPropAriaAttributes
            * @version 3.1.0
            * @default {}
            */
 			ltPropAriaAttributes : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'object', { default : window._lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'ariaAttributes', {
				role : "button",
            ...
            * @version 3.59.0
			*/
			ltPropReset : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{ default : false}),
			/**
			* @componentProperty {boolean} ltPropReset=false
			* @version 3.59.0
			*/
			ltPropPreventDuplicate : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{ default : false}),
			ltPropListErrorFiles : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { default : false}),

			ltPropResetFileValue : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { default : false}),
			ltPropAria : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{default : false}),
			ltPropDataTabindex : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string",{ default : ""}),
			ltPropValidateByExt : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{ default : false}),
			ltPropRenameDuplicateFile : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{ default : false}),
			ltPropActiveElement : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{ default : false}),
			// system data
			queueList : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'array', { "default" : [] } ),
			predefinedList : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('array',{ "default" : []}),
			currentUpload : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'array', { "default" : [] } ),
			chunkUpload : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('array',{ "default" : []}),
			fileClass : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)( 'string', { "default" : '' } ),
			chunkCount : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number', { "default" : 0}),
			abort : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{ "default" : false}),
			lxhrs : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" : []}),
			uploadedFiles : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" :[]}),
			manualUpdFiles : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" :[]}),
			uploadMultipleRetry : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number',{"default":0}),
			retryFiles : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('array',{"default" : []}),
			retry : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean',{"default" : false}),
			manualUpload : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean',{"default" : false}),
			totalFilesSize : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number'),
			curTotFilesSize : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number',{"default":0}),
			ariaCloseLabel : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string"),
			commonAriaLabel : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object",{"default": {}}),
			ariaSelectedFiles : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string",{"default": "0"}),
			randomAriaId:(0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string")
		}), arg1);		
	}
    ...
    validate(files) { 
		...
		for( var j = 0; j < files.length; j++ ) {
			...
			if ( Object.keys(reason).length > 0 ){ 
				...
				if(listErrorFiles) { 
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.queueList, 'push', fileObject );
				}
    ...
    constructFileObject(file, isChunk, fileType, errorMsg) {
		var fileObject = { id : 'lyte' + new Date().getTime() + parseInt( Math.random() * 10E10 ), file : file, size : file.size, name : file.name, isChunk: isChunk, retry : 0, fileType : ( fileType? fileType:'document') };
 		if( this.data.ltPropThumb && /image/i.test( file.type ) ) {
 			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( fileObject, 'src', URL.createObjectURL( file ) );
		}
		if(errorMsg) {
    ...
    add(file, fileObject) { //fileobject => file info,  file =>File Constructor
		...
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.uploadedFiles, 'push', fileObject );
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.ltPropFiles, 'push' , file);
			...
			if (!current.status || (current.isChunk && current.status == "uploading")) {
				if (current.isChunk) {
					...
					if(data.currentUpload.length < data.ltPropParallel){
						this.setData("manualUpload",true);
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( data.currentUpload, 'push', current );
						this.uploadFile( current );
						index++;
					}
					else {
    ...
    processqueue(id, check, frmRetry) {
		 ...
		 if(id && !frmRetry){
			...
			for( var i = 0; i < id.length; i++ ) {
				...
				if(file){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.manualUpdFiles, 'push', file );
				}
			}
		...
		if (data.manualUpload) {
 		...
 		while( ( ((data.currentUpload.length < data.ltPropParallel) || (data.ltPropUploadMultiple && data.currentUpload.length < data.ltPropUploadMultipleCount)) /*|| ( !data.ltPropMultipleUpload && !data.currentUpload.length ) */) || frmRetry && data.queueList.length  ) {
 			...
 			if( id ) {
				...
				if(frmRetry && current){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.retryFiles, 'push', current );
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( current, 'status', 'reloading' );
					if(data.uploadedFiles.indexOf(current) < 0){
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.uploadedFiles, 'push', current );
       ...
       for(var index =0 ; index < retryFiles.length ;){
           ...
           if(current.status == "reloading"|| current.status == "uploading"){
               if(current.isChunk){
                   ...
                   if(data.currentUpload.length < data.ltPropParallel){
                       this.setData("retry",true);
                       (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(retryFiles,"removeAt",index);
                       (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( data.currentUpload, 'push', current );
    ...
    removeFrmUpload(idd, arrnme, prevent, check) {//need to be checked
 		...
 		for( var i = 0; i < idd.length; i++ ) {
			...
			if (crct >= 0) {
				...
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( arr, 'removeAt', crct );
				if(arrnme === "queueList"){
					var lxhrs = this.getData("lxhrs");
					var lxhr = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().search(lxhrs, "fileId", cur.id)[0], index;
					if (cur.isChunk && flag) {
						this.getMethods("onFileFailure") && this.executeMethod('onFileFailure', lxhr, cur, this.$node, true);
					}
					if(!cur.lyteErrorMsg) {
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( this.data.ltPropFiles, 'removeAt', crct );
						this.removeFromTotalFileSize(cur.size)
					}
					var temparray=this.data.uploadedFiles,tempId = this.findIndex( temparray,  this.chkId.bind( this, id ) )
					if( tempId >= 0 ) {
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( temparray, 'removeAt', tempId );
					}
					...
					index > -1 && (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(lxhrs,'removeAt',index);
					if( crct <= i ) {
						i--;
					}
				}
    ...
    succFunc(evt) {
		if(this.$node){
			...
			for( var i = 0; i < file.length; i++ ){
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file[ i ], 'status', 'success' );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( file[ i ], 'delete', 'xhr' );
				if(!this.data.ltPropUploadMultiple){
					var lxhrs =this.getData("lxhrs");
					duplicate = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().search(lxhrs,"fileId",file[i].id);
					duplicate.length  && (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(lxhrs,'removeAt',lxhrs.indexOf(duplicate[0]));
					ret.fileId = file[i].id;
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData("lxhrs"),'push',ret);
    ...
    reject(evt) {
		if(this.$node){
			...
			if(this.data.abort || retry >= this.data.ltPropRetry  || (this.data.ltPropUploadMultiple && this.data.uploadMultipleRetry  >= this.data.ltPropRetry) ) {
				...
				for( var i = 0; i < file.length; i++ ){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file[ i ], 'status', 'error' );
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( file[ i ], 'delete', 'xhr' );
					if(! this.data.ltPropUploadMultiple){
						var lxhrs =this.getData("lxhrs");
						duplicate = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().search(lxhrs,"fileId",file[i].id);
						...
						!this.data.abort  && (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData("lxhrs"),'push',ret);
					}
					else {
						tempRet.push(file[i].id);
					}
				...
				if(this.data.abort){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( evt.xhr.file, 'add', 'retry', this.data.ltPropRetry );
					this.setData("abort",false);
				}
				delete evt.xhr.file;
			} else {
				if(!this.data.ltPropUploadMultiple){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( evt.xhr.file, 'status', 'retrying' );
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( evt.xhr.file, 'add', 'retry', retry + 1 );
					...
					delete file.xhr;
					for( var i = 0; i < file.length; i++ ){
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( evt.xhr.file[i], 'status', 'retrying' );
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( evt.xhr.file[i], 'retry', evt.xhr.file[i].retry +1 );
					}
    ...
    progress(evt) {
 		if( evt.lengthComputable ) {
	 		...
	 		for( var i = 0; i < file.length; i++ ){ 
				if(this.data.ltPropUploadMultiple){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file[ i ] , { loaded : file[i].size, percentage : 100 } );
				}
				else{
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file[ i ] , { loaded : upload, percentage : Math.round( upload * 100 / total ) } );
				}
    ...
    removeChunk(id, origin, prevent) {
 		...
 		if( cur > -1 ) {
 			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( arr, 'removeAt', cur );
    ...
    chunkReject(evt) {
		if(this.$node){
			...
			if( !this.data.abort && file.retry < this.data.ltPropChunkRetry) {
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file, 'status', 'retrying' );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( file, 'add', 'retry', file.retry + 1 );
				this.removeChunk( file.chunkProp.chunkId, origin, true );
				this.getMethods( 'onRetry' ) && this.executeMethod( 'onRetry',ret, file, this.$node );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'currentUploadingChunks', origin.currentUploadingChunks - 1 );
				this.processChunkQueue( file, true );
			} else {
				this.getMethods( 'onRequestFailure' ) && this.executeMethod( 'onRequestFailure', ret, file, this.$node,this.data.abort );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file, 'status', 'error' );
				this.removeChunk( file.chunkProp.chunkId, origin, true );
				this.getMethods( 'onChunkError' ) && this.executeMethod( 'onChunkError', ret, file, origin, this.$node,this.data.abort );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( file, 'delete', 'xhr' );
				delete evt.xhr.file; 	
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'currentUploadingChunks', origin.currentUploadingChunks - 1 );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'error', origin.error + 1 );
				if( origin.status != 'error' ) {
					var lxhrs =this.getData("lxhrs"),duplicate;
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'status', 'error' );
					//Lyte.Component.set( this.getData("lxhrs"), origin.id, ret );
					duplicate = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().search(lxhrs,"fileId",origin.id);
					duplicate.length  && (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(lxhrs,'removeAt',lxhrs.indexOf(duplicate[0]));
    ...
    chunkSuccess(evt) {
		if(this.$node){
			...
			this.getMethods( 'onRequestSuccess' ) && this.executeMethod( 'onRequestSuccess', ret, file, this.$node );
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file, 'status', 'success' );
			this.removeChunk( file.chunkProp.chunkId, origin,true );
			this.getMethods( 'onChunkSuccess' ) && this.executeMethod( 'onChunkSuccess', ret, file, origin, this.$node );
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( file, 'delete', 'xhr' );
			delete arguments[ 2 ].xhr.file;
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'finished', origin.finished + 1 );
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'currentUploadingChunks', origin.currentUploadingChunks - 1 );
			if( origin.finished == origin.total ) {
				var lxhrs =this.getData("lxhrs"),duplicate;
			   	(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, 'status', 'success' );
				duplicate = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().search(lxhrs,"fileId",origin.id);
				duplicate.length  && (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(lxhrs,'removeAt',lxhrs.indexOf(duplicate[0]));
				ret.fileId = origin.id;
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData("lxhrs"),'push',ret);
    ...
    chunkProgress(evt) {
 		if( evt.lengthComputable ) {
 			...
 			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file, 'loaded', upload );
 			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( origin, { loaded : Math.min( origin.loaded + diff, origin.size ), percentage : Math.min( Math.round( ( origin.loaded + diff ) * 100 / origin.size ), 100 ) } );
    ...
    proceedChunk(files, props) {
		 ...
		 (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( files, { chunks : blobs, error : 0, finished : 0, total : blobs.length } );
    ...
    processChunkQueue(blobs, frmFail) {
		...
		while( (!data.ltPropParallelChunkUpload && data.chunkUpload.length < 1) || ((data.ltPropParallelChunkUpload && (data.ltPropParallelChunkCount === Infinity ) || (data.ltPropParallelChunkCount != Infinity && /*data.ltPropMultipleUpload &&*/ data.chunkUpload.length < data.ltPropParallelChunkCount)) /*|| ( !data.ltPropMultipleUpload && !data.currentUpload.length )*/ ) ) {
			...
			if (!/success|uploading/.test(bb.status) && (!frmFail || (frmFail && !/error/.test(bb.status)))) {
				...
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file, { status : 'uploading', percentage : file.percentage || 0, loaded : file.loaded || 0, size : file.size , currentUploadingChunks : file.currentUploadingChunks+1 || 1 } )
				this.proceedUpload( bb, this.$addon.deepCopyObject( data.ltPropAjax ), true );
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)( data.chunkUpload, 'push', bb );
				idx++;
			} else {
				idx++;
				continue;
    ...
    finishSend(props, xhr, file, isChunk) {
 		if( Array.isArray(file) ){
 			for( var i = 0; i < file.length; i++ ){
 				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file[ i ], 'status', 'uploading' );
 			}
 		} else {
 			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.set)( file, 'status', 'uploading' );
 		}
 		var ret = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().ajax( props );
 		ret.xhr = xhr;
 		xhr.ret = ret;
    ...
    openFileWindow(evt, fromEnter) {
       if( !this.data.ltPropYield  && this.data.ltPropMultiple ) {
           if( !evt.shiftKey ){
               _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( '#lyteFileUpdSelectedFile.lyteFileUpdListFile', this.$node ).removeAttr( 'id' );
           } else{
               evt.preventDefault();
           }
           if(evt.target.className != "lyteFileUpdRetryMsg"){
               _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( evt.target ).closest( '.lyteFileUpdListFile' ).attr( 'id', 'lyteFileUpdSelectedFile' );
           }
       }
       if( evt.ctrlKey || evt.shiftKey || evt.metaKey ){
           return
       }
       var isSelectArea, close = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( evt.target ).closest( 'lyte-file-close' );
       if( close.length ) {
           this.$node.removeUpload( close.eq( 0 ).attr( 'data-value' ) )
           return;
       }
       var retry = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( evt.target ).closest( 'lyte-file-retry' );
       if( retry.length ) {
           var fileId = retry.eq( 0 ).attr( 'data-value' );
           this.$node.upload( fileId,undefined,true );
           return;
       }
       isSelectArea = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( evt.target ).closest( 'lyte-file-select-area' ).length || fromEnter || evt.target.classList.contains("fileUploadWrapper");
    ...
    static actions(arg1) {
        return Object.assign(super.actions({
            ...
            keydown : function( evt ){
                if( evt.which == 8 ){
                    var elem = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( "#lyteFileUpdSelectedFile lyte-file-close", this.$node )
...
LyteFileuploadComponent.register("lyte-fileupload", {
    hash: "LyteFileuploadComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(56751818)));
