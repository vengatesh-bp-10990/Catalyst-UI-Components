"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-timeline-view"],{

/***/ 91831682:
/*!*****************************************************!*\
  !*** ./components/javascript/lyte-timeline-view.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteTimelineViewComponent": () => (/* binding */ LyteTimelineViewComponent)
/* harmony export */ });
...
class LyteTimelineViewComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			...
			* @default month
             */
			ltPropView : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string' ,{default : 'month'} ),
			/**
             * @componentProperty {string} ltPropArrowKey
             */
			ltPropArrowKey : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string',{default : ''}),
			/**
             * @componentProperty {false|true} ltPropWorkingDay
			 * @default false
             */
			ltPropWorkingDay : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default : false}),
			/**
             * @componentProperty {object} ltPropDateWidth
             */
			ltPropDateWidth : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default : { 'day' :  220 , 'month' : 20 , 'week' : 40 , 'quarter' : 8 }}),
			/**
             ...
             */
			ltPropGroupby : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default : []}),
			/**
             * @componentProperty {false|true} ltPropGroup
			 * @default false
             */
			ltPropGroup : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default : false}),
			/**
             * @componentProperty {number} ltPropMaxHeight
             */
			ltPropMaxHeight : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number'),
			/**
             ...
             */
			ltPropHoverCardData : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default:[]}),
			/**
             * @componentProperty {string} ltPropNoRecordFound
             */
			ltPropNoRecordFound : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string',{default:'No Record Found'}), 
			/**
             * @componentProperty {string} ltPropSortKey
             */
			ltPropSortKey: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string',{default:'start'}),
			/**
             * @componentProperty {string} ltPropGroupbyPanelWidth
			 * @default 200px
             */
			ltPropGroupbyPanelWidth : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string',{default: '200px'}),
			/**
             * @componentProperty {array} ltPropNonWorkingDays
			 * @default [0,6]
             */
			ltPropNonWorkingDays : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default : [0,6]}),
			/**
             * @componentProperty {number} ltPropWeekStart
			 * @default 0
             */
			ltPropWeekStart : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number',{default: 0}),
			/**
             * @componentProperty {string} ltPropRestrict
             */
			ltPropRestrict : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string',{default : ''}),
			/**
             * @componentProperty {boolean} ltPropLoaderYield
			 * @default false
             */
			ltPropLoaderYield : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default: false}),
			ltPropMaxEventCountLength : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number',{default: 5}),
			ltPropMinResizeWidth : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number',{default: 20}),
			ltPropArrowkeyYield : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default : false}),
			ltPropHolidaylist : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default : []}),
			ltPropHolidayObject: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default:{}}),
			ltPropHolidayFormat : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('string',{default: 'DD-MM-YYYY'}),
			groupByData : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default:[]}),
			ltPropManipulatedEvent : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default:[]}),
			timeline : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default : []}),
			populateObject : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default:{}}),
			EventIndex : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number',{default:0}),
			populateIndex : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number',{default:0}),
			rightIntersectionObserver : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default : {}}),
			leftIntersectionObserver : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('object',{default : {}}),
			headerArray : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default : []}),
			subheader : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('array',{default : []}),
			months :  (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)( 'array', { default : [ 'January', 'February', 'March', 'April', 'May','June' ,'July','August','September','October','November','December' ] } ),
			prevScroll: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('number',{default:0}),
			enableGroup: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_1__.prop)('boolean',{default : false})
		}), arg1);		
	}
    ...
    init() {
		...
		this.$node.removeEvent = function( evtId ){
			...
			if( delIdx !== -1 ){
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(events,'removeAt',delIdx,1);
			}
		...
		this.$node.addGroupEvent = function( groupHead , events , isloadmore ,insertIndex){
			...
			if(insertIndex == undefined || !group.children){
				if(!group.children){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(group,'add','children',[]);
				}
				insertIndex = group.children.length; 
			}
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(group.children,'insertAt',insertIndex,events);
			_this.setIndex(group.children);
			var loadmore = isloadmore ? 1 : 0;
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(group,'add','rowCount', (group.children.length + isloadmore));
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(group,'add','loadmore',isloadmore);
		...
		this.$node.deleteGroupEvent = function( groupHead , eventid , isloadmore){
			...
			if(group.children){
				...
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(group.children,'removeAt',event.index-1,1);
			}
			_this.setIndex(group.children);
			var loadmore = isloadmore ? 1 : 0;
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(group,'add','rowCount', group.children.length + loadmore);
			$L.fastdom.mutate(function(){
				var accordion = $L('[group="'+groupHead+'"]',_this.$node)[0];
				if(accordion){
		...
		this.$node.today = function(prevScorllAnimation){
			...
			var isRTL = window._lyteUiUtils.getRTL();
		...
		this.$node.UpdateGroupHeader = function( groupHead , key , value ){
			...
			var index = _this.groupIndex( groupHead );
			if(groupArr[index]){
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(groupArr[index],'add',key,value);
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(RendergroupArr[index],'add',key,value);
			}
			_this.setTodayPosition();
		}
    ...
    updateValue(eventId, value, events, key, container) {
		var delIdx = events.findIndex(function( elem ){
			return elem.id === eventId ? true : false;
		});
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(events[delIdx],'add',key,value);
    ...
    generateTodayTimeline(scroll, isRTL, groupWidth, prevScorllAnimation) {
		scroll.style.scrollBehavior = '';
    ...
    intializeTimeline(init, isScrolled) {
		var view = this.getData('ltPropView');
		var _this = this;
		var scroll = $L('.lyteTimelineViewContentElem',this.$node)[0];
		var isRTL = window._lyteUiUtils.getRTL();
    ...
    getLastDayOftheViewPort() {
		if(window._lyteUiUtils.getRTL()){
			var endDate = document.elementFromPoint($L('.lyteTimelineViewContentElem',this.$node)[0].getBoundingClientRect().left + window._lyteUiUtils.getScrollBarWidth() + 20 ,$L('.lyteTimelineViewHeaderElem',this.$node)[0].getBoundingClientRect().top);
		}else{
			var endDate = document.elementFromPoint($L('.lyteTimelineViewContentElem',this.$node)[0].getBoundingClientRect().right - window._lyteUiUtils.getScrollBarWidth() - 20 ,$L('.lyteTimelineViewHeaderElem',this.$node)[0].getBoundingClientRect().top);
		}
		if(endDate){
    ...
    boundaryCondition(headerElem, draggable, isRTL) {
    ...
    setIndex(events) {
		...
		for( var ind=0;ind<events.length;ind++ ){
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( events[ind], 'add', 'index', value++);
		}
	}

    setTimeline(date, fromArrow, init) {
		var view = this.getData('ltPropView');
    ...
    intializeInfinteScroll(view, init) {	
		var scroll = $L('.lyteTimelineViewContentElem',this.$node)[0];
		var _this = this;
		var timeline = this.getData('timeline');
    ...
    UpdateOnRight(scroll, view) {
		...
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(timeline,'insertAt',timeline.length  ,timelineHeader.timeline);
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(headerArray,'insertAt',headerArray.length ,timelineHeader.headerArray);
    ...
    UpdateOnLeft(scroll, view, target) {
		...
		headerArray.forEach(function(item ){
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( item,'add','startColumn', item.startColumn + timelineHeader.timeline.length );
		});
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(headerArray,'insertAt',0,timelineHeader.headerArray);
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(timeline,'insertAt',0,timelineHeader.timeline);
    ...
    updatesubHeader(subheader, index) {
		subheader.forEach(function(item ){
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( item ,'add','startColumn', item.startColumn - index );
		})
		return subheader;
	}
    ...
    removeDateSection(removePos, view, count) {
		...
		if(removePos == 0){
			...
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(timeline,'removeAt',0,index);
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(headerArray,'removeAt',0,headerCount );
			if(view == 'quarter'){
				var endCount = 1;
				for(var Index = 0 ; Index < headerArray.length; Index++){
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)( headerArray[Index] ,'add','startColumn', endCount );
			...
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(timeline,'removeAt', timelineRemoveStartpos , index );
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(headerArray,'removeAt',removePos+1,headerCount);
		}
		return index ;
	}
    ...
    findDateinHolidayList(holidayList, date) {
		var flag = true;
		if(holidayList){
			var year = date.getFullYear();
			var month = date.getMonth()+1;
    ...
    generateTimeline(date, maxNoOfDate, view, isweek, isQuarterView, startIndex, fromArrow) {
		var timeline = [];
    ...
    updatePopulateObj(scrollTop) {
		...
		while( ind < objLen && eventEvent.length > eventIndex){
			if(eventEvent[eventIndex]){
				(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(populateObject, 'add', 'elemt'+ind, eventEvent[eventIndex]);
			}
			eventIndex++;
			ind++;
		}	
    ...
    setEventPosition(event, eventDiv, scroll) {
    ...
    setarrowPosition(event, eventDiv, scrolloffsetLeft) {
		...
		if(window._lyteUiUtils.getRTL()){
			...
			containmentLeft += window._lyteUiUtils.getScrollBarWidth();
		}else{
			arrowOffsetRight = arrowOffset.right;
			arrowOffsetLeft = arrowOffset.left; 
			var noEnddiv = $L('.lyteTimeLineViewNoEndElem',eventDiv)[0];
			...
			containmentRight -= window._lyteUiUtils.getScrollBarWidth();
		}
		...
		if( isVisible &&  (arrowOffsetLeft > containmentRight)  ){
			...
			if(window._lyteUiUtils.getRTL() && arrowOffsetRight >  containmentRight ){
				RightArrow.classList.remove('lyteTimelineViewHideArrow');
			}else if(!window._lyteUiUtils.getRTL() && arrowOffsetRight >  containmentRight){
				RightArrow.classList.remove('lyteTimelineViewHideArrow');
			}
    ...
    setArrowAndEventPosition(setArrow, setEvent, scroll) {
		var group = this.getData('ltPropGroup');
		var _this = this;
		var scrollOffset;
		if(scroll){
    ...
    setTodayPosition() {
		...
		if(CurrentDiv){
			...
			today.style.height = $L('.lyteTimelineViewContentElem',this.$node)[0].getBoundingClientRect().height - 1 - window._lyteUiUtils.getScrollBarWidth() + 'px';
			...
			if(todaynotinview){
				...
				todayDiv.innerHTML = ' ';
				var createTextNode = document.createTextNode( window._lyteUiUtils.i18n( 'today' ) + ' *' + currDate.format('DD') + ' ' + window._lyteUiUtils.i18n( currDate.format('MMMM') ) + ' ' + currDate.format('YYYY') );
				todayDiv.appendChild(createTextNode);			
			}else{
				today.classList.remove('lyteTimelineViewTodayNotInView');
				todayDiv.innerHTML = ' ';
				var createTextNode = document.createTextNode( window._lyteUiUtils.i18n( 'today' ) );
				todayDiv.appendChild(createTextNode);
			}
		}else{
    ...
    addGroupByUser(index) {
		var userList = this.getData('ltPropGroupby');
		if(!userList[index]){
			this.isHasScroll();
			return;
		}
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.arrayUtils)(this.getData('groupByData'),'push',userList[index]);
		var _this = this;
		$L.fastdom.mutate(function(){
			_this.setTodayPosition();
		})
    ...
    findNoOfworkingDay(date, endDate, notfromStart) {
		if(notfromStart){
    ...
    showHoverCard(target) {
		...
		if(hoverDate){
			...
			hoverCardDiv.style.height = this.$node.getBoundingClientRect().bottom - hoverCardDiv.getBoundingClientRect().top  - window._lyteUiUtils.getScrollBarWidth() + 'px';
    ...
    getResizeDate(eventDiv, direction, events) {
		var isRTL = window._lyteUiUtils.getRTL();
    ...
    callonArrowTextClick(eventdata) {
		if(this.getMethods('onTextArrowClick')){
			this.executeMethod('onTextArrowClick',eventdata)
		}
	}

    updateCurrentEnd(eventDiv, value, direction, eventData, event) {
    ...
    updateCurrentStart(eventDiv, value, direction, eventData, event) {
    ...
    DateDivLeftGreaterthanEventTagLeft(currentDiv, EventTag, date, view, Minwidth) {
		if(view == 'quarter'){
			date = date ? date : 0;
    ...
    DateDivRightLessthanEventTagLeft(currentDiv, EventTag, date, view) {
		if(view == 'quarter'){
			date = date ? date : 0;
    ...
    DateDivRightLessthanEventTagRight(currentDiv, EventTag, date, view, Minwidth) {
		if(view == 'quarter'){
			date = date ? date : 0;
			var width = date * this.getData('ltPropDateWidth')[view];
    ...
    DateDivLeftGreaterthanEventTagRight(currentDiv, EventTag, date, view) {
		if(view == 'quarter'){
			date = date ? date : 0;
			var width = date * this.getData('ltPropDateWidth')[view];
			return (currentDiv.getBoundingClientRect().left + width) > EventTag.getBoundingClientRect().right
    ...
    DateDivLeftLessthanEventTagLeft(currentDiv, EventTag, date, view) {
		if(view == 'quarter'){
			var width = date * this.getData('ltPropDateWidth')[view];
			return (currentDiv.getBoundingClientRect().left + width) < EventTag.getBoundingClientRect().left;
		}else{
    ...
    mousePositionReset(eventTagOffset, minWidth, direction, isRTL) {
		if(isRTL){
			if(direction == 'left'){
    ...
    intializeColorManipulator(colorCode, eventTag) {
		if(colorCode){
    ...
    cloneResizePlaceholder(eventDiv, eventTag, direction, events, scroll, group, iskey) {
    ...
    isNotAbsoluteEvent(eventDiv, eventTag) {
		if(!eventDiv.classList.contains('lyteTimelineViewAbsoluteEvent')){
			$L('lyte-yield',eventTag)[0].style.visibility = 'hidden';
		  	return true;
		}
    ...
    removeKeyResizedate(format, events, group, eventDiv) {
    ...
    static actions(arg1) {
        return Object.assign(super.actions({
            ...
            onarrowclick : function(eve,curr_event,dir,group){
                ...
                if(this.getData('ltPropGroup') && !window._lyteUiUtils.getRTL()){
            ...
            onmousedownEvent : function(event,direction,eventDiv,events,group){
                ...
                var mouseUpFunc = function(){
                    ...
                    if(_this.getData('ltPropView') == 'quarter'){
                        ...
                        if( (!window._lyteUiUtils.getRTL() && direction == 'right') || (window._lyteUiUtils.getRTL() && direction == 'left')){
...
LyteTimelineViewComponent._template = "<template tag-name=\"lyte-timeline-view\"> <div class=\"lyteTimelineViewTable {{if(enableGroup,'lyteTimelineViewWithGrouping')}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(enableGroup,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewContentElem {{lyteUiTimelineViewGetViewClass(ltPropView)}} {{lyteUiTimelineViewHasScroll(ltPropManipulatedEvent,ltPropMaxHeight)}}\" style=\"--lyte-timelineview-row-end: {{lyteUiTimelineViewRowCount(ltPropManipulatedEvent,ltPropMaxHeight)}}; --lyte-timelineview-column-size: {{expHandlers(ltPropDateWidth[ltPropView],'+','px')}}; --lyte-timelineview-column-gridline-temp: {{expHandlers(expHandlers(ltPropDateWidth[ltPropView],'+',1),'+','px')}};\"> <div class=\"lyteTimelineViewHeaderRowWrap\"> <div class=\"lyteTimelineViewHoverCardDiv lyteTimelineViewHoverCardHide\"> <div class=\"lyteTimelineViewHoverCard\"> <lyte-yield yield-name=\"hover-card\" timeline-event=\"{{item}}\" hover-data=\"{{ltPropHoverCardData}}\"> </lyte-yield> </div> </div> <div class=\"lyteTimelineViewHeaderRow\"> <template items=\"{{headerArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewPrimaryHeaderElem lyteTimelineViewHeaderMonthElem\" style=\"--lyte-timelineview-col-number: {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\" onmouseenter=\"{{action('onDateHover',event,this,item)}}\" onmouseleave=\"{{action('onDateMouseOut')}}\"> <span class=\"lyteTimelineViewPeriodLabel\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','week')}}\" is=\"case\" lc-id=\"lc_id_0\"> {{item.week}} </template><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_1\"> <span class=\"lyteTimelineViewHeaderPrimaryLabel\">{{item.quarter}}</span> <span class=\"lyteTimelineViewYearLabel\">{{item.year}}</span> </template><template default=\"\"> <span class=\"lyteTimelineViewHeaderPrimaryLabel lyteTimelineViewMonthLabel\">{{lyteUiTimelineViewGetMonth(item.month,months)}}</span> <span class=\"lyteTimelineViewYearLabel\">{{item.year}}</span> </template></template></span> </div></template> </div> <div class=\"lyteTimelineViewHeaderRow\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewSecondaryHeaderElem lyteTimelineViewHeaderElem {{lyteUiTimelineViewFindWeekend(item,ltPropView,ltPropNonWorkingDays,ltPropHolidayObject)}} {{if(item.isendOfView,'lyteTimelineViewEndOfSection','')}}\" style=\"--lyte-timelineview-col-number: {{expHandlers(index,'+',1)}}; --lyte-timelineview-lineCount:{{lyteUiTimelineViewLineCount(item,null,this,ltPropView)}};\" data-date=\"{{lyteUiSchedulerGetDate(item)}}\" id=\"{{lyteUiSchedulerGetDate(item)}}\" onmouseenter=\"{{action('onDateHover',event,this)}}\" onmouseleave=\"{{action('onDateMouseOut')}}\"> <div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_0\"> {{lyteUiTimelineViewGetMonth(item,months)}} </template><template default=\"\"> {{lyteUiTimelineViewGetDay(item,ltPropView)}} </template></template></div> </div></template> </div> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropManipulatedEvent.length}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteTimelineViewEventsContainer\"> <template object=\"{{populateObject}}\" value=\"item\" key=\"index\" is=\"forIn\" _new=\"true\"><div class=\"lyteTimelineViewEventDiv {{lyteUiTimelineViewCss(item,this,timeline,ltPropView)}} {{if(expHandlers(item.end,'!'),'lyteTimeLineViewNoEnd','')}}\" id=\"{{item.id}}\" onmouseover=\"{{action('onEventHover',event,item,this)}}\" onmouseleave=\"{{action('onEventOut',event,item,this)}}\" onfocusin=\"{{action('onEventHover',event,item,this)}}\"> <div class=\"lyteTimelineViewEvent {{lyteUiTimelineViewAddClass(item.class,this)}}\" style=\"{{lyteUiTimelineViewColorCode(item.color_code,this)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item.leftResize,'&amp;&amp;',item.end)}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewLeft lyteTimelineViewEventResizeHandler\" onmousedown=\"{{action('onmousedownEvent',event,'left',this,item)}}\" onkeydown=\"{{action('onkeydownEvent',event,'left',this,item)}}\" onkeyup=\"{{action('onkeyupEvent',event,this,item)}}\"></div></template></template><lyte-yield yield-name=\"timeline-event\" timeline-event=\"{{item}}\"> </lyte-yield> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item.end,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimeLineViewNoEndElem\"></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{item.dueDate}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewDue\"> </div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item.rightResize,'&amp;&amp;',item.end)}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewRight lyteTimelineViewEventResizeHandler\" onmousedown=\"{{action('onmousedownEvent',event,'right',this,item)}}\" onkeydown=\"{{action('onkeydownEvent',event,'right',this,item)}}\" onkeyup=\"{{action('onkeyupEvent',event,this,item)}}\"></div></template></template></div> </div></template> </div> <div class=\"lyteTimelineViewOverlayDiv\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','day')}}\" is=\"case\" lc-id=\"lc_id_0\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{lyteUiTimelineGridOverlay(item,ltPropView,ltPropNonWorkingDays,ltPropHolidayObject)}}\" is=\"case\" lc-id=\"lc_id_0\"><div style=\"--lyte-timelineview-col-number : {{expHandlers(index,'+',1)}};\" class=\"lyteTimelineViewOverlay \"></div></template></template></template> </template><template case=\"{{expHandlers(ltPropView,'==','month')}}\" is=\"case\" lc-id=\"lc_id_1\"> <template items=\"{{headerArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewOverlay {{if(lyteUiTimelineGridOverlay(item,ltPropView,index),'lyteTimelineViewEvenSection','lyteTimelineViewOddSection')}}\" style=\"--lyte-timelineview-col-number : {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\"></div></template> </template><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_2\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><lyte-timeline-view-overlay class=\"lyteTimelineViewOverlay {{lyteUiTimelineViewMonthClass(item)}}\" style=\"--lyte-timelineview-col-number : {{expHandlers(index,'+',1)}}; --lyte-timelineview-lineCount:{{lyteUiTimelineViewLineCount(item,true,this,ltPropView)}}; --lyte-timelineview-lineCountMinus:{{expHandlers(expHandlers(lyteUiTimelineViewLineCount(item,null,this,ltPropView),'-',1),'+','px')}}\"></lyte-timeline-view-overlay></template> </template><template case=\"{{expHandlers(ltPropView,'==','week')}}\" is=\"case\" lc-id=\"lc_id_3\"> <template items=\"{{headerArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewOverlay {{if(lyteUiTimelineGridOverlay(item,ltPropView),'lyteTimelineViewEvenSection','lyteTimelineViewOddSection')}}\" style=\"--lyte-timelineview-col-number : {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\"></div></template> </template></template></div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'===','day')}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteTimelineViewBg\" style=\"--lyte-timelineview-col-number: {{timeline.length}}\"></div> </template></template><div class=\"lyteTimelineViewArrowContainer\" style=\"--lyte-timelineview-col-number: {{timeline.length}}\"> <template object=\"{{populateObject}}\" value=\"item\" key=\"index\" is=\"forIn\" _new=\"true\"><div class=\"lyteTimelineViewArrow lyteTimelineViewEventArrow\" style=\"grid-row: {{item.index}}\" data-id=\"{{item.id}}\"> <div class=\"lyteTimelineViewArrowBox lyteTimelineViewLeftArrow lyteTimelineViewHideArrow\" lt-prop-title=\"\" onclick=\"{{action('onarrowclick',event,item,'left')}}\" onmouseover=\"{{action('onArrowhover',event,item,this)}}\"></div> <div class=\"lyteTimelineViewArrowBox lyteTimelineViewRightArrow lyteTimelineViewHideArrow\" lt-prop-title=\"\" onclick=\"{{action('onarrowclick',event,item,'right')}}\" onmouseover=\"{{action('onArrowhover',event,item,this)}}\"></div> <div class=\"lyteTimelineViewArrowSeparator\"></div> <div class=\"lyteTimelineViewArrowText lyteTimelineViewArrowTextHide lyteTextEllipsisNode\" onclick=\"{{action('onTextclick',event,item)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropArrowkeyYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"timeline-arrow-key\" timeline-event=\"{{item}}\"> </lyte-yield> </template><template default=\"\"> {{item[ltPropArrowKey]}} </template></template></div> </div></template> <div class=\"lyteTimelineViewHideLoadmore lyteTimelineViewLoading\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropLoaderYield,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-loader lt-prop-inline=\"true\" lt-prop-close-icon=\"false\" lt-prop-progress-bar=\"{&quot;mode&quot;: &quot;indefinite&quot; , &quot;show&quot;:false}\" lt-prop-on-timeout=\"{&quot;errorMsg&quot;:&quot; &quot;}\"> </lyte-loader> </template><template default=\"\"> <lyte-yield yield-name=\"timeline-loader\" class=\"lyteTimelineViewLoadingYield\"> </lyte-yield> </template></template></div> </div> </template><template default=\"\"> <div class=\"lyteTimelineViewNoResultDiv\" style=\"grid-column-start: 1; grid-column-end: {{timeline.length}};\"> <div class=\"lyteTimelineViewNoResultLabel\">{{ltPropNoRecordFound}}</div> </div> </template></template><div class=\"lyteTimelineViewToday\"> <div class=\"lyteTimelineViewTodayText\">Today</div> <div class=\"lyteTimelineViewTodayLineDiv\"> <div class=\"lyteTimelineViewTodayLine\"> </div> </div> </div> </div></template><template default=\"\"><div class=\"lyteTimelineViewContentElem {{lyteUiTimelineViewGetViewClass(ltPropView)}}\" style=\"--lyte-timelineview-column-size: {{expHandlers(ltPropDateWidth[ltPropView],'+','px')}}; --lyte-timelineview-column-gridline-temp: {{expHandlers(expHandlers(ltPropDateWidth[ltPropView],'+',1),'+','px')}} ; --lyte-timelineview-groupby-panel-width:{{ltPropGroupbyPanelWidth}};\"> <div class=\"lyteTimelineViewHeaderRowWrap\"> <div class=\"lyteTimelineViewGroupbyElementHeaderWrap\" style=\"--lyte-timelineview-col-number: {{expHandlers(timeline.length,'+',1)}};\"> <div class=\"lyteTimelineViewGroupbyElementHeader\"> <div>Grouped By</div> <lyte-yield yield-name=\"timeline-groupBy\"> </lyte-yield> </div> <div class=\"lyteTimeLineViewGroupbyDummyPanel\"> </div> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteTimelineViewHeaderRow \"> <template items=\"{{subheader}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineYearHeaderElem quarterHeader\" style=\"--lyte-timelineview-col-number: {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\"> <span> {{item.year}} </span> </div></template> </div> </template></template><div class=\"lyteTimelineViewHoverCardDiv lyteTimelineViewHoverCardHide\"> <div class=\"lyteTimelineViewHoverCard\"> <lyte-yield yield-name=\"hover-card\" timeline-event=\"{{item}}\" hover-data=\"{{ltPropHoverCardData}}\"> </lyte-yield> </div> </div> <div class=\"lyteTimelineViewHeaderRow\"> <template items=\"{{headerArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewPrimaryHeaderElem lyteTimelineViewHeaderMonthElem\" style=\"--lyte-timelineview-col-number: {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\" onmouseenter=\"{{action('onDateHover',event,this,item)}}\" onmouseleave=\"{{action('onDateMouseOut')}}\"> <span class=\"lyteTimelineViewPeriodLabel\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','week')}}\" is=\"case\" lc-id=\"lc_id_0\"> {{item.week}} </template><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_1\"> <span class=\"lyteTimelineViewHeaderPrimaryLabel\">{{item.quarter}}</span> <span class=\"lyteTimelineViewYearLabel\">{{item.year}}</span> </template><template default=\"\"> <span class=\"lyteTimelineViewHeaderPrimaryLabel lyteTimelineViewMonthLabel\">{{lyteUiTimelineViewGetMonth(item.month,months)}}</span> <span class=\"lyteTimelineViewYearLabel\">{{item.year}}</span> </template></template></span> </div></template> </div> <div class=\"lyteTimelineViewHeaderRow\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewSecondaryHeaderElem lyteTimelineViewHeaderElem {{lyteUiTimelineViewFindWeekend(item,ltPropView,ltPropNonWorkingDays,ltPropHolidayObject)}} {{if(item.isendOfView,'lyteTimelineViewEndOfSection','')}}\" style=\"--lyte-timelineview-col-number: {{expHandlers(index,'+',1)}};--lyte-timelineview-lineCount:{{lyteUiTimelineViewLineCount(item,null,this,ltPropView)}};\" data-date=\"{{lyteUiSchedulerGetDate(item)}}\" id=\"{{lyteUiSchedulerGetDate(item)}}\" onmouseenter=\"{{action('onDateHover',event,this,item)}}\" onmouseleave=\"{{action('onDateMouseOut')}}\"> <span> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_0\"> {{lyteUiTimelineViewGetMonth(item,months)}} </template><template default=\"\"> {{lyteUiTimelineViewGetDay(item,ltPropView)}} </template></template></span> </div></template> </div> </div> <div class=\"lyteTimelineViewGroupbyContainer\" style=\"--lyte-timelineview-col-number: {{expHandlers(timeline.length,'+',1)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{groupByData.length}}\" is=\"case\" lc-id=\"lc_id_0\"> <template items=\"{{groupByData}}\" item=\"groupByDataArray\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-timeline-view-accordion class=\"lyteTimelineViewGroupbyAccordion {{lyteUiTimelineViewAccordionClosed(groupByDataArray,this)}} {{if(groupByDataArray.loadmore,'lyteTimelineViewHasMoreEvent',)}} {{if(lyteUiIfEquals(index,expHandlers(groupByData.length,'-',1)),'lyteTimelineViewLastAccordion','')}}\" style=\"--lyte-timelineview-row-end: {{expHandlers(groupByDataArray.rowCount,'+',1)}}\" group=\"{{groupByDataArray.systemValue}}\" id=\"{{groupByDataArray.systemValue}}\"> <div class=\"lyteTimelineViewGroupbyElement\" onclick=\"{{action('toggleAccordion',event,this,groupByDataArray)}}\"> <div class=\"lyteTimelineViewGroupbyElementLabelWrap\"> <lyte-text class=\"lyteTimelineViewGroupbyElementLabel\" lt-prop-value=\"{{groupByDataArray.userValue}}\"></lyte-text> <lyte-badge class=\"lyteTimelineViewGroupbyCount\" lt-prop-data=\"{{groupByDataArray.eventCount}}\" lt-prop-max-length=\"{{ltPropMaxEventCountLength}}\" lt-prop-show-tooltip=\"true\"></lyte-badge> <span class=\"lyteTimelineViewGroupbyAccordionArrow\"></span> </div> <div class=\"lyteTimelineViewGroupbyElementFillBg\"></div> </div> <div class=\"lyteTimelineViewGroupbyAccordionBody {{if(groupByDataArray.norecordfound,'lyteTimelineViewNoRecordFound')}}\" style=\"--lyte-timelineview-row-end:{{groupByDataArray.rowCount}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{groupByDataArray.children.length}}\" is=\"case\" lc-id=\"lc_id_0\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_0\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewOverlay\" style=\"--lyte-timelineview-col-number : {{expHandlers(index,'+',1)}}; --lyte-timelineview-lineCount:{{lyteUiTimelineViewLineCount(item,null,this,ltPropView)}};\"></div></template> </template></template><div class=\"lyteTimelineViewEventsContainer\"> <template items=\"{{groupByDataArray.children}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewEventDiv {{if(expHandlers(item.end,'!'),'lyteTimeLineViewNoEnd','')}}\" id=\"{{item.id}}\" style=\"--lyte-timelineview-row-number: {{expHandlers(index,'+',1)}};\" onmouseover=\"{{action('onEventHover',event,item,this)}}\" onmouseleave=\"{{action('onEventOut',event,item,this)}}\" onfocusin=\"{{action('onEventHover',event,item,this)}}\"> <div class=\"lyteTimelineViewEvent LyteTimelineViewGroupBy {{lyteUiTimelineViewAddClass(item.class,this)}}\" style=\"{{lyteUiTimelineViewColorCode(item.color_code,this)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item.leftResize,'&amp;&amp;',item.end)}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewLeft lyteTimelineViewEventResizeHandler\" onmousedown=\"{{action('onmousedownEvent',event,'left',this,item,groupByDataArray)}}\" onkeydown=\"{{action('onkeydownEvent',event,'left',this,item,groupByDataArray)}}\" onkeyup=\"{{action('onkeyupEvent',event,this,item,groupByDataArray)}}\"></div></template></template><lyte-yield yield-name=\"timeline-event\" timeline-event=\"{{item}}\"> </lyte-yield> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item.end,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimeLineViewNoEndElem\"></div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{item.dueDate}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewDue\"> </div></template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(item.rightResize,'&amp;&amp;',item.end)}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewRight lyteTimelineViewEventResizeHandler\" onmousedown=\"{{action('onmousedownEvent',event,'right',this,item,groupByDataArray)}}\" onkeydown=\"{{action('onkeydownEvent',event,'right',this,item,groupByDataArray)}}\" onkeyup=\"{{action('onkeyupEvent',event,this,item,groupByDataArray)}}\"></div></template></template></div> </div></template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{groupByDataArray.loadmore}}\" is=\"case\" lc-id=\"lc_id_0\"><div class=\"lyteTimelineViewLoadMore\" style=\"grid-column-start: 1; grid-column-end:{{expHandlers(timeline.length,'+',1)}}\" onclick=\"{{action('loadmore',event,groupByDataArray,this)}}\"> <div class=\"lyteTimelineViewLoadMoreLabel\"> View More</div> </div></template></template><div class=\"lyteTimelineViewHideLoadmore lyteTimelineViewLoading\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropLoaderYield,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-loader lt-prop-inline=\"true\" lt-prop-close-icon=\"false\" lt-prop-progress-bar=\"{&quot;mode&quot;: &quot;indefinite&quot; , &quot;show&quot;:false}\" lt-prop-on-timeout=\"{&quot;errorMsg&quot;:&quot; &quot;}\"> </lyte-loader> </template><template default=\"\"> <lyte-yield yield-name=\"timeline-loader\" class=\"lyteTimelineViewLoadingYield\"> </lyte-yield> </template></template></div> <div class=\"lyteTimelineViewArrowContainer\"> <template items=\"{{groupByDataArray.children}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewArrow lyteTimelineViewEventArrow\" style=\"grid-row: {{item.index}}\" data-id=\"{{item.id}}\"> <div class=\"lyteTimelineViewArrowBox lyteTimelineViewLeftArrow lyteTimelineViewHideArrow\" lt-prop-title=\"\" onclick=\"{{action('onarrowclick',event,item,'left',groupByDataArray.systemValue)}}\" onmouseover=\"{{action('onArrowhover',event,item,this)}}\"></div> <div class=\"lyteTimelineViewArrowBox lyteTimelineViewRightArrow lyteTimelineViewHideArrow\" lt-prop-title=\"\" onclick=\"{{action('onarrowclick',event,item,'right',groupByDataArray.systemValue)}}\" onmouseover=\"{{action('onArrowhover',event,item,this)}}\"></div> <div class=\"lyteTimelineViewArrowSeparator\"></div> <div class=\"lyteTimelineViewArrowText lyteTimelineViewArrowTextHide lyteTextEllipsisNode\" onclick=\"{{action('onTextclick',event,item)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropArrowkeyYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"timeline-arrow-key\" timeline-event=\"{{item}}\"> </lyte-yield> </template><template default=\"\"> {{item[ltPropArrowKey]}} </template></template></div> </div></template> </div> </div> </template><template case=\"{{groupByDataArray.norecordfound}}\" is=\"case\" lc-id=\"lc_id_1\"> <div class=\"lyteTimelineViewNoResultDiv\" style=\"grid-column-start: 1; grid-column-end: {{timeline.length}};\"> <div class=\"lyteTimelineViewNoResultLabel\">{{ltPropNoRecordFound}}</div> </div> </template></template></div> </lyte-timeline-view-accordion> </template> </template><template default=\"\"> <div class=\"lyteTimelineViewNoResultDiv\" style=\"grid-column-start: 1; grid-column-end: {{timeline.length}}; --lyte-timelineview-row-end: {{lyteUiTimelineViewRowCount(ltPropManipulatedEvent,ltPropMaxHeight)}};\"> <div class=\"lyteTimelineViewNoResultLabel\">{{ltPropNoRecordFound}}</div> </div> </template></template></div> <div class=\"lyteTimelineViewOverlayDiv\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'==','day')}}\" is=\"case\" lc-id=\"lc_id_0\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{lyteUiTimelineGridOverlay(item,ltPropView,ltPropNonWorkingDays,ltPropHolidayObject)}}\" is=\"case\" lc-id=\"lc_id_0\"><div style=\"--lyte-timelineview-col-number : {{expHandlers(index,'+',1)}};\" class=\"lyteTimelineViewOverlay \"></div></template></template></template> </template><template case=\"{{expHandlers(ltPropView,'==','month')}}\" is=\"case\" lc-id=\"lc_id_1\"> <template items=\"{{headerArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewOverlay {{if(lyteUiTimelineGridOverlay(item,ltPropView,index),'lyteTimelineViewEvenSection','lyteTimelineViewOddSection')}}\" style=\"--lyte-timelineview-col-number : {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\"></div></template> </template><template case=\"{{expHandlers(ltPropView,'==','quarter')}}\" is=\"case\" lc-id=\"lc_id_2\"> <template items=\"{{timeline}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><lyte-timeline-view-overlay class=\"lyteTimelineViewOverlay {{lyteUiTimelineViewMonthClass(item)}}\" style=\"--lyte-timelineview-col-number : {{expHandlers(index,'+',1)}}; --lyte-timelineview-lineCount:{{lyteUiTimelineViewLineCount(item,true,this,ltPropView)}}; --lyte-timelineview-lineCountMinus:{{expHandlers(expHandlers(lyteUiTimelineViewLineCount(item,null,this,ltPropView),'-',1),'+','px')}}\"></lyte-timeline-view-overlay></template> </template><template case=\"{{expHandlers(ltPropView,'==','week')}}\" is=\"case\" lc-id=\"lc_id_3\"> <template items=\"{{headerArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"><div class=\"lyteTimelineViewOverlay {{if(lyteUiTimelineGridOverlay(item,ltPropView),'lyteTimelineViewEvenSection','lyteTimelineViewOddSection')}}\" style=\"--lyte-timelineview-col-number : {{item.startColumn}}; grid-column-end: span {{item.endColumn}};\"></div></template> </template></template></div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropView,'===','day')}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteTimelineViewBg {{if(lyteUiIfEquals(index,expHandlers(groupByData.length,'-',1)),'lyteTimelineViewLastAccordion','')}}\" style=\"--lyte-timelineview-col-number: {{expHandlers(timeline.length,'+',1)}};\"></div> </template></template><div class=\"lyteTimelineViewToday\"> <div class=\"lyteTimelineViewTodayText\">Today</div> <div class=\"lyteTimelineViewTodayLineDiv\"> <div class=\"lyteTimelineViewTodayLine\"> </div> </div> </div> </div></template></template></div> </template>";;
LyteTimelineViewComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-row-end: '",{"type":"helper","value":{"name":"lyteUiTimelineViewRowCount","args":["ltPropManipulatedEvent","ltPropMaxHeight"]}},"'; --lyte-timelineview-column-size: '",{"type":"helper","value":{"name":"expHandlers","args":["ltPropDateWidth[ltPropView]","'+'","'px'"]}},"'; --lyte-timelineview-column-gridline-temp: '",{"type":"helper","value":{"name":"expHandlers","args":[null,"'+'","'px'"]}},"';'"]}}},"cn":"lc_id_0"},{"t":"a","p":[0,1,1,1,1],"cn":"lc_id_0"},{"t":"i","p":[0,1,1,1,1],"in":3,"sibl":[2],"cn":"lc_id_0"},{"t":"a","p":[0,1,3,1],"cn":"lc_id_0"},{"t":"f","p":[0,1,3,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}},{"t":"s","p":[0,1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"tX","p":[1,0],"cn":"lc_id_1"},{"t":"tX","p":[3,0],"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,0],"cn":"default"},{"t":"tX","p":[3,0],"cn":"default"}]},"dc":{"lc_id_0":{},"lc_id_1":{},"default":{}},"hd":true,"co":["lc_id_0","lc_id_1"]}],"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"a","p":[0,1,5,1],"cn":"lc_id_0"},{"t":"f","p":[0,1,5,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"'; --lyte-timelineview-lineCount:'",{"type":"helper","value":{"name":"lyteUiTimelineViewLineCount","args":["item",null,"this","ltPropView"]}},"';'"]}}}},{"t":"s","p":[0,1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1],"cn":"default"}]},"dc":{"lc_id_0":{},"default":{}},"hd":true,"co":["lc_id_0"]}],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"s","p":[0,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"fI","p":[1,1],"dN":[{"t":"a","p":[0]},{"t":"a","p":[0,1],"a":{"style":{"name":"style","helperInfo":{"name":"lyteUiTimelineViewColorCode","args":["item.color_code","this"]}}}},{"t":"s","p":[0,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":4,"sibl":[3]},{"t":"a","p":[0,1,2]},{"t":"i","p":[0,1,2],"in":3,"sibl":[2]},{"t":"s","p":[0,1,4],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":2,"sibl":[1]},{"t":"s","p":[0,1,5],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":1,"sibl":[0]},{"t":"s","p":[0,1,6],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0}],"dc":[3],"hc":true,"trans":true,"in":4,"sibl":[3],"cn":"lc_id_0"},{"t":"s","p":[3,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"f","p":[1],"dN":[{"t":"s","p":[0],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"';'"]}}},"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"a","p":[1],"cn":"lc_id_1"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}}],"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true},"lc_id_2":{"dN":[{"t":"a","p":[1],"cn":"lc_id_2"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"'; --lyte-timelineview-lineCount:'",{"type":"helper","value":{"name":"lyteUiTimelineViewLineCount","args":["item",true,"this","ltPropView"]}},"'; --lyte-timelineview-lineCountMinus:'",{"type":"helper","value":{"name":"expHandlers","args":[null,"'+'","'px'"]}}]}}}},{"t":"cD","p":[0],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_2"}],"cdp":{"t":"a","p":[2]},"dcn":true},"lc_id_3":{"dN":[{"t":"a","p":[1],"cn":"lc_id_3"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}}],"cn":"lc_id_3"}],"cdp":{"t":"a","p":[3]},"dcn":true}},"d":{},"dc":{"lc_id_0":{},"lc_id_1":{},"lc_id_2":{"dc":[0],"hc":true,"trans":true},"lc_id_3":{}},"hd":true,"co":["lc_id_0","lc_id_1","lc_id_2","lc_id_3"],"hc":true,"trans":true,"in":3,"sibl":[2],"cn":"lc_id_0"},{"t":"s","p":[5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '","timeline.length"]}}},"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"a","p":[6],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '","timeline.length"]}}},"cn":"lc_id_0"},{"t":"a","p":[6,1],"cn":"lc_id_0"},{"t":"fI","p":[6,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'grid-row: '","item.index"]}}}},{"t":"a","p":[0,1]},{"t":"a","p":[0,3]},{"t":"a","p":[0,7]},{"t":"s","p":[0,7,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"s","p":[6,3,1],"c":{"lc_id_0":{"dN":[{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"i","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'grid-column-start: 1; grid-column-end: '","timeline.length","';'"]}}},"cn":"default"},{"t":"tX","p":[1,1,0],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[4,3,1,0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-column-size: '",{"type":"helper","value":{"name":"expHandlers","args":["ltPropDateWidth[ltPropView]","'+'","'px'"]}},"'; --lyte-timelineview-column-gridline-temp: '",{"type":"helper","value":{"name":"expHandlers","args":[null,"'+'","'px'"]}},"' ; --lyte-timelineview-groupby-panel-width:'","ltPropGroupbyPanelWidth","';'"]}}},"cn":"default"},{"t":"a","p":[0,1,1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '",{"type":"helper","value":{"name":"expHandlers","args":["timeline.length","'+'",1]}},"';'"]}}},"cn":"default"},{"t":"i","p":[0,1,1,1,3],"in":7,"sibl":[6],"cn":"default"},{"t":"s","p":[0,1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}},{"t":"tX","p":[0,1,1]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":6,"sibl":[5],"cn":"default"},{"t":"a","p":[0,1,4,1,1],"cn":"default"},{"t":"i","p":[0,1,4,1,1],"in":5,"sibl":[4],"cn":"default"},{"t":"a","p":[0,1,6,1],"cn":"default"},{"t":"f","p":[0,1,6,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}},{"t":"s","p":[0,1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"tX","p":[1,0],"cn":"lc_id_1"},{"t":"tX","p":[3,0],"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,0],"cn":"default"},{"t":"tX","p":[3,0],"cn":"default"}]},"dc":{"lc_id_0":{},"lc_id_1":{},"default":{}},"hd":true,"co":["lc_id_0","lc_id_1"]}],"in":4,"sibl":[3],"cn":"default"},{"t":"a","p":[0,1,8,1],"cn":"default"},{"t":"f","p":[0,1,8,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"';--lyte-timelineview-lineCount:'",{"type":"helper","value":{"name":"lyteUiTimelineViewLineCount","args":["item",null,"this","ltPropView"]}},"';'"]}}}},{"t":"s","p":[0,1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1],"cn":"default"}]},"dc":{"lc_id_0":{},"default":{}},"hd":true,"co":["lc_id_0"]}],"in":3,"sibl":[2],"cn":"default"},{"t":"a","p":[0,3],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '",{"type":"helper","value":{"name":"expHandlers","args":["timeline.length","'+'",1]}}]}}},"cn":"default"},{"t":"s","p":[0,3,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"f","p":[1],"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-row-end: '",{"type":"helper","value":{"name":"expHandlers","args":["groupByDataArray.rowCount","'+'",1]}}]}}}},{"t":"a","p":[1,1]},{"t":"a","p":[1,1,1,1]},{"t":"cD","p":[1,1,1,1],"in":3,"sibl":[2]},{"t":"a","p":[1,1,1,3]},{"t":"cD","p":[1,1,1,3],"in":2,"sibl":[1]},{"t":"a","p":[1,3],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-row-end:'","groupByDataArray.rowCount"]}}}},{"t":"s","p":[1,3,1],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"'; --lyte-timelineview-lineCount:'",{"type":"helper","value":{"name":"lyteUiTimelineViewLineCount","args":["item",null,"this","ltPropView"]}},"';'"]}}}}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":4,"sibl":[3],"cn":"lc_id_0"},{"t":"a","p":[2,1],"cn":"lc_id_0"},{"t":"f","p":[2,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-row-number: '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"';'"]}}}},{"t":"a","p":[0,1],"a":{"style":{"name":"style","helperInfo":{"name":"lyteUiTimelineViewColorCode","args":["item.color_code","this"]}}}},{"t":"s","p":[0,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":4,"sibl":[3]},{"t":"a","p":[0,1,2]},{"t":"i","p":[0,1,2],"in":3,"sibl":[2]},{"t":"s","p":[0,1,4],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":2,"sibl":[1]},{"t":"s","p":[0,1,5],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":1,"sibl":[0]},{"t":"s","p":[0,1,6],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0}],"dc":[3],"hc":true,"trans":true,"in":3,"sibl":[2],"cn":"lc_id_0"},{"t":"s","p":[2,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'grid-column-start: 1; grid-column-end:'",{"type":"helper","value":{"name":"expHandlers","args":["timeline.length","'+'",1]}}]}}},"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"s","p":[2,4,1],"c":{"lc_id_0":{"dN":[{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"i","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"a","p":[2,6,1],"cn":"lc_id_0"},{"t":"f","p":[2,6,1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'grid-row: '","item.index"]}}}},{"t":"a","p":[0,1]},{"t":"a","p":[0,3]},{"t":"a","p":[0,7]},{"t":"s","p":[0,7,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'grid-column-start: 1; grid-column-end: '","timeline.length","';'"]}}},"cn":"lc_id_1"},{"t":"tX","p":[1,1,0],"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[3,1,0],"hc":true,"trans":true},"lc_id_1":{}},"hd":true,"co":["lc_id_0","lc_id_1"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0}],"dc":[3,2,1,0],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'grid-column-start: 1; grid-column-end: '","timeline.length","'; --lyte-timelineview-row-end: '",{"type":"helper","value":{"name":"lyteUiTimelineViewRowCount","args":["ltPropManipulatedEvent","ltPropMaxHeight"]}},"';'"]}}},"cn":"default"},{"t":"tX","p":[1,1,0],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":2,"sibl":[1],"cn":"default"},{"t":"s","p":[0,5,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"f","p":[1],"dN":[{"t":"s","p":[0],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"';'"]}}},"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"a","p":[1],"cn":"lc_id_1"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}}],"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true},"lc_id_2":{"dN":[{"t":"a","p":[1],"cn":"lc_id_2"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '",{"type":"helper","value":{"name":"expHandlers","args":["index","'+'",1]}},"'; --lyte-timelineview-lineCount:'",{"type":"helper","value":{"name":"lyteUiTimelineViewLineCount","args":["item",true,"this","ltPropView"]}},"'; --lyte-timelineview-lineCountMinus:'",{"type":"helper","value":{"name":"expHandlers","args":[null,"'+'","'px'"]}}]}}}},{"t":"cD","p":[0],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_2"}],"cdp":{"t":"a","p":[2]},"dcn":true},"lc_id_3":{"dN":[{"t":"a","p":[1],"cn":"lc_id_3"},{"t":"f","p":[1],"dN":[{"t":"a","p":[0],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number : '","item.startColumn","'; grid-column-end: span '","item.endColumn","';'"]}}}}],"cn":"lc_id_3"}],"cdp":{"t":"a","p":[3]},"dcn":true}},"d":{},"dc":{"lc_id_0":{},"lc_id_1":{},"lc_id_2":{"dc":[0],"hc":true,"trans":true},"lc_id_3":{}},"hd":true,"co":["lc_id_0","lc_id_1","lc_id_2","lc_id_3"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"default"},{"t":"s","p":[0,7],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--lyte-timelineview-col-number: '",{"type":"helper","value":{"name":"expHandlers","args":["timeline.length","'+'",1]}},"';'"]}}},"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[3,0],"hc":true,"trans":true},"default":{"dc":[7,5,2,1],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteTimelineViewComponent._observedAttributes = [
    "ltPropCurrentDate",
    "ltPropView",
    "ltPropArrowKey",
    "ltPropWorkingDay",
    ...
    "ltPropNonWorkingDays",
    "ltPropWeekStart",
    "ltPropRestrict",
    "ltPropLoaderYield",
    "ltPropMaxEventCountLength",
    "ltPropMinResizeWidth",
    "ltPropArrowkeyYield",
    "ltPropHolidaylist",
    "ltPropHolidayObject",
    "ltPropHolidayFormat",
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewGetMonth", function(date,months){
	var curr_month;
	...
	var i18n = window._lyteUiUtils.i18n(curr_month);
	if(i18n){
		return i18n;
	}
	return curr_month;
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewGetDay",function( date , view){
	if(view == 'day'){
		var weekDay = window._lyteUiUtils.i18n(date.format('ddd'));
		if(weekDay){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewCss",function(event,eventDiv,timeline,view){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper('lyteUiTimelineViewColorCode',function(colorCode,elem){
	if(colorCode){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper('lyteUiTimelineViewFindWeekend',function(date,view,NonWorkingDays,holidayList){
	if(view == 'day' ){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewRowCount",function(eventArray,height){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewAccordionClosed",function(group,accordion){
	if(group.isclosed){
		return 'lyteTimelineViewHideAccordion';
	}
});

_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewGetViewClass",function(view){

	return 'lyteTimelineView'+view.charAt(0).toUpperCase() + view.slice(1) +'wise';
});

_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewGridCol",function(date,elem,view){
	$L.fastdom.mutate(function(){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewAddClass",function(classList,elem){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineGridOverlay",function(date,view,NonworkingDay,holidayList){
	if(view == 'day' ){
		var date = date.getDObj();
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewHasScroll",function(eventArray,height){
	if( height && !eventArray.length || eventArray.length < parseInt((height/40)-2)){
		return 'lyteTimelineViewNoScroll';
	}
})

_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewMonthClass",function(date){
...
_component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.registerHelper("lyteUiTimelineViewLineCount",function(date,drawLine,elem,view){
	if(view !== 'quarter'){
		return;
	}
	...
	if(drawLine){
		...
		var year = date.getFullYear();
		if(startOfMonth.getDay() !== this.$node.component.getData('ltPropWeekStart')){
			var weeklast = (( startOfMonth.getDay() - this.$node.component.getData('ltPropWeekStart') ) % 7) + 1;
		...
		while( startOfMonth.getFullYear()  == year ){
			...
			if( startOfMonth.getMonth() === month ){
				if(startOfMonth.getDate()  !== 1 && startOfMonth.getDate() !== lastOfMonth.getDate()){
					lineCount = this.$node.component.findNoOfworkingDay(date,startOfMonth.getDate());
		...
		lineCount = this.$node.component.findNoOfworkingDay(new Date(date.toString()),lastOfMonth.getDate());
	}else{
		var lineCount = this.$node.component.findNoOfworkingDay(new Date(date.toString()),startOfMonth.getDate());
	}
...
if( !window._lyteUiUtils.registeredCustomElements[ 'lyte-timeline-view-accordion' ] ) {
    ...
    class LyteTimelineViewAccordionCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
        ...
        connectedCallback() {
            ...
            if(timelineView.getMethods('onGroupRender')){
				...
				var promise = timelineView.component.executeMethod('onGroupRender',groupData[groupData.length - 1],timelineView,lyteNode);
				var _this = lyteNode;
				if(promise && promise.then){
					promise.then(function(value){
					...
					if( lyteNode.getBoundingClientRect().bottom <= (scroll.getBoundingClientRect().top + timelineView.getData('ltPropMaxHeight')) ){
						var cs = parseInt(window.getComputedStyle(container).getPropertyValue('--lyte-timelineview-row-end'));
						container.style.setProperty('--lyte-timelineview-row-end',cs+groupData.length)
						timelineView.component.addGroupByUser(groupData.length );
					}else{
						timelineView.component.stopRenderOnToggle = false;
						timelineView.component.lastaccordion = lyteNode;
					}
				}
			}
        }
    ...
    LyteTimelineViewAccordionCustomElements.options = {clone : {allCallbacks : false}};
...
LyteTimelineViewComponent.register("lyte-timeline-view", {
    hash: "LyteTimelineViewComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(91831682)));
