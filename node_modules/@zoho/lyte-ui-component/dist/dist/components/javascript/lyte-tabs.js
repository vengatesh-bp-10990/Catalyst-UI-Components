"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-tabs"],{

/***/ 70698083:
/*!********************************************!*\
  !*** ./components/javascript/lyte-tabs.js ***!
  \********************************************/
...
class LyteTabsComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    ...
    data(arg1) {
        return Object.assign(super.data({
          ...
          /**
             ...
             */
          "ltPropYield": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { "default": true }),
           ...
           */
          "ltPropHover": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { "default": window._lyteUiUtils.resolveDefaultValue( 'lyte-tabs', 'hover', 'lyteTabHover' ) }),
           ...
           */
          "ltPropActiveClass": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { "default": window._lyteUiUtils.resolveDefaultValue( 'lyte-tabs', 'activeClass', 'lyteTabActive' ) }),
          /**
           ...
           */
          "ltPropPosition": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { "default":  { 'pos': 'top', 'align': 'left' } }),
           ...
           * 
           */
          "ltPropCloseIcon": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { "default": false }),
          "prevTarget": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { "default": null }),
           ...
           */
          "ltPropHeight": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { "default": window._lyteUiUtils.resolveDefaultValue( 'lyte-tabs', 'height', "400px") }),
           ...
           * @options collapse
           */
          "ltPropType": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"), //options - collapse
           ...
           * @suffix px,pt,cm,mm,vh,vm,em,%
           */
          "ltPropMaxWidth": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { "default": window._lyteUiUtils.resolveDefaultValue( 'lyte-tabs', 'maxWidth', "90%") }),
           ...
           * @options nested
           */
          "ltPropTabStyle": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),     //nested

          /**
           * @componentProperty {string} ltPropMenuWrapperClass
           * @version 2.2.8
           */
          "ltPropMenuWrapperClass": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),
          /**
           ...
           * @version 3.6.0
           */
          "ltPropCurrentTab": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object"),
          "ltPropActiveTab": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number'),
          "ltPropHiddenTabs": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', { "default": [] }),
          "ltPropFireOnInit": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean',{"default": true }),
          "createTabMenu" :  (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { "default" : false } ),
          "ltPropMenuYield": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean',{ "default" : false}),
          "menuLabels": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array", { "default": [] })
        }), arg1);
    }
    ...
    didConnect() {
        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).attr('role','tabs');
        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('LYTE-TAB-HEAD').attr('role','tablist');
    ...
    initialFunc(onRender) {
        ...
        if (this.$node.childElementCount > 1 || this.$node.children[0].tagName === "LYTE-TAB") {
            ...
            **-- NOT REQUIRED NOW --** */
            ...
            var contents = this.getContent( _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('lyte-tab-content',this.$node.querySelector('lyte-tab-body')) );
            ...
            if( curr_tab ){
                ...
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[curr_tab]).attr('tabindex',0);
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[curr_tab]).attr('aria-selected','true');
                pos = curr_tab;
            }else{
                for (var i = 0; i < labels.length; i++) {
                    if (labels[i].classList.contains(active)) {
                        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[i]).attr('tabindex',0);
                        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[i]).attr('aria-selected','true');
                        pos = i;
                    }
                }
            }
           ...
           var hiddenTab = this.getData('ltPropHiddenTabs');
            for (var i = 0; i < labels.length; i++) {
                if(contents[i]){
                    if (pos && (pos === i || labels[pos].getAttribute('lt-prop-id') === contents[i].id)) {
                        ...
                        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[i]).attr('aria-selected',false);
                    }
                    _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[i]).attr('aria-controls',contents[i].id);
                }
            ...
            if (!pos && labels.length && initialTab !== null) {
                ...
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[pos]).attr('tabindex',0);
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(labels[pos]).attr('aria-selected','true');
                if(contents[pos]){
            ...
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {    //Sets the height and width of the tab label and content based on the given values and positions.
    ...
    keydown(event) {
        ...
        var tabs = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).find('lyte-tab-title').toArray();
        var curr_tab = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).find('.lyteTabHover'); //$L(this.$node).find('.lyteTabActive');
        curr_tab = curr_tab.length === 0 ? _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).find('.lyteTabActive') : curr_tab;
        var tabFocus = tabs.indexOf(curr_tab[0]),prevFocus;

        var tab_length = tabs.length;
        if (event.keyCode === 39 || event.keyCode === 37){
            tabs[tabFocus].setAttribute('tabindex', -1);
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(tabs[tabFocus]).removeClass('lyteTabHover');
            if(event.keyCode === 39){
                tabFocus++;
            ...
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(tabs[tabFocus]).addClass('lyteTabHover')
        }
        if(event.keyCode === 13){
            this.openTabContent(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(tabs[tabFocus]).attr('lt-prop-id'), event);
        }
        tabs[tabFocus].focus();  
    }
    ...
    mouseOver(event) {
        ...
        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(target).addClass(hover);
    }
    ...
    mouseOut(event) {
        ...
        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(target).removeClass(hover);
    }

    getContent(children) {
        var contents = [];
        for (var i = 0; i < children.length; i++) {
            if (this.$node == _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(children[i]).closest('LYTE-TABS')[0]) {
    ...
    openTabContent(tabId, event) {
        ...
        if (tabId) {
            ...
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(label).attr('tabindex',0);
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(label).attr('aria-selected','true');
        }
    ...
    destoryCloseIcon(head) {
        var closeIcon = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('.lyteTabCloseIcon',this.$node);
    ...
    hideAll() {
        ...
        var contents = this.getContent(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('lyte-tab-content',this.$node.querySelector('lyte-tab-body'))); /*this.getContent(this.$node.querySelector('lyte-tab-body').children);*/
        var active = this.getData('ltPropActiveClass');
        for (var i = 0; i < labels.length; i++) {
            if (labels[i].classList.contains(active)) {
        ...
        for (var v = 0; v < contents.length; v++) {
            ...
            if (!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(contents[v]).hasClass('lyteTabHide')) {
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(contents[v]).addClass('lyteTabHide');
            }
        }
    }
    ...
    collapseHeader(onResize) {
        ...
        if(menu && maxWidth == head.getBoundingClientRect().width){
            totalWidth += _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('#moreMenu',head)[0].getBoundingClientRect().width;
        }
        ...
        if (allowed > -1 && allowed < headers.length) {
            for (var i = allowed; i < headers.length; i++) {
                if (i == openedTab) {
                    if (openedTab > 0 && !(headers[i - 1].classList.contains('lyteTabForceHide') && !(headers[i - 1].classList.contains('lyteTabTitleHide'))) ){
                        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(headers[i - 1]).addClass('lyteTabForceHide');
                        if (!(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(headers[i - 1]).hasClass('lyteTabDisable'))) {
                    ...
                    if(!(headers[i].classList.contains('lyteTabTitleHide'))){
                        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(headers[i]).addClass('lyteTabForceHide');
                        if (!(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(headers[i]).hasClass('lyteTabDisable'))) {
            ...
            if (!menu) {
                ...
                if(totalWidth + span.getBoundingClientRect().width > maxWidth && maxWidth == head.getBoundingClientRect().width){
                    _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(headers[allowed - 1]).addClass('lyteTabForceHide');
    ...
    createMenu(menuLabels, sel, prop) {
        if (prop == "init") {
            ...
            var menu = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('#lyteTabMenu',this.$node)[0];
            // menu.id = 'lyteTabMenu';
    ...
    removeMenu() {
        // var menu = this.$node.querySelector('#lyteTabMenu');
        var head = this.$node.querySelector('lyte-tab-head');
        var menu_span = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('#moreMenu',head)[0];
        if (menu_span) {
            menu_span.remove();
        }
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-tab-title']) {
    ...
    class LyteTabTitleCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
        ...
        connectedCallback() {
            ...
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(lyteNode).attr('role','tab');
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(lyteNode).attr('tabindex',-1);
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(lyteNode).attr('aria-selected','false');
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-tab-content']) {
    ...
    class LyteTabContentCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry
            }];
        ...
        connectedCallback() {
            var lyteNode = this.$node;
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(lyteNode).attr('role','tabpanel');
        }
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(70698083)));
