"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-popover"],{
...
window.addPopoverEvent = function(event) {
    ...
    window._lyteUiUtils.addGlobalEventListener('click', function (event) {
        ...
        if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('.lyteInputCalendar')[0] || _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('.lyteCalendarView')[0]) {
            closeBoolean = true
        }
        ...
        if (!closeBoolean) {
            ele = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().traverseUp(ele, ["LYTE-POPOVER-FREEZE", "LYTE-DROP-BOX", "HTML"], ["popoverWrapper"])
        }
        if (!ele) {
            return;
        }
        if (ele.tagName == 'HTML' || ele.tagName == "LYTE-POPOVER-FREEZE") {
            for (var i = window.LytePopup.components.length - 1; i >= 0; i--) {
                var dropdowns = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(window.LytePopup.components[i].childComp).find('lyte-dropdown')
                var dontClose = false;
                if (dropdowns[0]) {
                ...
                if (window.LytePopup.components[i].$node.tagName == "LYTE-POPOVER" && window.LytePopup.components[i].childComp.style.visibility == "visible" && !dontClose) {
                    ...
                    if ((popover && popover.component.getData('visible') && popover.component.getData('ltPropCloseOnBodyClick') && !popover.component.getData('dragRunning')) && ((!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('lyte-input')[0]) || (!popover.component.getData('ltPropIgnoreInput')) && !closeBoolean)) {
        ...
        /*  If ele is having popoverWrapper class ie. a popover and it is not the popover that is opened at last which is the current popover element in the page
            ...
            var dropdowns = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(comp.childComp).find('lyte-dropdown')
            var dontClose = false;
            if (dropdowns[0]) {
    ...
    window.addEventListener('scroll', function (event) {    //This is for closing the dropdown when an outside area is clicked(CODE HELP)
        if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('.lytePopover')[0]) {
        ...
        for (var i = window.LytePopup.components.length - 1; i >= 0; i--) {
            if (window.LytePopup.components[i].$node && window.LytePopup.components[i].$node.nodeName == "LYTE-POPOVER" && window.LytePopup.components[i].childComp.style.visibility == "visible") {
                ...
                if (window.LytePopup.components[i].data.ltPropCloseOnScroll && (!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('.popoverWrapper')[0])) {
                    if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('lyte-drop-box')[0] && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(event.target).closest('lyte-drop-box')[0].origindd.closest('.lytePopover')) {
                        return
                    }
...
class LytePopoverComponent extends _node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.Component {
    constructor() {
        super();
    ...
    data(arg1) {
        return Object.assign(super.data({
             ...
             * @out
             */
            "ltPropShow": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false, in: true, out: true }),
             ...
             * @in
             */
            "ltPropType": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "callout", in: true, out: false }),
             ...
             * @in
             */
            "ltPropFreeze": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropShowCloseButton": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropCloseOnEscape": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropOriginElem": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropPosition": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "bottom", in: true, out: false }),
             ...
             * @in
             */
            "ltPropPlacement": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropDimmer": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { "default": {}, in: true, out: false }),

            "ltPropDraggable": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false }),
             ...
             * @in 
             */
            "ltPropAllowMultiple": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropScrollable": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropMaxHeight": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropMaxWidth": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropWidth": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropHeight": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "auto", in: true, out: false }),
             ...
             * @in
             */
            "ltPropWrapperClass": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
            /**
             ...
             * @in
             */
            "ltPropBoundary": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { "default": {}, in: true, out: false }),
             ...
             * @in
             */
            "ltPropCloseOnBodyClick": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropDuration": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("number", { "default": 400, in: true, out: false }),
            /**
             ...
             * @out
             */
            "ltPropOffset": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { "default": {}, in: true, out: true }),
            ...
            /**
              ...
              * @in
            */
            "ltPropOffsetFromTarget": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { "default": {}, in: true, out: false }),
             ...
             * @out
             */
            "ltPropBindToBody": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false, in: true, out: true }),
             ...
             * @in
             */
            "ltPropHeaderPadding": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropContentPadding": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropFooterPadding": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropAnimation": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string", { "default": "fade", in: true, out: false }),
            /**
             ...
             * @in
             */
            "ltPropWindowSpacing": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { in: true, out: false }),
             ...
             * @in
             */
            "ltPropForceScroll": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropAutoAlign": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropAria": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropAriaAttributes": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('object', { default: {}, in: true, out: false }),
             ...
             * @in
             */
            "ltPropPreventFocus": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropStopClick": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropIgnoreBoundary": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropMargin": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('object', { in: true, out: false }),
             ...
             * @in
             */
            "ltPropAutoPlacement": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', {
                default: false, in: true, out: false
            }),
            ...
            "buttons": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array", { "default": [{ "type": "accept", "text": "Ok" }] }),
            "ltPropShowCopy": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false }),
            "visible": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": true }),
            "timeOutId": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("number"),
            "classTobeAdded": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string"),
            "keys": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { "default": { 37: 1, 38: 1, 39: 1, 40: 1 } }),
            "first": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": true }),
            "arrowHidden": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false }),
            "arrowEle": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object"),
            "returnedFalse": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { "default": false }),
            "transformOrigin": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string"),
            "windowSpacing": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object"),
            "lyteUnbound": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { 'default': false }),
            "prevOffsetVal": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object"),
            "calculateHW": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean", { 'default': false }),
            "checkAria": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("number", { "default": 0 }),
            "prevRect": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object", { 'default': undefined }),
            "margin": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object"),
            "modalElemWidth": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', { "default": '' }),
            "modalElemHeight": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('string', { "default": '' }),
            "dragRunning": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('boolean', { "default": false }),
            "duringAutoPlacement": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('object', {
                default: {
                    height: '',
                    width: ''
                }
    ...
    handleMove(e) {
        ...
        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(e.target).addClass('lytePopoverDragRunning')
        if (e.type == "mousedown") {
    ...
    handleDrag(e) {
        ...
        var curComp = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(drag).closest('lyte-wormhole')[0]._callee
    ...
    stopDrag(e) {
        ...
        if (!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(targetElem).hasClass('lytePopoverDragRunning')) {
            targetElem = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('.lytePopoverDragRunning')[0]
        }
        var drag = window.LytePopup.node;
        var curComp = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(drag).closest('lyte-wormhole')[0]._callee
        while (targetElem && targetElem !== document) {
            if (targetElem.parentEle) {
                if (e.type == "mouseup") {
                    ...
                    _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('.lytePopoverDragRunning').removeClass('lytePopoverDragRunning');
                }
    ...
    clearFastdomBatch() {
        if (this.fastdomfn1) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn1);
            delete this.fastdomfn1;
        }
        if (this.fastdomfn2) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn2);
            delete this.fastdomfn2;
        }
        if (this.fastdomfn3) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn3);
            delete this.fastdomfn3;
        }
        if (this.fastdomfn4) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn4);
            delete this.fastdomfn4;
        }
        if (this.fastdomfn5) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn5);
            delete this.fastdomfn5;
        }
        if (this.fastdomfn6) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn6);
            delete this.fastdomfn6;
        }
        if (this.fastdomfn7) {
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.clear(this.fastdomfn7);
    ...
    updateScrollHandling(event) {   //Sets the height and width of the popover
        ...
        /*------------------------------ MEASURE STARTS --------------------------*/
        this.fastdomfn1 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {   //Measures the initial height and width based on the content of popover
            delete this.fastdomfn1;
            ...
            /*------------------------------ MUTATE STARTS --------------------------*/
            this.fastdomfn2 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {  //Measures and sets the height and width based on the user provided max values
                delete this.fastdomfn2;
                ...
                if (this.getData("calculateHW") && contentNode) {
                    ...
                    /*------------------------------ MEASURE STARTS --------------------------*/
                    this.fastdomfn3 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {    //Measures the heaser and footer dimensions
                        delete this.fastdomfn3;
                        if (popoverHeader) {
                            if (this.$node.ltProp("maxWidth")) {
                        ...
                        /*------------------------------ MUTATE STARTS --------------------------*/
                        this.fastdomfn4 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {   //Sets the final height and width of the popover
                            delete this.fastdomfn4;
    ...
    computeOffsetImpl(event, reAlign) {
        ...
        // modalEle.style.top = "";
        /*------------------------------ MEASURE STARTS --------------------------*/
        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {
            if (this.$node.ltProp("showCopy")) {
                if (this.$node.ltProp('originElem') != "" || !(lyteSelf.$registry.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset')))) {
                    ...
                    if (!ele && lyteSelf.$registry.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset'))) {
                        ...
                        ele = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.getData('ltPropHostElement'))[0].shadowRoot.querySelector(this.getData('ltPropOriginElem'))
                    ...
                    if (noPlaceAvailable && this.getData('ltPropAutoPlacement')) {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('duringAutoPlacement'), 'width', 'add', this.getData('width'))
                        ;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('duringAutoPlacement'), 'height', 'add', this.getData('height'))
                        // offObj.offsetLeft = bodyWidth - modalElePosition.width - 10;
                    ...
                    if (this.$node.ltProp('type') === "callout") {
                        ...
                        _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {   //If originElem -> height < arrowIcon -> height OR originElem -> width < arrowIcon -> width
            ...
            if (this.getData('ltPropDuration') == undefined) {
                ...
                setTimeout(function () {
                    if (!(self.getData('visible'))) {
                        if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(self.childComp).find('.lytePopover')[0]) {
                            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(self.childComp).find('.lytePopover')[0].style.left = ""
                            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(self.childComp).find('.lytePopover')[0].style.top = ""
                        }
                        if (self.childComp) {
    ...
    onBeforeShowHandling() {
        ...
        if (result === undefined || result) {
            ...
            if (this.getData('ltPropDuration') == undefined) {
                ...
                this.fastdomfn5 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {
                    delete this.fastdomfn5;
                    this.fastdomfn6 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {
                        delete this.fastdomfn6;
                        this.fastdomfn7 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {
                            delete this.fastdomfn7;
                ...
                this.initCompute = setTimeout(function () {
                    ...
                    self.fastdomfn5 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {
                        delete self.fastdomfn5;
                        self.fastdomfn6 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {
                            delete self.fastdomfn6;
                            self.fastdomfn7 = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {
            ...
            _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {
                ...
                if (this.getData('ltPropHostElement') !== "") {
                    ...
                    scrollParent = this.$node.ltProp('originElem') ? window.LytePopup.getScrollParent(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.getData('ltPropHostElement'))[0].shadowRoot.querySelector(this.getData('ltPropOriginElem'))) : null;
            ...
            showToggled: function () {
                ...
                if (this.$node.ltProp("show") && !this.$node.ltProp("showCopy")) {
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('left')) {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('windowSpacing'), 'add', 'left', this.getData('ltPropWindowSpacing').left)
                    }
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('right')) {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('windowSpacing'), 'add', 'right', this.getData('ltPropWindowSpacing').right)
                    }
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('bottom')) {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('windowSpacing'), 'add', 'bottom', this.getData('ltPropWindowSpacing').bottom)
                    }
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('top')) {
                        (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_2__.objectUtils)(this.getData('windowSpacing'), 'add', 'top', this.getData('ltPropWindowSpacing').top)
                    }
                    ...
                    if (this.$node.ltProp('freeze')) {
                        ...
                        if (!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().isEmptyObject(dimmerValue)) {
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(98690302)));
