"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-emoji"],{

/***/ 47136298:
/*!*********************************************!*\
  !*** ./components/javascript/lyte-emoji.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteEmojiComponent": () => (/* binding */ LyteEmojiComponent)
/* harmony export */ });
...
class LyteEmojiComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }

    data(arg1) {
		var default_values = window._lyteUiUtils.getDefault( 'lyte-emoji' );
		return Object.assign(super.data({
		  ...
		  /**
			...
			* @version 3.86.0
			*/	
			ltPropInput : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'object', { default : default_values.input } ),
			/**
			* @componentProperty {boolean} ltPropShowTitle
			* @default false
			* @version 3.107.0
			*/	
			ltPropShowTitle : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { default : false } ),


			// system 
			value : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { default : '' }),
			showNoResult : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { default : false })
		}), arg1);
	}
    ...
    perfromSearch(value) {
		var wrapper = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( '.lyteEmojiWrapper', this.$node ).get( 0 ),
		...
		fn = function( value ){
			...
			if( dia ){
				value = window._lyteUiUtils.convert_diacritics( value );
			} 
		...
		this.data.ltPropEmoji.forEach( function( item, index ){
			...
			item.emojis.forEach( function( emoji, e_index ){
				var $emoji = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( grp_child[ e_index ] ),
			...
			_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( grp )[ ( to_hide ? 'add' : 'remove' ) + 'Class' ]( cls_name );
...
LyteEmojiComponent._template = "<template tag-name=\"lyte-emoji\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropSearch}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteEmojiInputElement\"> <lyte-input lt-prop=\"{{stringify(ltPropInput)}}\" lt-prop-type=\"{{ltPropInput.type}}\" lt-prop-close-icon=\"{{ltPropInput.closeIcon}}\" lt-prop-value=\"{{lbind(value)}}\" oninput=\"{{action('input',event)}}\"></lyte-input> </div> </template></template><div class=\"lyteEmojiWrapper\" tabindex=\"{{expHandlers(ltPropInput.tabindex,'||',0)}}\" onkeydown=\"{{action('keydown',event)}}\"> <template items=\"{{ltPropEmoji}}\" item=\"group\" index=\"grp_index\" is=\"for\" _new=\"true\"> <div class=\"lyteEmojiGroup {{group.name}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropShowTitle}}\" is=\"case\" lc-id=\"lc_id_0\"> <span class=\"lyteEmojiGroupTitle\">{{group.name}}</span> </template></template><template items=\"{{group.emojis}}\" item=\"emoji\" index=\"index\" is=\"for\" _new=\"true\"> <span tabindex=\"{{expHandlers(ltPropInput.tabindex,'||',0)}}\" role=\"button\" class=\"lyteEmoji\" lt-prop-tooltip-class=\"lyteEmojiTooltip\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" onclick=\"{{action('click',emoji)}}\" value=\"{{emoji.value}}\" encode=\"{{emoji.encode}}\" aria-label=\"{{emoji.name}}\" onmouseenter=\"{{action('enter',emoji.name,this)}}\">{{unescape(emoji.encode)}}</span> </template> </div> </template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropNoMatchText}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteEmojiNoResult {{if(showNoResult,'','lyteEmojiHidden')}}\">{{ltPropNoMatchText}}</div> </template></template></div> </template>";;
LyteEmojiComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"cD","p":[1,1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"a","p":[2]},{"t":"a","p":[2,1]},{"t":"f","p":[2,1],"dN":[{"t":"a","p":[1]},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1,0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[0]},{"t":"a","p":[1,2]},{"t":"f","p":[1,2],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}]}],"in":1,"sibl":[0]},{"t":"s","p":[2,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"tX","p":[1,0],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0},{"type":"dc","trans":true,"hc":true,"p":[2]}];;

LyteEmojiComponent._observedAttributes = [
    "ltPropEmoji",
    "ltPropTooltipConfig",
    "ltPropSearch",
    "ltPropCaseSensitive",
...
LyteEmojiComponent.register("lyte-emoji", {
    hash: "LyteEmojiComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(47136298)));
