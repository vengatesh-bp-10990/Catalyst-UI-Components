"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-carousel"],{

/***/ 59721206:
/*!************************************************!*\
  !*** ./components/javascript/lyte-carousel.js ***!
  \************************************************/
 ...
 */
class LyteCarouselComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
        this._lyteUtilFunctions = ["moveSlideByIndex", "reset", "getActiveSlideIndex", "focus"];
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			 ...
			 * @version 3.0.0
			 */
			ltPropEffect: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', {
			...
			ltPropActiveIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 0
			}),
			/** 
			 ...
			 * @version 3.0.0
			 */
			ltPropMoreRecords: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				'default': false
			}),

			ltPropRecords: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': undefined
			}),
			/** 
			 ...
			 * @version 3.0.0
			 */
			ltPropAutoPlayDuration: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
			 ...
			 * @version 3.0.0
			 */
			ltPropAutoPlayPause: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
			 ...
			 * @version 3.82.0
			 */
			ltPropOrientation: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', {
				'default': "horizontal"
			}),
			/**
			 ...
			 * @version 3.82.0
			 */
			ltPropTabIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', {
				'default': '0'
			}),
			ltPropDataTabIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 0
			}),
			ltPropArrowKey: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				default: false
			}),
			/**
			 ...
			 * @version 3.82.0
			 */
			ltPropType: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', {
				default: 'yielded'
			}),
			ltPropIndicatorOverlap: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				default: false
			}),
			coordinates: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('object', {
				'default': {}
			}),
			currentActiveIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 0
			}),
		...
		setTimeout(function () {
			...
			if (this._nextTrans) {
				...
				for (var i = 0; i < itemList.length; ++i) {
					if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(itemList[i]).hasClass('lyteActivePrev')) {
						itemList[i].classList.remove('lyteActivePrev')
					}
				}
				if (activeItemList.length > 1) {
					for (var i = 0; i < itemList.length; ++i) {
						if (i != this.getData('ltPropActiveIndex') && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(itemList[i]).hasClass('lyteActive')) {
    ...
    removePrevClass(event) {
		...
		var currentTarget = window._lyteUiUtils.getCurrentTarget(event);
    ...
    indicatorClick(event) {
		...
		var index, e = event.target,
			target = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(e).closest('lyte-carousel-indicator-item')[0];
...
LyteCarouselComponent._template = "<template tag-name=\"lyte-carousel\"> <div class=\"lyteCarouselWrapper{{if(ltPropIndicatorOverlap,' lyteCarouselIndicatorInside','')}}{{if(expHandlers(ltPropType,'===','image'),' lyteCarouselIndicatorImg','')}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropType,'===','image')}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-carousel-prev> </lyte-carousel-prev> <lyte-carousel-content class=\"lyteCarouselImgContent\"> <template items=\"{{ltPropData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-carousel-item> <img src=\"{{item}}\"> </lyte-carousel-item> </template> </lyte-carousel-content> <lyte-carousel-indicator class=\"lyteCarouselIndicatiorWrapper\"> <template items=\"{{ltPropData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-carousel-indicator-item data-value=\"{{index}}\" class=\"lyteCarouselIndicatiorItemImg\"> <img src=\"{{item}}\"></lyte-carousel-indicator-item> </template> </lyte-carousel-indicator> <lyte-carousel-next> </lyte-carousel-next> </template><template default=\"\"> <lyte-yield yield-name=\"carouselBoxYield\"></lyte-yield> </template></template></div> </template>";;
LyteCarouselComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"cD","p":[1],"in":5,"sibl":[4],"cn":"lc_id_0"},{"t":"a","p":[3,1],"cn":"lc_id_0"},{"t":"f","p":[3,1],"dN":[{"t":"a","p":[1,1]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":4,"sibl":[3],"cn":"lc_id_0"},{"t":"cD","p":[3],"in":3,"sibl":[2],"cn":"lc_id_0"},{"t":"a","p":[5,1],"cn":"lc_id_0"},{"t":"f","p":[5,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"cD","p":[5],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[7],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"i","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[5,4,3,2,1,0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-carousel-item']) {
    ...
    class LyteCarouselItemCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-carousel-next']) {
    ...
    class LyteCarouselNextCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry
            }];
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-carousel-prev']) {
    ...
    class LyteCarouselPrevCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry
            }];
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-carousel-indicator-item']) {
    window._lyteUiUtils.registeredCustomElements['lyte-carousel-indicator-item'] = true;

    class LyteCarouselIndicatorItemCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry
            }];
    ...
    LyteCarouselIndicatorItemCustomElements.options = {clone : {allCallbacks : false}};

    LyteCarouselIndicatorItemCustomElements.register("lyte-carousel-indicator-item");
}
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(59721206)));
