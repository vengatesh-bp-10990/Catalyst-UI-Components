"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-kanbanview"],{

/***/ 68113382:
/*!**************************************************!*\
  !*** ./components/javascript/lyte-kanbanview.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteKanbanviewComponent": () => (/* binding */ LyteKanbanviewComponent)
/* harmony export */ });
 ...
 */
class LyteKanbanviewComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
        this._lyteUtilFunctions = ["getVisibleBoard"];
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			...
			'ltPropBoardDetails': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				'default': []
			}),
			/**
			...
			*/
			 ...
			 */
			'ltPropSortable': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('object', {
				'default': { "board": true, "card": true }
			 ...
			 * @default false
			 */
			'ltPropMoreStageRecord': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				'default': false
			}),
			/**
			 ...
			 * @version 3.1.0
			 */
			'ltPropId': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string'),
			/** 
			 * @componentProperty {boolean} ltPropPreventBoardDetailObserver
			 * @version 3.1.0
			 * @default false
			 */
			'ltPropPreventBoardDetailObserver': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				'default': false
			}),
			/**
			 ...
			 * @default true
			 */
			'ltPropViewPort': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				'default': true
			}),
			/**
			 ...
			 * @default 250
			 */
			'ltPropBoardScrollStopDuration': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 250
			}),
			/**
			 ...
			 * @default false
			 */
			'ltPropAria': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				'default': false
			}),
			/**
			 ...
			 * @default {}
			 */
			'ltPropAriaAttributes': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('object', {
				default: {}
			}),
			/**
			...
			* @version 3.1.0
			*/
			'ltPropSortableCancel': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string'),
			'ltPropSortableRestrict': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string'),
			/**
			* @experimental dummyId
			*/
			'dummyId': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', {
				'default': ''
			}),
			'ltPropKanbanItemClassKey': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: '' }),
			'ltPropIntersection': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('object', {
				'default': { "board": false, "card": false }

			}),
			'ltPropBoardWidth': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', { default: '300px' }),

			'visibleBoards': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				'default': []
			}),
			'lastTopIndex': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': -1
			}),
			'lastBottomIndex': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': -1
			}),
			'currentStartIndex': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 0
			}),
			'currentEndIndex': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 0
			}),
			'rowsPerLoad': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				'default': 10
			})
		}), arg1);
	}
    ...
    setVisibleArray() {
		...
		for (let i = 0; i < Math.min(rowsPerLoad, boardDetails.length); i++) {
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(visibleBoards, 'push', true)
		}
	}
    ...
    addVisibleRows(kanbanItem) {
		...
		if (indexToShow > visibleBoards.length - 1) {
			...
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.appendChild)(kanbanItem, kanbanItem._removedChild)
    ...
    removeNotVisibleRows(row) {
		...
		if (visibleBoards[index] && !row._removedChild && !row.classList.contains('sortable-element-selected') && !row.classList.contains('lyteKanbanSortableParent')) {
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__._setIgnoreDisconnect)(true);
			...
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__._setIgnoreDisconnect)(false);
			return true
		}
		return false
	}
		...
		if (boardWithoutSortable.length > 0 && boardWithSortable.length > 0) {
			...
			var sortableObject = {
				...
				onReady: function (sortableElem) {
					var board = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(sortableElem)[0].closest("lyte-board")
				...
				onSelect: function (currentElem, fromIndex, source, event) {
					...
					if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(currentElem).hasClass('lyteKanbanNoResultMsg')) {
						return false;
					}

					window._lyteUiUtils.closeAllPopups()
					...
					if (res && (self.getData('ltPropIntersection').card || self.getData('ltPropIntersection').board)) {
						var kanbanItem = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(currentElem)[0].closest('lyte-kanban-item')
				...
				onEnter: function (event, obj) {
					...
					if (element.getAttribute('cards-length') == 0) {
						...
						if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(div).hasClass('lyteKanbanNoResultMsg')) {
				...
				onBeforeDrop: function (droppableElement, belowElement, placeholderElement, fromIndex, toIndex, source, destination) {
					...
					if (!flag && (self.getData('ltPropIntersection').card || self.getData('ltPropIntersection').board)) {
						var kanbanItem = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(droppableElement)[0].closest('lyte-kanban-item')
				...
				onDrop: function (droppedElement, destination, belowElement, fromIndex, toIndex, source) {
					...
					draggedElement = (self.hasSameColumnReordered(source, destination) ? (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(destArray, 'splice', fromIndex, 1) : (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(sourceArray, 'splice', fromIndex, 1))
					;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(destArray, 'splice', toIndex, 0, draggedElement[0])
					delete self.prevent
					...
					if (self.getData('ltPropIntersection').card || self.getData('ltPropIntersection').board) {
						var kanbanItem = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(source)[0].closest('lyte-kanban-item')
						kanbanItem && kanbanItem.classList.remove('lyteKanbanSortableParent')
					}
				}
			}
    ...
    setupSortableForBoard() {
		...
		var sortableObject = {
			...
			onDrop: function (droppedElement, destination, belowElement, fromIndex, toIndex, source) {
				...
				draggedElement = (0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(boardDetails, 'splice', fromIndex, 1)
				;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(boardDetails, 'splice', toIndex, 0, draggedElement[0])
				delete self.prevent
				...
				_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('.lyteKanbanNestedSortable ', this.$node).sortable("destroy")
		...
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('.lyteKanbanviewScrollDivSelector ', this.$node).sortable(sortableObject);
	}
    ...
    setupSortableForCard() {
		...
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('.lyteKanbanNestedSortable', this.$node).sortable(sortableObject);
		// }
    ...
    addSortableForNewBoards() {
		...
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(boardWithoutSortable).addClass("sortable-element " + sortableClass);
	}
				...
				if (this.getData('ltPropIntersection').board) {
					if (this.getData('visibleBoards').length < this.getData('rowsPerLoad')) {
						...
						if (changeObj.insertedItems && changeObj.insertedItems.length > 0 && this.getData('visibleBoards').length == changeObj.index) {
							(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(this.getData('visibleBoards'), 'push', true)
						}
						if (this.getData('visibleBoards').length > this.getData('ltPropBoardDetails').length) {
							(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(this.getData('visibleBoards'), 'removeAt', this.getData('visibleBoards').length - 1)
						}
					}
...
LyteKanbanviewComponent._template = "<template tag-name=\"lyte-kanbanview\"> <div class=\"lyteKanbanviewScrollDivSelector {{dummyId}} {{if(ltPropBoardIntersection,'','')}}\" onscroll=\"{{action('onBodyScroll',event)}}\"> <template items=\"{{ltPropBoardDetails}}\" item=\"item\" index=\"dataIndex\" is=\"for\" _new=\"true\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropIntersection.board}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-kanban-item class=\"lyteKanbanViewItem {{item[ltPropKanbanItemClassKey]}} {{if(item.collapse,'lyteKanbanBoardCollapse','')}}\" data-index=\"{{dataIndex}}\" style=\"width: {{ltPropBoardWidth}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{visibleBoards[dataIndex]}}\" is=\"case\" lc-id=\"lc_id_0\"><lyte-yield yield-name=\"kanbanYield\" lyte-board-item=\"{{item}}\" lyte-index=\"{{dataIndex}}\" lyte-kanban-id=\"{{dummyId}}\"></lyte-yield></template></template></lyte-kanban-item> </template><template default=\"\"> <div class=\"lyteKanbanViewItem {{item[ltPropKanbanItemClassKey]}} {{if(item.collapse,'lyteKanbanBoardCollapse','')}}\" data-index=\"{{dataIndex}}\"> <lyte-yield yield-name=\"kanbanYield\" lyte-board-item=\"{{item}}\" lyte-index=\"{{dataIndex}}\" lyte-kanban-id=\"{{dummyId}}\"></lyte-yield> </div> </template></template></template> </div> </template>";;
LyteKanbanviewComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"f","p":[1,1],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","ltPropBoardWidth"]}}},"cn":"lc_id_0"},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[0],"cn":"lc_id_0"},{"t":"i","p":[0],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"a","p":[1,1],"cn":"default"},{"t":"i","p":[1,1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteKanbanviewComponent._observedAttributes = [
    "ltPropBoardDetails",
    "ltPropSortable",
    "ltPropMoreStageRecord",
    "ltPropId",
    "ltPropPreventBoardDetailObserver",
    "ltPropViewPort",
    "ltPropBoardScrollStopDuration",
    "ltPropAria",
    "ltPropAriaAttributes",
    "ltPropSortableCancel",
    "ltPropSortableRestrict",
    "dummyId",
    "ltPropKanbanItemClassKey",
    "ltPropIntersection",
    "ltPropBoardWidth",
    "visibleBoards",
    "lastTopIndex",
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-kanban-item']) {
    window._lyteUiUtils.registeredCustomElements['lyte-kanban-item'] = true;

    class LyteKanbanItemCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
			return [{
        ...
        disconnectedCallback() {
			...
			if ((0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.shouldIgnoreDisconnect)()) {
				return
			}
			...
			var kanbanview = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(lyteNode).closest('lyte-kanbanview').get(0);
    ...
    LyteKanbanItemCustomElements.options = { clone: { allCallbacks: false } };

    LyteKanbanItemCustomElements.register('lyte-kanban-item');
}
...
LyteKanbanviewComponent.register("lyte-kanbanview", {
    hash: "LyteKanbanviewComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(68113382)));
