"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/avatar-navigator/lyte-avatar-navigator"],{

/***/ 80113278:
/*!*************************************************************************!*\
  !*** ./components/javascript/avatar-navigator/lyte-avatar-navigator.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteAvatarNavigatorComponent": () => (/* binding */ LyteAvatarNavigatorComponent)
/* harmony export */ });
...
class LyteAvatarNavigatorComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
        this._lyteUtilFunctions = [ 'reset' ];
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			...
			"ltPropImages": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'array', { 'default': [] } ),
			...
			"ltPropUrlValue": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': 'image' } ),
			...
			"ltPropAvatarYield": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': false } ),
			...
			"ltPropIconYield": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': false } ),

			/**
			 * @componentProperty {string} ltPropImageWidth=0px
			 */

			"ltPropImageWidth": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': '0px' } ),

			/**
			 * @componentProperty {string} ltPropSystemValue=value
			 */

			"ltPropSystemValue": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': 'value' } ),
			...
			"ltPropSelected": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'object', { 'default': {} } ),
			...
			"ltPropSelectedClass": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'selectedClass', 'lyteAvatarSelectedItem' ) } ),
			...
			"ltPropPreviousIconClass": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'previousIconClass', 'lyteAvatarPrevIcon' ) } ),
			...
			"ltPropNextIconClass": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'nextIconClass', 'lyteAvatarNextIcon' ) } ),

			/**
			 * @componentProperty {string} ltPropAltValue
			 */

			"ltPropAltValue": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': '' } ),

			/**
			 * @componentProperty {string} ltPropAlt
			 */

			"ltPropAlt": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'alt', '' ) } ),
			...
			"ltPropCyclic": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'cyclic', true ) } ),
			...
			"ltPropTooltipValue": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': '' } ),
			...
			"ltPropTooltip": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'object', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'tooltip', 
				{ 
   					'position': 'bottom', 
   					'appearance': 'box',
   					'margin': 5,
				 ...
				 */
   			"ltPropPreload": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': window._lyteUiUtils.resolveDefaultValue( 'lyte-avatar-navigator', 'preload', false ) } ),

   			/**
			 * @componentProperty {string} ltPropAriaLabelValue
			 */

   			"ltPropAriaLabelValue": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': '' } ),


			"blocks": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'array', { 'default': [] } ),
			"imagesPerBlock": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'number', { 'default': 0 } ),
			"displayIndex": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'number' ),
			"imageHeight": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { 'default': '0' } ),
			"isAnimating": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': false } ),
			"rangeSet": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'array', { 'default': [] } ),
			"showLeftArrow": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': true } ),
			"showRightArrow": (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'boolean', { 'default': true } )
		}), arg1);
	}

    updateTabIndex() {
		var imageItems = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( 'lyte-avatar-navigator-item', this.$node ),
    ...
    setup() {
		...
		if( !this.isEmpty() ) {
			...
			this.setImageDimensions().then( function() {
				...
				that.setContainerWidth();
				block = that.buildImageBlock( displayIndex );
				that.$addon.objectUtils( block, 'add', 'translate', 0 );
				that.preloadImages();
			} );
    ...
    wrapAroundDelay(fn, timeout) {
		var isWidget = this.$addon.isWidgetBuild;
    ...
    setImageDimensions() {
		...
		var prom = new Promise( function( resolve ) {
			that.wrapAroundDelay( function() {
				...
				if( imageWidth === 0 ) {
					that.setData( 'ltPropImageWidth', _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( item ).outerWidth( true ) + 'px' );
				}
				
				that.setData( 'imageHeight', _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( item ).outerHeight( true ) + 'px' );
    ...
    setDisplayIndex() {
		...
		if( _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().isEmptyObject( sel ) ) {
    ...
    removeSelectedClass() {
		...
		var previousItems =  _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()("."+sel,this.$node);
    ...
    addSelectedClass(navItem) {
		...
		if( navItem ) {
			...
			var selectedItems = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()("[data-image-id='"+imageId+"']",this.$node);
    ...
    selectItem(event) {
		...
		navItem = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( target ).closest( 'lyte-avatar-navigator-item' ).get( 0 ),
...
LyteAvatarNavigatorComponent._template = "<template tag-name=\"lyte-avatar-navigator\" role=\"region\" aria-description=\"{{lyteUiI18n(&quot;lyte.avatar.navigator.description&quot;)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{showLeftArrow}}\" is=\"case\" lc-id=\"lc_id_0\"> <div aria-description=\"{{lyteUiI18n(&quot;lyte.avatar.navigator.previous.nav.description&quot;)}}\" role=\"button\" tabindex=\"0\" class=\"lyteAvatarArrowCont\" onclick=\"{{action('navigatePrevious',event)}}\" onkeydown=\"{{action('navigatePreviousOnKey',event)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropIconYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"previousIconYield\"></lyte-yield> </template><template default=\"\"> <span class=\"{{ltPropPreviousIconClass}}\"></span> </template></template><span class=\"lyteVisuallyHidden\"> {{lyteUiI18n(\"lyte.avatar.navigator.previous.nav.button\")}} </span> </div> </template></template><div class=\"lyteAvatarSetCont\" style=\"height:{{imageHeight}};\" onclick=\"{{action('selectItem',event)}}\" onkeydown=\"{{action('selectItemOnKey',event)}}\"> <template items=\"{{blocks}}\" item=\"block\" index=\"blockIndex\" is=\"for\" _new=\"true\"> <div class=\"{{block.class}}\" style=\"transform: translate({{concat(block.translate,'px')}});\" ontransitionend=\"{{action('removeClass',event,block)}}\"> <template items=\"{{block.images}}\" item=\"imageObj\" index=\"imageIndex\" is=\"for\" _new=\"true\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropAvatarYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"avatarYield\" lyte-image=\"{{imageObj}}\"></lyte-yield> </template><template default=\"\"> <lyte-avatar-navigator-item lt-prop-image=\"{{imageObj}}\"></lyte-avatar-navigator-item> </template></template></template> </div> </template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderDummyImage}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteAvatarSet\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropAvatarYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"avatarYield\" lyte-image=\"{{dummyImage}}\"></lyte-yield> </template><template default=\"\"> <lyte-avatar-navigator-item lt-prop-image=\"{{dummyImage}}\"></lyte-avatar-navigator-item> </template></template></div> </template></template></div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{showRightArrow}}\" is=\"case\" lc-id=\"lc_id_0\"> <div aria-description=\"{{lyteUiI18n(&quot;lyte.avatar.navigator.next.nav.description&quot;)}}\" role=\"button\" tabindex=\"0\" class=\"lyteAvatarArrowCont\" onclick=\"{{action('navigateNext',event)}}\" onkeydown=\"{{action('navigateNextOnKey',event)}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropIconYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"nextIconYield\"></lyte-yield> </template><template default=\"\"> <span class=\"{{ltPropNextIconClass}}\"></span> </template></template><span class=\"lyteVisuallyHidden\"> {{lyteUiI18n(\"lyte.avatar.navigator.next.nav.button\")}} </span> </div> </template></template><span class=\"lyteVisuallyHidden\" aria-live=\"polite\"> {{lyteUiI18nWithArgs('lyte.avatar.navigator.images.shown',expHandlers(displayIndex,'+',1),expHandlers(displayIndex,'+',imagesPerBlock))}} </span> </template>";;
LyteAvatarNavigatorComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"},{"t":"tX","p":[1,2,1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":3,"sibl":[2]},{"t":"a","p":[2],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'height:'","imageHeight","';'"]}}}},{"t":"a","p":[2,1]},{"t":"f","p":[2,1],"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'transform: translate('",{"type":"helper","value":{"name":"concat","args":["block.translate","'px'"]}},"');'"]}}}},{"t":"a","p":[1,1]},{"t":"f","p":[1,1],"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"cD","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"s","p":[2,3],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"cD","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[4],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"},{"t":"tX","p":[1,2,1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"t":"tX","p":[5,1]},{"type":"dc","trans":true,"hc":true,"p":[3,2,1,0]}];;

LyteAvatarNavigatorComponent._observedAttributes = [
    "ltPropImages",
    "ltPropUrlValue",
    "ltPropAvatarYield",
    "ltPropIconYield",
...
LyteAvatarNavigatorComponent.register("lyte-avatar-navigator", {
    hash: "LyteAvatarNavigatorComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(80113278)));
