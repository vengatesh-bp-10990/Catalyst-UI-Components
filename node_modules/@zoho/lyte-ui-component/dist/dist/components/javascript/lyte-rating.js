"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-rating"],{

/***/ 19346778:
/*!**********************************************!*\
  !*** ./components/javascript/lyte-rating.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteRatingComponent": () => (/* binding */ LyteRatingComponent)
/* harmony export */ });
...
class LyteRatingComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			 ...
			 * @minValue 0
             */
			"ltPropValue" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number",{"default":0}),
             ...
             */
			"ltPropCount" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number",{"default":5}),

			/**
             * @componentProperty {string} ltPropWrapperClass
             * @version 3.1.0
             */
			"ltPropWrapperClass" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),
             ...
             * @default svg
             */
			"ltPropType" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"svg"}),	//svg,multiple,switch,toggle,class
             ...
             */
			"ltPropAppearance" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),				//star,heart,lineStar,lineHeart,smiley,likeDislike,custom
             ...
             * 
             */
			"ltPropClearable" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean",{"default":false}),
			 ...
			 * @condition ltPropAppearance star,heart,custom
             */
			"ltPropHalfIncrement" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean",{"default":false}),
			 ...
			 * @condition tPropAppearance custom,class ,class 
             */
			"ltPropEmptyIcon" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"lyteRatingHeartEmptyIcon"}),
			 ...
			 * @condition ltPropType class,multiple,toggle,switch 
			 * @condition tPropAppearance custom,class  
             */
			"ltPropFullIcon" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"lyteRatingHeartRatedIcon"}),
             ...
             */
			"ltPropHalfIcon" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"lyteRatingHeartRatedHalfIcon"}),
			 ...
			 * @condition tPropAppearance custom,class 
             */
			"ltPropHoverFullIcon" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"lyteRatingHeartHoverRatedIcon"}),
			 ...
			 * @condition ltPropType class
             */
			"ltPropHoverHalfIcon" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"lyteRatingHeartHoverHalfIcon"}),
             ...
             * @version 3.1.0
             */
			"ltPropEmptyColor" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),

			/**
             * @componentProperty {colorString} ltPropFillColor
             * @version 3.1.0
             */
			"ltPropFillColor" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),

			/**
             * @componentProperty {colorString} ltPropHoverColor
             * @version 3.1.0
             */
			"ltPropHoverColor" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),
             ...
             */
			"ltPropWidth" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"22px"}),
			 ...
			 * @condition ltPropAppearance star,heart,lineStar,lineHeart,custom,class
             */
			"ltPropHeight" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"22px"}),
             ...
             * @default 0.5
             */
			"ltPropPrecision" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number",{"default":0.5}),
			/**
             * @componentProperty {string} ltPropStroke
             * @version 3.1.0
             */
			"ltPropStroke" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),
			"countArray" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array",{"default":[]}),
			"currentHover" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number",{"default":0}),
			"emptyIconArray" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array",{"default":[]}),
			"fullIconArray" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array",{"default":[]}),
			"halfIconArray" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array",{"default":[]}),
			"hoverFullIconArray" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array",{"default":[]}),
			"hoverHalfIconArray" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array",{"default":[]}),
			"starVB" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"6.5 4.5 21 21"}),
			"lineStarVB" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"5.5 2.5 23 23"}),
			"heartVB" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"1.5 0.5 20 20"}),
			"lineHeartVB" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string",{"default":"1 0 21 21"}),
			"ratingNum" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number",{"default":0}),
			"ltPropPrevWrapper" : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string")
		}), arg1);		
	}
				...
				if(currentRating < ratedNodes.length){
					...
					for(var i = currentRating; i < ratedNodes.length; i++){
						if(this.getData("ltPropAppearance") == "lineHeart"){
							...
							this.$addon.objectUtils(obj,"add","appearance","#lineHeart");
							this.$addon.objectUtils(obj,"add","viewbox",this.getData('lineHeartVB'));
						}
						if(this.getData("ltPropAppearance") == "lineStar"){
							// $L('use',ratedNodes[i]).attr("href","#lineStar");
							obj = this.getData('countArray')[i];
							this.$addon.objectUtils(obj,"add","viewbox",this.getData('lineStarVB'));
						}
						if(this.getData("ltPropAppearance") == "lineHeart" || this.getData("ltPropAppearance") == "lineStar"){
							_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',ratedNodes[i]).css('stroke',this.getEmptyColor());
							_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',ratedNodes[i]).css('fill',"transparent");
						}
						else{
							_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',ratedNodes[i]).css('fill',this.getEmptyColor());
						}
					...
					for(var i = 0; i < currentRating && i < nodes.length; i++){
						if(this.getData("ltPropAppearance") == "lineHeart"){
							...
							obj = this.getData('countArray')[i];
							this.$addon.objectUtils(obj,"add","appearance","#heart");
							this.$addon.objectUtils(obj,"add","viewbox",this.getData('heartVB'));
						}
						if(this.getData("ltPropAppearance") == "lineStar"){
							// $L('use',nodes[i]).attr("href","#star");
							obj = this.getData('countArray')[i];
							this.$addon.objectUtils(obj,"add","viewbox",this.getData('starVB'));
						}
						_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('fill',this.getFillColor());
						_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('stroke',"");
						nodes[i].classList.add(this.getData('ltPropFullIcon'),"lyteRated");
					}
				}
			}
    ...
    getClass(index, iconType) {
		if(iconType == "fi"){
			return this.$component.registeredHelpers.lyteUiGetArrayValueByIndex(this.getData('fullIconArray'),index);
		}
		if(iconType == "hi"){
			return this.$component.registeredHelpers.lyteUiGetArrayValueByIndex(this.getData('halfIconArray'),index);
		}
		if(iconType == "hfi"){
			return this.$component.registeredHelpers.lyteUiGetArrayValueByIndex(this.getData('hoverFullIconArray'),index);
		}
		if(iconType == "hhi"){
			return this.$component.registeredHelpers.lyteUiGetArrayValueByIndex(this.getData('hoverHalfIconArray'),index);
		}
	}
    ...
    onOver(event) {
		...
		if(this.getData('ltPropType') == "svg"){
			if(this.$component.registeredHelpers.lyteUiCheckHalfRatingSvg(this.getData('ltPropHalfIncrement'), this.getData('ltPropPrecision'))){
				...
				if(value > hoveredNodes){
					for(var i = hoveredNodes; i < value; i++){
						...
						_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('fill',this.getHoverColor());
						_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('stroke',"");
					}
				}
					...
					for(var i = value; i < hoveredNodes; i++){
						...
						if(value < this.getData('ltPropValue')){
							...
							if(this.getData("ltPropAppearance") == "lineHeart" || this.getData("ltPropAppearance") == "lineStar"){
								_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('stroke',this.getEmptyColor());
								_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('fill',"transparent");
							}
							else{
								_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()('svg',nodes[i]).css('fill',this.getEmptyColor());
							}
						}
					}
				}
			...
			nodes[value-1].classList.add(this.$component.registeredHelpers.lyteUiGetArrayValueByIndex(this.getData('hoverFullIconArray'),value-1),'lyteRatingHover');
			this.setData('currentHover',value);
		}
		else if(this.getData('ltPropType') == "multiple" && this.getData('ltPropAppearance') != 'smiley'){
			if(this.getData('ltPropHalfIncrement')){
    ...
    onOut(event) {
		var target = event.target.closest('lyte-rate-icon');
		if(this.getData('ltPropType') == "switch"){
			target.classList.remove(this.$component.registeredHelpers.lyteUiGetArrayValueByIndex(this.getData('hoverFullIconArray'), parseInt(target.getAttribute('data-lrc')) - 1),'lyteRatingHover');
			this.setData('currentHover',0);
		}
		else{
    ...
    static observers(arg1) {
        return Object.assign(super.observers({
			addReadOnlyClass : function(){
				var readonly = this.getData("ltPropReadOnly");
				if(readonly){
					this.$node.classList.add('lyteRatingReadOnly');
				}else{
					this.$node.classList.remove('lyteRatingReadOnly');
				}
			}.observes("ltPropReadOnly").on('didConnect'),
			addWrapperClass : function(){

				var wrapperClass = this.getData("ltPropWrapperClass");
				var prev_Wrapper = this.getData("ltPropPrevWrapper");
				if(prev_Wrapper){
					this.$node.classList.remove(prev_Wrapper);
				}
				if(wrapperClass){
					this.$node.classList.add(wrapperClass);
					this.setData("ltPropPrevWrapper",wrapperClass)
				}
			}.observes("ltPropWrapperClass").on('didConnect'),
...
LyteRatingComponent._template = "<template tag-name=\"lyte-rating\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"rateIcon\"></lyte-yield> </template><template case=\"{{expHandlers(ifNotEquals(ltPropAppearance,'smiley'),'&amp;&amp;',lyteUiIfEqualsAny(ltPropType,'switch','multiple'))}}\" is=\"case\" lc-id=\"lc_id_1\"> <template items=\"{{countArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-rate-icon class=\"{{lyteUiGetArrayValueByIndex(emptyIconArray,index)}}\" data-lrc=\"{{item.ind}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,';')}}\"></lyte-rate-icon> </template> </template><template case=\"{{ifEquals(ltPropType,'svg')}}\" is=\"case\" lc-id=\"lc_id_2\"> <template items=\"{{countArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-rate-icon class=\"{{lyteUiGetArrayValueByIndex(emptyIconArray,index)}}\" data-lrc=\"{{item.ind}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{lyteUiCheckHalfRatingSvg(ltPropHalfIncrement,ltPropPrecision)}}\" is=\"case\" lc-id=\"lc_id_0\"> <svg viewBox=\"{{item.viewbox}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,lyteUiGetFillOrStroke(ltPropAppearance,'var(--lyte-rating-empty-color)',ltPropStroke))}}\"> <linearGradient id=\"{{lyteUiConcat('filledGradient',ratingNum,'__',item.ind)}}\" x1=\"0%\" y1=\"0%\" x2=\"100%\" y2=\"0%\"> <stop offset=\"0%\" style=\"stop-color: var(--lyte-rating-empty-color);\"></stop> <stop offset=\"0%\" style=\"stop-color: var(--lyte-rating-empty-color);\"></stop> <stop offset=\"0%\" style=\"stop-color: var(--lyte-rating-empty-color);\"></stop> </linearGradient> <use href=\"{{item.appearance}}\" fill=\"{{lyteUiConcat('url(#','filledGradient',ratingNum,'__',item.ind,')')}}\"></use> </svg> </template><template default=\"\"> <svg viewBox=\"{{item.viewbox}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,lyteUiGetFillOrStroke(ltPropAppearance,'var(--lyte-rating-empty-color)',ltPropStroke))}}\"> <use href=\"{{item.appearance}}\"></use> </svg> </template></template></lyte-rate-icon> </template> </template><template default=\"\"> <template items=\"{{countArray}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-rate-icon class=\"{{ltPropEmptyIcon}}\" data-lrc=\"{{item.ind}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,';')}}\"></lyte-rate-icon> </template> </template></template><svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"0 0 18 18\" style=\"display: none;\" xml:space=\"preserve\"> <g> <path id=\"heart\" d=\"M7.2,1C4.5,1,2.3,3.4,2.1,6.7c0,0.1-0.1,0.9,0.2,2.2c0.4,1.8,1.3,3.4,2.6,4.7l6.6,6.5l6.7-6.5 c1.3-1.3,2.2-2.9,2.6-4.7c0.3-1.2,0.2-2,0.2-2.2C20.7,3.4,18.6,1,15.9,1c-1.8,0-3.4,1-4.4,2.7C10.5,2,8.9,1,7.2,1L7.2,1z\"></path> </g> </svg> <svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"0 0 18 18\" style=\"display: none;\" xml:space=\"preserve\"> <style type=\"text/css\"> .st0 { fill: none; stroke-miterlimit: 10; } </style> <g> <path id=\"lineHeart\" class=\"st0\" d=\"M6.1,1C3.4,1,1.2,3.4,1,6.7c0,0.1-0.1,0.9,0.2,2.2c0.4,1.8,1.3,3.4,2.6,4.7l6.6,6.5l6.7-6.5 c1.3-1.3,2.2-2.9,2.6-4.7c0.3-1.2,0.2-2,0.2-2.2C19.7,3.4,17.6,1,14.9,1c-1.8,0-3.4,1-4.4,2.7C9.4,2,7.8,1,6.1,1L6.1,1z\"></path> </g> </svg> <svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"5 5 89.6 80\" style=\"display: none;\" xml:space=\"preserve\"> <polygon id=\"star\" points=\"17,4.7 19.5,12 27,12 21,16.6 23.2,23.8 17,19.5 10.8,23.8 13,16.6 7,12 14.5,12 \"></polygon> </svg> </template>";;
LyteRatingComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true},"lc_id_1":{"dN":[{"t":"a","p":[1],"cn":"lc_id_1"},{"t":"f","p":[1],"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight","';'"]}}}},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_1"}],"cdp":{"t":"a","p":[1]},"dcn":true},"lc_id_2":{"dN":[{"t":"a","p":[1],"cn":"lc_id_2"},{"t":"f","p":[1],"dN":[{"t":"a","p":[1]},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight",null]}}},"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"a","p":[1,3],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight",null]}}},"cn":"default"},{"t":"a","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{},"default":{}},"hd":true,"co":["lc_id_0"],"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"lc_id_2"}],"cdp":{"t":"a","p":[2]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"f","p":[1],"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight","';'"]}}}},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"lc_id_1":{"dc":[0],"hc":true,"trans":true},"lc_id_2":{"dc":[0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0","lc_id_1","lc_id_2"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteRatingComponent._observedAttributes = [
    "ltPropValue",
    "ltPropCount",
    "ltPropWrapperClass",
    "ltPropType",
...
if( !_lyteUiUtils.registeredCustomElements[ 'lyte-rate-icon' ] ){
    ...
    class LyteRateIconCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_0__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
        ...
        connectedCallback() {
            ...
            if(!lyteNode.prevent){
		        var comp = lyteNode.closest('lyte-rating').component;
		        lyteNode.addEventListener('click',comp.onClick.bind(comp));
		        lyteNode.addEventListener('mousemove',comp.onOver.bind(comp));
		        lyteNode.addEventListener('mouseout',comp.onOut.bind(comp));
		        if(comp.getData('ltPropYield')){
		        	...
		        	comp.timeoutId = setTimeout(function(){
		        		var nodes = lyteNode.closest('lyte-rating').querySelectorAll('lyte-rate-icon');
		        		for(var i = 0; i<nodes.length; i++){
		        			nodes[i].setAttribute('data-lrc',i+1);
		        		}
		        	}.bind(lyteNode),100);
		        }
		        lyteNode.prevent = true;
	        }
        }
    ...
    LyteRateIconCustomElements.options = {clone : {allCallbacks : false}};

    LyteRateIconCustomElements.register("lyte-rate-icon");
}
...
LyteRatingComponent.register("lyte-rating", {
    hash: "LyteRatingComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(19346778)));
