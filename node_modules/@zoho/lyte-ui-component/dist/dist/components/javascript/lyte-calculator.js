"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-calculator"],{

/***/ 46989476:
/*!**************************************************!*\
  !*** ./components/javascript/lyte-calculator.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteCalculatorComponent": () => (/* binding */ LyteCalculatorComponent)
/* harmony export */ });
...
/* harmony import */ var _plugins_lyte_scrollbar_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../plugins/lyte-scrollbar.js */ 74039621);
/* harmony import */ var _plugins_lyte_scrollbar_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_plugins_lyte_scrollbar_js__WEBPACK_IMPORTED_MODULE_1__);
 ...
 */
class LyteCalculatorComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			'bigger' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default":false}),
			'equation' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string"),
			'previous' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string"),
			'numstack' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" : []}),
			'opstack' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default":[]}),
			'rank' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("object",{"default":undefined}),
			'secondLayer' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" : []}),
			'operator' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("string",{"default" : ''}),
			'check_error' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default" : false}),
			'deg' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default":false}),
			'memory' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("number",{"default":0}),
			'secondLayer' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('array',{"default":[]}),
			'secondKeySet' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" : []}),
			'secondActive' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default" : false}),
			'secondValue' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("array",{"default" : []}),
			'cursor' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default" : false}),
			'cursorIndex' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("number",{"default":0}),
			/**
			 * @componentProperty {boolean} ltPropEditable=false
			 */

			'ltPropEditable' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default" :  window._lyteUiUtils.resolveDefaultValue( 'lyte-calculator', 'editable', false )}),
			/**
			 * @componentProperty {boolean} ltPropAutoFocus=false
			 */

			'ltPropAutoFocus' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)("boolean",{"default" :  window._lyteUiUtils.resolveDefaultValue( 'lyte-calculator', 'autoFocus', false )}),
			/**
			 ...
			 * @version 3.1.0
			 */
			'ltPropAriaAttributes': (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('object',{'default':{}}),
			'ltPropDataTabindex' : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_3__.prop)('number',{'default':0})
		}), arg1);
	}
    ...
    didConnect() {
		...
		if(!this.getData('ltPropEditable')){
			_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_2___default()('.lyteCalculatorTextField',this.$node).scroll({preventVertical : true, preventHorizontal : true});
		}
    ...
    keyDown(event, obj) { // works for mouse and key
        ...
        return Object.assign(super.actions({
            ...
            "mupTextField" : function(e){
                ...
                if(inputField.value.length>=1){
                    inputField.focus();
                    window.index=this.getSelectionIndex();
        ...
        return Object.assign(super.observers({
            ariaObserver: function( change ) {
                ...
                if( this.getData('ltPropAria') ){
                    ...
                    window._lyteUiUtils.setAttribute( calculator, this.getData( 'ltPropAriaAttributes' ) || {}, {} );
                }
...
LyteCalculatorComponent.register("lyte-calculator", {
    hash: "LyteCalculatorComponent_2",
...
/******/ __webpack_require__.O(0, ["plugins_lyte-scrollbar_js","lyte","app-init-nonlyte"], () => (__webpack_exec__(46989476)));
