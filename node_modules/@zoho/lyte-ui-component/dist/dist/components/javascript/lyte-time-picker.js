"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-time-picker"],{

/***/ 51781437:
/*!***************************************************!*\
  !*** ./components/javascript/lyte-time-picker.js ***!
  \***************************************************/
...
class LyteTimePickerComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor() {
        super();
    }
    ...
    init() {
		...
		if (moment) {
			...
			time_to = this.toOtherLang(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(time_to, timeFormat), timeFormat), timeFormat);
		}
    ...
    data(arg1) {
		return Object.assign(super.data({
			ltPropValue: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropTimeFormat: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "hh:mm A" }),
			ltPropStartTime: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: undefined }),
			ltPropEndTime: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: undefined }),
			ltPropButton: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array", { default: [{ text: "Ok", purpose: "ok", properties: { appearance: "primary", ariaButton: {} } }] }),
			ltPropInterval: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { default: {} }),
			ltPropId: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropClass: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropName: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropPlaceholder: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropDisabled: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropReadonly: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropAllowDropdown: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropInline: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true }),
			ltPropBindToBody: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true }),
			ltPropBoundary: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { default: {} }),
			ltPropI18n: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropConvertNumbers: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropConvertedValue: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropFreeze: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropAriaAttributes: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { default: { input: "Time Picker", icon: "Choose Time", hour: "Select Hour", minute: "Select Minute", second: "Select Second", meridiem: "Select Meridiem", message: "Selected Time" } }),
			ltPropValidate: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropValidateType: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { default: { minmax: true, mandatory: true } }),
			ltPropValidateOn: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { default: { blur: true, init: false } }),
			ltPropValid: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true }),
			ltPropDropdownMinHeight: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number"),
			ltPropDropdown: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true }),
			ltPropCounter: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropAllowCounter: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropInputInterval: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object", { default: {} }),
			ltPropInputIntervalSync: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: false }),
			ltPropDropdownClass: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "" }),
			ltPropDropdownAlignPosition: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string", { default: "left" }),
			ltPropPreventInvalid: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true }),

			hours: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array", { default: [] }),
			minutes: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array", { default: [] }),
			seconds: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array", { default: [] }),
			meridiems: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("array", { default: [] }),
			minutesHide: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object"),
			hoursHide: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object"),
			secondsHide: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("object"),
			curFormat: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("number"),
			randId: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("string"),
			inBoundary: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true }),
			dropdownRefresh: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)("boolean", { default: true })
		}), arg1);
	}
    ...
    static actions(arg1) {
        return Object.assign(super.actions({
			...
			inputFocus: function (focusIn) {
				var $node = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node);
				if (focusIn) {
					this.inputClick();
    ...
    didConnect() {
		...
		$node.open = function () {
			...
			if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.dropDown).hasClass("lyteTimePickerDropdownNone")) {
		...
		$node.close = function () {
			...
			if (data.ltPropDropdown && !_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.dropDown).hasClass("lyteTimePickerDropdownNone") || !inBound) {
    ...
    disableElem(data, _class) {
		if (this.data[data]) {
			_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).addClass(_class);
		} else {
			_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).removeClass(_class);
		}
	}
    ...
    toEng(time, format) {
		if (time) {
			var data = this.data;
			return _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(time, format, { i18n: data.ltPropI18n, number_conversion: data.ltPropConvertNumbers }).format(format);
		}
	}

    alterObjUtils(obj, key, value) {
		key.forEach((item, index) => {
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(obj, "add", item, value[index]);
		});
	}
    ...
    hideDropDownVal(close, evt, buttonType, boundary) {
		...
		if (close) {
			...
			ariaExpand = false;
			freeze == false;
			_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.dropDown).removeClass("lyteDropdownSizeChange", "lyteDropdownTopSide");
		...
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.dropDown)[noneClass]("lyteTimePickerDropdownNone");
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node)[openClass]("lyteTimePickerDropdownOpened");
    ...
    setDropVal(onlyInfo, evt) {//set drop val to input || ltPropValue
		...
		curSetVal = this.toOtherLang(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(curSetVal, timeForm), timeForm);
		if (onlyInfo) {
			return curSetVal;
		}
    ...
    isValid(custFormat) {
		...
		var data = this.data,
			...
			moment = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(value, format, { i18n: data.ltPropI18n, number_conversion: data.ltPropConvertNumbers });
    ...
    validateRefresh() {
		...
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node)[validate ? 'addClass' : 'removeClass']("lyteTimePickerInvalidTime");
    ...
    validateTimeInterval(curTime, getInfo) {
		var data = this.data,
			...
			curTimeMoment = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(curTime, curFormat), curFormat),
			startMoment = data.ltPropStartTime && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(data.ltPropStartTime, curFormat), curFormat),
			endMoment = data.ltPropEndTime && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(data.ltPropEndTime, curFormat), curFormat),
    ...
    inputKeys(evt, fromCounter) {
		var activeElement = document.activeElement,
			...
			moment = curTime && curFormat && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(curTime, curFormat),
			...
			getUpdVal = function (func, val, nearest) {
				...
				if (func == "set") {
					...
					if (!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(tempUpdatedTime, curFormat).validate()) {
						return false;
					}
					tempUpdatedTime = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(tempUpdatedTime, curFormat).format(curFormat);
		...
		updatedTime && this.setData("ltPropValue", this.toOtherLang(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(updatedTime, curFormat), curFormat));

		inputElem.setSelectionRange(selectionStart, selectionEnd);
	}

    dropDownKeys(evt, dropDown) {
		if (!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(dropDown).hasClass("lyteTimePickerDropdownNone")) {
			var selectedItem = evt.target,
				...
				setVertCorresValue = function (corres, atmost, onlyInfo) {
					...
					while (sib != selectedItem && !button) {
						if (!sib || sib && !_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(sib).hasClass(selectedItemClass)) {
							if (onlyInfo) {
								return true;
							}
							sib = selectedItem.parentNode[atmost];
						}
						if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(sib).hasClass("lyteTimePickerBlur")) {
							sib = sib[corres];
						} else {
							evt.preventDefault();
							sib.focus();
			...
			availableUnits.forEach((item, index) => {
				if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(selectedItem).hasClass(item)) {
			...
			switch (key) {
				...
				case 'PageUp': {
					...
					_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(parent).addClass('lyteTimePickerScrollBehavior');
					parent.scrollTop += key == 'PageDown' ? chng : -chng;
					setTimeout(function () {
						_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(parent).removeClass('lyteTimePickerScrollBehavior')
					}, 1000);
					break;
				}
			}
    ...
    moveTop(selectElem, from, down) {
		...
		if (Math.abs(parent.scrollTop - scrollPosition) >= 1) {
			if (from && from != "start") {
				_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(selectElem.parentElement).addClass('lyteTimePickerScrollBehavior');
			}
			parent.scrollTop = scrollPosition;
			setTimeout(function () {
				_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(selectElem.parentElement).removeClass('lyteTimePickerScrollBehavior')
			}, 1000);
		}
	}
		...
		if ((listComp && !listComp.class.includes("lyteTimePickerBlur")) || overRide) {
			...
			if (_class == "meridiems" || _class == "hours" || _class == "minutes") {//it is also used to hide min and sec (based on hour)
				var selectedMeridiem = _this.getItemWithClass("meridiems", "lyteTimePickerItemSelected"),
					...
					timeFormat = data.ltPropTimeFormat,
					nextDay = data.ltPropStartTime && data.ltPropEndTime && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(data.ltPropStartTime, timeFormat), timeFormat).fromNow(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(data.ltPropEndTime, timeFormat), timeFormat)).past,
    ...
    setValuesManually(activateUnits, overRide, from, manualValue) {
		var _this = this,
			...
			moment = time ? _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(time, format)/*$L.moment(time, format, { i18n: data.ltPropI18n, number_conversion: data.ltPropConvertNumbers })*/ : _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment().startOf('day'),
    ...
    fixSelection(start, return_field) {
		var _this = this,
			data = _this.data,
			format = data.ltPropTimeFormat,
			moment = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(data.ltPropValue, format), format),
			input = this.input,
    ...
    setDropdownDim(evt, start) {
		var dropDown = this.dropDown,
			...
			fastdom = (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom);
		if (evt && _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(evt.target).closest(".lyteTimePickerUl").length) {
			return;
		}
		...
		fastdom.measure(function () {
			var scrolledY = window.pageYOffset || document.documentElement.scrollTop,
				...
				data = this.data,
				minFeildHeight = (data.ltPropDropdownMinHeight ? data.ltPropDropdownMinHeight : _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(dropDown).find('li')[0].offsetHeight) + data.paddingTop,
				inline = data.ltPropInline,
				bToBody = !inline && data.ltPropBindToBody,
				dropdownPositionLeft = data.ltPropDropdownAlignPosition == 'left',
				$dropDown = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(dropDown);
    ...
    modifyVal(start, end, range, type, __class, form, addUnit, ind) {
		var getConv = function (val) {
			...
			moment = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(getConv(start), form),
			retArr = [],
			inc = range ? range : 1;
    ...
    setUnitValues() {
		var data = this.data,
			...
			split = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(curTime, format).parseFormat(format),
			am = 'AM',
			pm = 'PM',
			startMoment,
			availTimeUnits = {},
			...
			setHourData = function (curFormat, start, end, timeFormat, type) {
				startMoment = this.toEng(startTime, format) || _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(start, curFormat);
				endMoment = this.toEng(endTime, format) || _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(end, curFormat);
				startMoment = (typeof (startMoment) == "string") ? _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(startMoment, format) : startMoment;
				endMoment = (typeof (endMoment) == "string") ? _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(endMoment, format) : endMoment;
		...
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.dropDown).removeClass("lyteTimePickerDropdownNone");
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.$node).addClass("lyteTimePickerDropdownOpened");
		this.setDropdownDim(undefined, true);
		if (!data.paddingTop) {
			this.setData("paddingTop", parseFloat(getComputedStyle(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(this.dropDown).find('.lyteTimePickerUl')[0]).paddingTop));
		}
	}
    ...
    dropDownButtonClick(evt) {
		...
		this.setUnitValues();
		_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function () {//fastdom is because updtDropDownDim called after setValuesManually, so that if the values are 59 and the dropdown is short, it is not in view
			_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.mutate(function () {
			...
			formatChange: function (arg) {
				var oldFormat = arg.oldValue,
					...
					changeFormat = function (data) {
						...
						value && ((data != 'ltPropValue') || this.isValid(oldFormat)) && this.setData(data, this.toOtherLang(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().moment(this.toEng(value, oldFormat), oldFormat).format(newFormat), newFormat), newFormat));
					}.bind(this);
...
(function () {
	var updtDropDownDim = function (evt) {
		Array.from(document.getElementsByTagName("lyte-time-picker-dropdown")).forEach(dropItem => {
			...
			if ((!_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(dropItem).hasClass("lyteTimePickerDropdownNone")) || !dropDown.data.inBoundary) {
	...
	window._lyteUiUtils.addEvent(document, 'click', function (evt) {
		...
		if (retClosest(".lyteTimePickerInput")) {
			...
			if (_node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()(mainComp.dropDown).hasClass("lyteTimePickerDropdownNone")) {
				hideDropDown();
...
LyteTimePickerComponent.register("lyte-time-picker", {
    hash: "LyteTimePickerComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(51781437)));
