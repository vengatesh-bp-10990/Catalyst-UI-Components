"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-tree-table/lyte-tree-table"],{

/***/ 68240886:
/*!******************************************************************!*\
  !*** ./components/javascript/lyte-tree-table/lyte-tree-table.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LyteTreeTableComponent": () => (/* binding */ LyteTreeTableComponent)
/* harmony export */ });
/* harmony import */ var _node_modules_slyte_component_src_directives_lyte_hide_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../node_modules/@slyte/component/src/directives/lyte-hide.js */ 98862259);
...
class LyteTreeTableComponent extends _component_js__WEBPACK_IMPORTED_MODULE_1__.Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			// Exposed variables
			ltPropHeader: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				default: []
			}),
			ltPropData: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				default: [],
				watch: true
			}),
			ltPropAsTree: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('string', {
				default: '1'
			}),
			ltPropScrollSpeed: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				default: 5
			}),
			ltPropRowSortable: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				default: false
			}),
			ltPropColumnSortable: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {
				default: true
			}),
			ltPropHideHeader : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean' , {
				default : false
			}),

			// Internal variables
			// intersection observer variables
			leftInterSectionArr: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				default: [0]
			}),
			rootMarginArr: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				default: []
			}),
			asTreeIndex: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('number', {
				default: 1
			}),
			fixedColConfigs: (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('array', {
				default: []
			}),

			// drag and drop variables
			initialRowVals : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('object' , {
				default : {
					top : 0,
					left : 0,
					right : 0,
			...
			initialClientVals : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('object' , {
				default : {
					x : 0,
					y : 0
				}
    ...
    mouseDownFunction(event) {
		...
		;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(_this.getData('initialClientVals') , 'add' , 'x' , event.clientX)
		;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(_this.getData('initialClientVals') , 'add' , 'y' , event.clientY)


		;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(_this.getData('initialRowVals') , 'add' , {
			'top' : rowDim.top,
			'left' : rowDim.left,
			'right' : rowDim.right,
					...
					if(!backgroundRow.hasClass('lyteTTCurrentDraggedRow')){
						if(event.clientY < (backgroundRowDim.top + topHeight)){
							...
							if((currentDraggedDataIndex > backgroundDataIndex) || (currentDraggedParentArray !== backgroundParentArray)){
								(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(currentDraggedParentArray , 'removeObjects' , currentDraggedObject)
								;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(backgroundParentArray , 'insertAt' , backgroundDataIndex , currentDraggedObject)
							...
							if(backgroundObject){
								...
								if(backgroundObject.children && backgroundObject.children.length>1){
									(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(backgroundObject , 'add' , 'collapsed' , false);
								}
								if(!backgroundObject.children){
									(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(backgroundObject , 'add' , 'children' , [])
								}
								...
								(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(backgroundObject.children , 'push' , currentDraggedObject)
								;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(currentDraggedParentArray , 'removeObjects' , currentDraggedObject)
							...
							if((currentDraggedDataIndex > backgroundDataIndex) || (currentDraggedParentArray !== backgroundParentArray)){
								(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(currentDraggedParentArray , 'removeObjects' , currentDraggedObject)
								;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(backgroundParentArray , 'insertAt' , (backgroundDataIndex+1) , currentDraggedObject)
							} else if((currentDraggedDataIndex < backgroundDataIndex) || (currentDraggedParentArray !== backgroundParentArray)){
								(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(backgroundParentArray , 'insertAt' , (backgroundDataIndex+1) , currentDraggedObject)
								;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(currentDraggedParentArray , 'removeObjects' , currentDraggedObject)
							}
    ...
    resetInitialVals() {
		(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(this.getData('initialClientVals') , 'add' , 'x' , 0)
		;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(this.getData('initialClientVals') , 'add' , 'y' , 0)
	}
    ...
    initiateIntersectionObserver() {
		...
		for (var i = 0; i < treeTableHeaader.length; i++) {
			if ($L(treeTableHeaader[i]).hasClass('lyteTreeFixedHeader')) {
				...
				if (i === 0) {
					...
					(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(this.getData('leftInterSectionArr'), 'push', toFixLeft);
				...
				;(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(this.getData('fixedColConfigs'), 'push', fixedColConfig)
				fixedColConfig = {}
			}
		}
		...
		for (var i = 0; i < testArr.length; i++) {
			...
			(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.arrayUtils)(this.getData('rootMarginArr'), 'push', rootMarVal)
		}
...
LyteTreeTableComponent._template = "<template tag-name=\"lyte-tree-table\" class=\"lyteTreeTable\"> <lyte-tree-table-node> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(calledFromInside,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-tree-table-header class=\"lyteTreeTableHeader{{if(ltPropHideHeader,' lyteTreeTableHeaderHidden','')}}\"> <lyte-yield yield-name=\"treeTableHead\" header-value=\"{{ltPropHeader}}\"></lyte-yield> </lyte-tree-table-header> </template></template><lyte-tree-table-body class=\"lyteTreeTableBody\"> <lyte-tree-table-child @hide-tag=\"true\" lt-prop-data=\"{{ltPropData}}\"> <template is=\"registerYield\" yield-name=\"treeTableRow\"> <lyte-yield class=\"lyteTreeTableRow {{lyteTTIconHelper(listValue)}} {{lyteTThasChildHelper(listValue)}}\" yield-name=\"lyteTreeTableRow\" list-value=\"{{listValue}}\" index=\"{{index}}\" level=\"{{level}}\" style=\"--tree-level:{{level}};\" data-index=\"{{indexVar}}\"> </lyte-yield> </template> </lyte-tree-table-child> </lyte-tree-table-body> </lyte-tree-table-node> </template>";;
LyteTreeTableComponent._dynamicNodes = [{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"i","p":[1,1],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":4,"sibl":[3]},{"t":"a","p":[1,2,1],"trans":true,"in":3,"sibl":[1],"chld":[2]},{"t":"r","p":[1,2,1,1],"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'--tree-level:'","level","';'"]}}}},{"t":"i","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"cD","p":[1,2,1],"_igTs":true},{"t":"cD","p":[1,2],"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0},{"type":"dc","trans":true,"hc":true,"p":[4,3,1,0]}];;

LyteTreeTableComponent._observedAttributes = [
    "ltPropHeader",
    "ltPropData",
    "ltPropAsTree",
    "ltPropScrollSpeed",
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-tree-table-icon']) {
    ...
    class LyteTreeTableIconCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
        ...
        constructor() {
            ...
            lyteNode.addEventListener('click', function (eve) {

				var currentRow = $L(lyteNode).closest('.lyteTreeTableRow')
				var currenttreeTable = $L(lyteNode).closest('lyte-tree-table')[0]
				...
				function openTree() {
					...
					function openFun(){
						if ((onBeforeCloseRet !== false) && ( onToggle !== false)) {
							(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(currenttreeTable.component.getTreeObj(currentDataIndex), 'add', 'collapsed', false)
				...
				function closeTree() {
					if ((currenttreeTable.component.executeMethod('onBeforeClose',
						...
						(0,_node_modules_slyte_component_index_js__WEBPACK_IMPORTED_MODULE_3__.objectUtils)(currenttreeTable.component.getTreeObj(currentDataIndex), 'add', 'collapsed', true)
    ...
    LyteTreeTableIconCustomElements.options = {clone : {allCallbacks : false}};
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-tree-table-tr']) {
    ...
    class LyteTreeTableTrCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry
            }];
    ...
    LyteTreeTableTrCustomElements.options = {clone : {allCallbacks : false}};
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-tree-table-th']) {
    ...
    class LyteTreeTableThCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry
            }];
        ...
        constructor() {
            super();
            var lyteNode = this.$node;
            var currYield = $L(lyteNode).closest('lyte-yield')
            var currInd = currYield.find('lyte-tree-table-th').indexOf(lyteNode);
            $L(lyteNode).attr("head-index", currInd)
            $L(lyteNode).addClass('lyteTreeTableHead' + currInd)
            if ($L(lyteNode)[0].hasAttribute('fixed')) {
				$L(lyteNode).addClass('lyteTreeFixedHeader')
			}
        }
    ...
    LyteTreeTableThCustomElements.options = {clone : {allCallbacks : false}};
...
if (!window._lyteUiUtils.registeredCustomElements['lyte-tree-table-td']) {
    ...
    class LyteTreeTableTdCustomElements extends _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry.CustomElements {
        lookups() {
            return [{
                component: _component_js__WEBPACK_IMPORTED_MODULE_1__.LyteUiComponentComponentRegistry
            }];
        ...
        constructor() {
            ...
            var currYield = $L(lyteNode).closest('lyte-yield')
            var currInd = currYield.find('lyte-tree-table-td').indexOf(lyteNode);
            $L(lyteNode).addClass('lyteTreeTableCol' + currInd)
            $L(lyteNode).attr("col-index", currInd)
        }
    ...
    LyteTreeTableTdCustomElements.options = {clone : {allCallbacks : false}};
...
LyteTreeTableComponent.register("lyte-tree-table", {
    hash: "LyteTreeTableComponent_2",
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(68240886)));
