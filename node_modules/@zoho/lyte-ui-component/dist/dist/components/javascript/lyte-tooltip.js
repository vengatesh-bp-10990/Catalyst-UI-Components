"use strict";
(self["webpackChunk_zoho_lyte_ui_component"] = self["webpackChunk_zoho_lyte_ui_component"] || []).push([["components/javascript/lyte-tooltip"],{

/***/ 42381715:
/*!***********************************************!*\
  !*** ./components/javascript/lyte-tooltip.js ***!
  \***********************************************/
...
class LyteTooltipComponent extends _component_js__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  data(arg1) {
    ...
    return Object.assign(super.data({
       ...
       * @version 1.0.0
       */
      ltPropKeepAlive : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)('boolean', {default : default_values.keepAlive || false }),
       ...
       * @version 2.2.20
       */
      ltPropTooltipConfig : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'object', { default : default_values.tooltipConfig || {} } ),
      ...
      ltPropIgnoreClass : (0,_node_modules_slyte_core_index_js__WEBPACK_IMPORTED_MODULE_2__.prop)( 'string', { default : default_values.ignoreClass || "lyteTooltipIgnore" } ),
  ...
  mousedown(evt) {
      ...
      $target = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( target ),
  ...
  mouseup(evt) {
      ...
      if( this._slider ){
         ...
         if( _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( target ).hasClass( 'lyteSliderHandler' ) ){
    ...
    // here tooltip changes its position on every mousemov. so fastdom can't  be used here
      if( span.parentNode ){
            ...
            if( span.classList.contains( 'lyteTooltipHidden' ) ){
              ...
              _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure( this._followcursor.bind( this, event,span ) );
            } else {
  ...
  nonFollowcursor(event, span, position, prevent) {
        ...
        if( !span._callbackHandled ) {
         ...
         _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().fastdom.measure(function(){
            ...
            ddct, calloutstyle,
            $span = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( span );
            if( appearance ) {
            ...
            switch(position.toLowerCase())
              {
               ...
               if( __startclass ){
                  var $span = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( span ).addClass( __startclass );
  ...
  removeTooltip(span) {
        ...
        if( __parent ){
            ...
            fn = function(){
                ...
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( span ).off( 'transitionend' );
            };
            ...
            config.aria && node.setAttribute( 'aria-expanded', "false" );
             ...
             if( __endClass ){
                _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( span ).removeClass( __endClass ).on( 'transitionend', fn );
  ...
  mousemove(event) {
        ...
        while(nodeName1 && nodeName1.tagName != 'BODY' && nodeName1 != document && nodeName1.tagName != 'HTML' ){
            ...
            Jnode = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( nodeName1 );
            ...
            if( title ){
                  ...
                  if( this.prevTooltipNode != nodeName1 && ( !tooltip.tooltipSpan || is_reuse ) ){
                      ...
                      Jobj = _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( span ),
                      ...
                      _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( span ).css({
                         opacity : "",
                         pointerEvents : ""
                      });
                      ...
                      _node_modules_zoho_lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default()( tooltip.tooltipSpan ).css({
                         display : "",
                         opacity : "",
                         pointerEvents : ""
                      });
...
/******/ __webpack_require__.O(0, ["lyte","app-init-nonlyte"], () => (__webpack_exec__(42381715)));
