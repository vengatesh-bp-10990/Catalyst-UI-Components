...
LyteAudioRecorderComponent._template = "<template tag-name=\"lyte-audio-recorder\"> <div class=\"lyteRecordingPreview\"> <canvas class=\"lyteRecordingCanvas\"></canvas> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropDisplayTime}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteTimePreview\">{{currentTime}}<template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropTimeLimit}}\" is=\"case\" lc-id=\"lc_id_0\">/{{totalTime}}</template></template></div> </template></template><div class=\"lyteRecordingControlButtons\"> <template object=\"{{ltPropButton}}\" value=\"value\" key=\"key\" is=\"forIn\" _new=\"true\"> <div purpose=\"{{value.purpose}}\" class=\"{{value.class}}\" lt-prop-title=\"{{value.title}}\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;Bottom&quot;}\" disabled=\"{{value.disable}}\" onclick=\"{{action('controlButtons',this)}}\"></div> </template> </div> <div class=\"lyteRecordingControlButtons\"> <template object=\"{{ltPropButton}}\" value=\"value\" key=\"key\" is=\"forIn\" _new=\"true\"> <div purpose=\"{{value.purpose}}\" class=\"{{value.class}}\" lt-prop-title=\"{{value.title}}\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;Bottom&quot;}\" disabled=\"{{value.disable}}\" onclick=\"{{action('controlButtons',this)}}\"></div> </template> </div> </template>";;
LyteAudioRecorderComponent._dynamicNodes = [{"t":"s","p":[3],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1,0],"cn":"lc_id_0"},{"t":"s","p":[1,2],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"sibl":[1]},{"t":"a","p":[4,1]},{"t":"fI","p":[4,1],"dN":[{"t":"a","p":[1]}],"sibl":[0]},{"t":"a","p":[6,1]},{"t":"fI","p":[6,1],"dN":[{"t":"a","p":[1]}]}];;

LyteAudioRecorderComponent._observedAttributes = [
    "ltPropOptions",
    "ltPropButton",
    "ltPropWorkersPath",
    "ltPropTimeLimit",
...
LyteAudioRecorderComponent.register("lyte-audio-recorder", {
    hash: "LyteAudioRecorderComponent_2",
