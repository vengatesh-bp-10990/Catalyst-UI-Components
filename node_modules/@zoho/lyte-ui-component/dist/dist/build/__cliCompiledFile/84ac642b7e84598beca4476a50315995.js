...
class LyteDrawerComponent extends Component {
    ...
    data(arg1) {
		return Object.assign(super.data({
			 ...
			 */
			ltPropPosition:prop("string",{"default":window._lyteUiUtils.resolveDefaultValue('lyte-drawer', 'position', "left")}),
			/** 
			 * @componentProperty  {string} ltPropWidth=200px
			 */
			ltPropWidth:prop("string",{"default":window._lyteUiUtils.resolveDefaultValue('lyte-drawer', 'width', "200px")}),
			/** 
			 * @componentProperty  {string} ltPropHeight=100%
			 */
			ltPropHeight:prop("string",{"default":window._lyteUiUtils.resolveDefaultValue('lyte-drawer', 'height', "100%")}),
			/** 
			 ...
			 */
			ltPropAnimationDuration:prop("string",{"default":window._lyteUiUtils.resolveDefaultValue('lyte-drawer', 'animationDuration', "0.3s")}),
			/** 
			 ...
			 */
			ltPropCloseOnSelect:prop("boolean",{"default":window._lyteUiUtils.resolveDefaultValue("lyte-drawer", "closeOnSelect", false)}),
			/** 
			 * @componentProperty  {boolean} ltPropOverlayClose=true
			 */
			ltPropOverlayClose : prop("boolean",{"default":window._lyteUiUtils.resolveDefaultValue("lyte-drawer", "overlayClose", true)}),
			/** 
			 * @componentProperty  {boolean} ltPropShowOpenButton=true
			 */
			 ltPropShowOpenButton : prop("boolean",{"default":window._lyteUiUtils.resolveDefaultValue("lyte-drawer", "showOpenButton", true)}),
			/** 
			 * @componentProperty  {boolean} ltPropShowCloseButton=true
			 */
			 ltPropShowCloseButton : prop("boolean",{"default":window._lyteUiUtils.resolveDefaultValue("lyte-drawer", "showCloseButton", true)}),
			 /** 
			 * @componentProperty  {boolean} ltPropCloseOnEscape=true
			 */
			ltPropCloseOnEscape : prop("boolean",{"default":window._lyteUiUtils.resolveDefaultValue("lyte-drawer", "closeOnEscape", true)}),
			/** 
    ...
    initializeDataForModal() {
		...
		lyteModal.ltProp("offset",{[currentPosition] : offset[currentPosition] != "center" ? offset[currentPosition] : "0px", top: offset.top});
	}
    ...
    openDrawer() {
		...
		if(this.data.ltPropShow) {
			...
			if(this.data.isMouseEvent) {
				window._lyteUiUtils.addGlobalEventListener( "mousemove", this._bindedDrawerClose, true);
			}
		}
	}
    ...
    closeOnHover(event) {
        if (this.$node) {
            ...
            if (elements.indexOf(parentElement) == -1 ) {
				this.setData("ltPropShow", false);
				if(!this.data.ltPropShow) {
					window._lyteUiUtils.removeGlobalEventListener( "mousemove", this._bindedDrawerClose, true);
    ...
    checkAndUpdateSelectedValue(config) {
		if(config.selection) {
			...
			objectUtils(config, "delete", "selection");
		}
	}
    ...
    checkAndUpdateDisbaleList(config) {
		if(config.disable) {
			...
			objectUtils(config, "delete", "disable");
		}
	}
...
window.addDrawerCloseEvent = function(){
...
if (document.readyState === "complete" || document.readyState === "interactive"){
    window.addDrawerCloseEvent();
}
else{
    window._lyteUiUtils.addGlobalEventListener("DOMContentLoaded", function(){
        addDrawerCloseEvent();
    });
}
