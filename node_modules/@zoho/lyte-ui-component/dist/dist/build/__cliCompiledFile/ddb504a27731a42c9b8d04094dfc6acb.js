...
import { Component, arrayUtils } from "../../node_modules/@slyte/component/index.js";

class LyteDragdropComponent extends Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
        return Object.assign(super.data({
			"ltPropAvailablelist" : prop("array",{"default":[]}),
			"ltPropSelectedlist" : prop("array",{"default":[]}),
			"ltPropMultiselect" : prop("boolean",{"default":true}),
			"ltPropEnableSearch" : prop("boolean",{"default":true}),
			"ltPropEnableIcon" : prop("boolean",{"default":true}),
			"ltPropDraggable" : prop("boolean",{"default":true}),
			"ltPropErrorMessage" : prop("string",{"default":""}),
			"ltPropAvailablelistEmptyMessage" : prop("string",{"default" : "Empty List"}),
			"ltPropSelectedlistEmptyMessage" : prop("string",{"default" : "Drop Here"}),
			"ltPropSearchStyle" : prop("string",{"default" : ""}),
			"ltPropAvailableLabel" : prop("string"),
			"ltPropSelectedLabel" : prop("string"),

			/*local variables of the component*/
			"clickCount" : prop("number",{"default":0}),
			"component" : prop("object",{"default":null}),
			"placeholder" : prop("object",{"default":null}),
			"div" : prop("object",{"default":null}),
			"offset" : prop("array",{"default":[0,0]}),
			"isDown" : prop("boolean",{"default":false}),
			"isMoved" : prop("boolean",{"default":false}),
			"top" : prop("number",{"default":0}),
			"bottom" : prop("number",{"default":0}),
			"prevScrollTop" : prop("number",{"default":0}),
			"multiSelectedItems" : prop("array",{"default":[]}),
			"keyPressed" : prop("boolean",{"default":false}),
			"keyValue" : prop("number",{"default":0}),
			"prevMode" : prop("string",{"default":""}),
			"checkSelection" : prop("boolean",{"default":false}),
			"querySelector" : prop("object",{"default":{'scope':'#sortableSec','target':'.filterlabel','search':'.item'}}),
			"left" : prop("boolean",{"default":false}),
			"right" : prop("boolean",{"default":false}),
			"availableList" : prop("array",{"default" : []}),
			"selectedList" : prop("array",{"default" : []}),
			"checkOnDidconnect" : prop("boolean",{"default" : false}),
			"draggedItems" : prop("array",{"default" : []})
		}), arg1);
	}

    makeDroppable(current) {
    ...
    checkPossiblePosition(ele, prop) {
    ...
    appendElement(event, prop) {
		...
		if (prop == 'span') {
			if (elem.classList.contains('lyteDragDropAdd') && this.onClickFunction(event, this.getElement(elem.parentElement), "availableList")) {
				...
				arrayUtils(this.getData('ltPropAvailablelist'),'removeAt',this.getElementPosition(this.getData('ltPropAvailablelist'),element),1);
				arrayUtils(this.getData('ltPropSelectedlist'),'push',element);
				element = null;
				this.generateArray();
			...
			if (elem.classList.contains('lyteDragDropRemove') && this.onClickFunction(event, this.getElement(elem.parentElement), "selectedList")) {
				...
				element = this.getElement(elem.parentElement);
				arrayUtils(this.getData('ltPropSelectedlist'),'removeAt',this.getElementPosition(this.getData('ltPropSelectedlist'),element),1);
				arrayUtils(this.getData('ltPropAvailablelist'),'push',element);
				element = null;
				this.generateArray();
				this.onDropFunction(event);
			}
    ...
    getElementPosition(arrayElm, elem) {
    ...
    hideOrShowMessageOnEmpty(prop, msg) {
    ...
    onClickFunction(event, element, fromList) {
		var returnVal;
		var items = [];
		items.push(element);
		this.setData('draggedItems', items);
...
LyteDragdropComponent._template = "<template tag-name=\"lyte-dragdrop\"> <div class=\"lyteDragDropFields\"> <div class=\"lyteDragDropColumns\"> <div class=\"lyteDragDropFL lytePosRel\"> <span class=\"lyteDragDropHeading\">{{ltPropAvailableLabel}}</span> <div class=\"lyteDragDropAvailable\"> <span class=\"lyteSelectedNone\" id=\"AvailableNone\">{{ltPropAvailablelistEmptyMessage}}</span> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropEnableSearch}}\" lc-id=\"lc_id_0\"> <div class=\"lytePosRel\"> <lyte-search style=\"display: block;\" lt-prop-style=\"{{ltPropSearchStyle}}\" lt-prop-query-selector=\"{{querySelector}}\" lt-prop-appearance=\"box\" lt-prop-error=\"{{ltPropErrorMessage}}\"></lyte-search> </div> <ul class=\"lyteAvailableUL\" id=\"sortableSec\"> <template is=\"for\" items=\"{{ltPropAvailablelist}}\" item=\"item\"> <li class=\"filterlabel sortableElem\" data-pos=\"{{item.pos}}\" data-propvalue=\"{{item}}\" onmousedown=\"{{action('mouseDown',event)}}\" onmouseover=\"{{action('mouseOver',event)}}\" onmouseout=\"{{action('mouseOut',event)}}\"> <span class=\"item\">{{item.name}}</span> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropDraggable}}\" lc-id=\"lc_id_0\"> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropEnableIcon}}\" lc-id=\"lc_id_0\"><span class=\"lyteDragDropAdd\"></span></template></template> </template></template> </li> </template> </ul> </template><template default=\"\"> <ul class=\"lyteAvailableUL\" id=\"sortableSec\" style=\"height: 336px;\"> <template is=\"for\" items=\"{{ltPropAvailablelist}}\" item=\"item\"> <li class=\"filterlabel sortableElem\" data-pos=\"{{item.pos}}\" data-propvalue=\"{{item}}\" onmousedown=\"{{action('mouseDown',event)}}\" onmouseover=\"{{action('mouseOver',event)}}\" onmouseout=\"{{action('mouseOut',event)}}\"> <span class=\"item\">{{item.name}}</span> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropDraggable}}\" lc-id=\"lc_id_0\"> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropEnableIcon}}\" lc-id=\"lc_id_0\"><span class=\"lyteDragDropAdd\"></span></template></template> </template></template> </li> </template> </ul> </template></template> </div> </div> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropDraggable}}\" lc-id=\"lc_id_0\"> <div class=\"lyteDragDropFL lytePosRel\"> <span class=\"lyteDragDropHeading\">{{ltPropSelectedLabel}}</span> <div class=\"lyteDragDropSelected\"> <span class=\"lyteSelectedNone\" id=\"SelectedNone\">{{ltPropSelectedlistEmptyMessage}}</span> <ul class=\"lyteSelectedUL\" id=\"dropSec\"> <template is=\"for\" items=\"{{ltPropSelectedlist}}\" item=\"item\"> <li data-pos=\"{{item.pos}}\" data-propvalue=\"{{item}}\" onmousedown=\"{{action('mouseDown',event)}}\" onmouseover=\"{{action('mouseOver',event)}}\" onmouseout=\"{{action('mouseOut',event)}}\"> <span>{{item.name}}</span> <template is=\"switch\" l-c=\"true\"><template is=\"case\" case=\"{{ltPropEnableIcon}}\" lc-id=\"lc_id_0\"><span class=\"lyteDragDropRemove\"></span></template></template> </li> </template> </ul> </div> </div> </template></template> </div> </div> </template>";;
LyteDragdropComponent._dynamicNodes = [{"t":"tX","p":[1,1,1,1,0]},{"t":"tX","p":[1,1,1,3,1,0]},{"t":"s","p":[1,1,1,3,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"cD","p":[1,1],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"a","p":[3,1],"cn":"lc_id_0"},{"t":"f","p":[3,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,1,0]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"]}],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1,1],"cn":"default"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,1,0]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"]}],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[1],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,1,3],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1,1,0],"cn":"lc_id_0"},{"t":"tX","p":[1,3,1,0],"cn":"lc_id_0"},{"t":"a","p":[1,3,3,1],"cn":"lc_id_0"},{"t":"f","p":[1,3,3,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,1,0]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":0},{"type":"dc","trans":true,"hc":true,"p":[1]}];;

LyteDragdropComponent._observedAttributes = [
    "ltPropAvailablelist",
    "ltPropSelectedlist",
    "ltPropMultiselect",
    "ltPropEnableSearch",
    ...
    "ltPropDraggable",
    "ltPropErrorMessage",
    "ltPropAvailablelistEmptyMessage",
    "ltPropSelectedlistEmptyMessage",
    "ltPropSearchStyle",
    "ltPropAvailableLabel",
    "ltPropSelectedLabel",
    "clickCount",
    "component",
    "placeholder",
			...
			if(returnVal){
				if(component.getData('ltPropMultiselect') && component.getData('multiSelectedItems').length > 1 ){
					...
					for(var i = 0 ; i < objects.length ; i++){
						arrayUtils(component.getData(parentListOfObjects),'removeAt',component.getElementPosition(component.getData(parentListOfObjects),objects[i]),1);
					}
					...
					if(prevEle){
						arrayUtils(component.getData(parentListOfPlaceholder),'insertAt',component.getElementPosition(component.getData(parentListOfPlaceholder),component.getElement(prevEle))+1,objects);
					}
					else{
						...
						if(nextEle){
							arrayUtils(component.getData(parentListOfPlaceholder),'insertAt',component.getElementPosition(component.getData(parentListOfPlaceholder),component.getElement(nextEle)),objects);
						}
						else{
							arrayUtils(component.getData(parentListOfPlaceholder),'push',objects);
						}
					}
					...
					if(prevEle){
						arrayUtils(component.getData(parentListOfDiv),'removeAt',component.getElementPosition(component.getData(parentListOfDiv),elemData),1);
						arrayUtils(component.getData(parentListOfPlaceholder),'insertAt',component.getElementPosition(component.getData(parentListOfPlaceholder),component.getElement(prevEle))+1,elemData);
					}
					else{
						var nextEle = placeholder.nextElementSibling;
						...
						if(nextEle){
							arrayUtils(component.getData(parentListOfDiv),'removeAt',component.getElementPosition(component.getData(parentListOfDiv),elemData),1);
							arrayUtils(component.getData(parentListOfPlaceholder),'insertAt',component.getElementPosition(component.getData(parentListOfPlaceholder),component.getElement(nextEle)),elemData);
						}
						else{
							arrayUtils(component.getData(parentListOfDiv),'removeAt',component.getElementPosition(component.getData(parentListOfDiv),elemData),1);
							arrayUtils(component.getData(parentListOfPlaceholder),'push',elemData);
						}
					}
...
export { LyteDragdropComponent };

LyteDragdropComponent.register("lyte-dragdrop", {
    hash: "LyteDragdropComponent_2",
