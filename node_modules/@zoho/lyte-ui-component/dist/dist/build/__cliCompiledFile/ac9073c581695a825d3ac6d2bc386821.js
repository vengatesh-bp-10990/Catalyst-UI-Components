...
class LyteBreadcrumbComponent extends includeMixins([LyteAdvancedBreadcrumbMixin], Component) {
    constructor() {
        super();
        this._lyteUtilFunctions = [ "modifyCrumbItems" ];
    }
    ...
    data(arg1) {
        ...
        return Object.assign(super.data({
			...
			*/
			...
			advContent : prop( 'object', { default : {} } ),
			advMiddleButtonShow : prop( 'boolean', { default : false } ),
			advYieldData : prop( 'boolean', { default : true } ) //to pass as arg via yield
		}), arg1);
	}
...
LyteBreadcrumbComponent.register("lyte-breadcrumb", {
    hash: "LyteBreadcrumbComponent_2",
