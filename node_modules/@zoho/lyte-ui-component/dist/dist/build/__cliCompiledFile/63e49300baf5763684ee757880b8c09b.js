...
class LyteFollowerComponent extends Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
			...
			ltPropOffset: prop('object', { // will not work with renderAtCenter
				default : {}
			}),
			ltPropYield: prop('boolean', {
				default: true
			}),
			ltPropContent: prop('string', {
				default: "This is Follower Content"
			}),
			ltPropOrientation: prop('string', {
				default: ""
			}),
			ltPropPosition: prop('object', {
				default: {}
			}),
			ltPropMouseEvent: prop('object', {
				default: {}
			}),
			ltPropZindex: prop('number', {
				default: undefined
			}), 
			ltPropOriginElement: prop('object', {
				default: {}
			}),
			ltPropRenderAtCenter: prop('boolean', {
				default : false
			}),
			ltPropHorizontalCenter: prop('boolean', {
				default : false
			}),
			ltPropVerticalCenter: prop('boolean', {
				default : false
			}),
			ltPropContainer: prop('object', {
				default: {}
			}),
			ltPropWrapperClass : prop('string',{
				default : ''
			}),
			ltPropWrapperParent: prop('string'),

			topStart: prop('number', {
				default: 0
			}),
			topEnd: prop('number', {
				default: window.innerHeight
			}),
			leftStart: prop('number', {
				default: 0
			}),
			leftEnd: prop('number', {
				default: window.innerWidth
			}),
			marginFromCursor: prop('number', {
				default: 10
			}),
			offsetTop: prop('number', {
				default: 0
			}),
			offsetLeft: prop('number', {
				default: 0
			}),
			horizontalPosition: prop('number', {
				default: undefined
			}),
			verticalPosition: prop('number', {
				default: undefined
			}),
			marginFromElement: prop('number', {
				default: 5
			}),

			originElement: prop('object'),
			container: prop('object'),
			leftBoundary: prop('number', {
				default: 0
			}),
			topBoundary: prop('number', {
				default: 0
			}),
			rightBoundary: prop('number', {
				default: 0
			}),
			bottomBoundary: prop('number', {
				default: 0
			}),
			followerBcr: prop('object'),
			originElemBcr: prop('object'),
			orientationCheck: prop('boolean', {
				default: false
			}),
			offsetParentElem: prop('object'),
			offsetParentDimensions: prop('object')

		}), arg1);		
	}

    calcInitialPosition(orient) {
    ...
    changeYPosition(_this, event, originElemCheck) {
    ...
    changeXPosition(_this, event, originElemCheck) {
		let followerBcr = _this.getData("followerBcr"),
...
LyteFollowerComponent._template = "<template tag-name=\"lyte-follower\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropBindToBody}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-wormhole lt-prop-query=\"{{ltPropWrapperParent}}\" on-before-append=\"{{method(&quot;beforeWormholeAppend&quot;)}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <div class=\"lyteFollowerWrapper {{ltPropWrapperClass}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"follower\" class=\"lyteFollowerYield\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteFollowerContent\"> {{ltPropContent}} </div> </template></template></div> </template> </lyte-wormhole> </template></template></template>";;
LyteFollowerComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"tX","p":[1,1],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteFollowerComponent._observedAttributes = [
    "ltPropShow",
    "ltPropBindToBody",
    "ltPropOffset",
    "ltPropYield",
    ...
    "ltPropZindex",
    "ltPropOriginElement",
    "ltPropRenderAtCenter",
    "ltPropHorizontalCenter",
    "ltPropVerticalCenter",
    "ltPropContainer",
    "ltPropWrapperClass",
    "ltPropWrapperParent",
    "topStart",
...
export { LyteFollowerComponent };
LyteFollowerComponent.register("lyte-follower", {
    hash: "LyteFollowerComponent_2",
