...
class LyteAnnotatorComponent extends includeMixins([LyteSmartguideUtilsMixin], Component) {
    constructor() {
        super();
    }
		...
		if (__type != "image") {
			...
			for (var i = 0; i < __len; i++) {
				...
				if( __cur.name == "concealing_tools" ){
					arrayUtils( side_panel_data, 'removeAt', i-- );
					__len--;
				}
			}
		} else {
    ...
    data(arg1) {
		...
		return Object.assign(super.data({
			...
			ltPropMarkerData : prop( object, { default : {
				type : "marker",
				tag : "defs",
				children : [
					{
			...
			ltPropResizeHandlers : prop( object, { default : {
				N : {
					width : 15,
					height : 15
				},
			...
			ltPropEditorPanelData : prop( object, { default : {
					fill : {
						value : "Fill color",
						selected : "",
			...
			ltPropZoomOptions : prop( object, { default : {
				10 : "10%",
				25 : "25%",
				50 : "50%",
				75 : "75%",
			...
			ltPropEditorPanelMapping : prop( object, { default : {
				rectangle : {
					fill : true,
					stroke : true,
					border : true,
			...
			ltPropContextMenuOptions : prop( object, { default : {			
				cut : {
					value : "Cut",
					show : ""
				},
    ...
    static actions(arg1) {
        return Object.assign(super.actions({
            ...
            mousedown : function( evt ){
                ...
                if( selectedItem ){
                    selectedItem.open && objectUtils( selectedItem, 'add', 'open', '' );
                }
...
LyteAnnotatorComponent._template = "<template tag-name=\"lyte-annotator\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{render}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-wormhole class=\"lyteAnnotatorWormhole\" on-before-append=\"{{method('beforeappend')}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <div class=\"lyteAnnotatorOuterWrapper {{ltPropWrapperClass}} {{loading}}\"> <lyte-annotator-wrapper> <lyte-annotator-header> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropHeaderYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"annotator-header\"></lyte-yield> </template><template default=\"\"><template items=\"{{ltPropButtons}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <lyte-button lt-prop=\"{{stringify(item.properties)}}\" class=\"lyteAnnotatorButton lyteAnnotator{{item.purpose}}\" onclick=\"{{action('buttonclick',item.purpose)}}\"> <template is=\"registerYield\" yield-name=\"text\"> {{item.text}} </template> </lyte-button> </template> </template></template></lyte-annotator-header> <lyte-annotator-content onmousedown=\"{{action('mousedown',event)}}\" ontouchstart=\"{{action('mousedown',event)}}\" tabindex=\"0\" onkeydown=\"{{action('keydown',event,this)}}\"> <lyte-annotator-whiteboard-content> <lyte-whiteboard-area> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{isImage}}\" is=\"case\" lc-id=\"lc_id_0\"> <canvas ref_x=\"0\" ref_y=\"0\" class=\"lyteAnnotatorCanvas\"></canvas> </template></template><svg xmlns=\"http://www.w3.org/2000/svg\" class=\"lyteAnnotatorSvg\" viewBox=\"{{viewBox}}\"> </svg> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderCrop}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-crop-wrapper> <lyte-crop-left></lyte-crop-left> <lyte-crop-top></lyte-crop-top> <lyte-crop-bottom></lyte-crop-bottom> <lyte-crop-right></lyte-crop-right> <lyte-crop-content></lyte-crop-content> </lyte-crop-wrapper> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{loading}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-loading class=\"{{loading}}\"></lyte-annotator-loading> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropSmartGuide}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteAnnotatorSmartGuides lyteConnectHorizontal lyteAnnotatorHidden\"></div> <div class=\"lyteAnnotatorSmartGuides lyteConnectVertical lyteAnnotatorHidden\"></div> </template></template></lyte-whiteboard-area> </lyte-annotator-whiteboard-content> </lyte-annotator-content> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropZoom,'&amp;&amp;',isImage)}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-footer> <div class=\"lyteAnnotatorZoom\"> <div class=\"lyteAnnotatorZoomPrev {{disablePrev}}\" onclick=\"{{action('prevZoom')}}\">-</div> <lyte-dropdown lt-prop-display-value=\"{{lbind(displayValue)}}\" lt-prop-selected=\"{{lbind(ltPropZoomLevel)}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteAnnotatorZoomDropdown\"> <lyte-drop-body> <template object=\"{{ltPropZoomOptions}}\" value=\"value\" key=\"key\" is=\"forIn\" _new=\"true\"> <lyte-drop-item data-value=\"{{key}}\" class=\"lyteAnnotatorZoom_{{key}}\">{{value}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <div class=\"lyteAnnotatorZoomNext {{disableNext}}\" onclick=\"{{action('nextZoom')}}\">+</div> </div> </lyte-annotator-footer> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropContextMenu,'&amp;&amp;',renderMenu)}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-menu lt-prop-show=\"{{lbind(menuShow)}}\" lt-prop-event=\"contextmenu\" lt-prop-query=\"lyte-annotator-wrapper\" lt-prop-yield=\"true\" lt-prop-wrapper-class=\"lyteAnnotatorMenu\" on-before-open=\"{{method('beforeMenu')}}\" on-menu-click=\"{{method('menuSelect')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-menu-body> <template object=\"{{ltPropContextMenuOptions}}\" value=\"value\" key=\"key\" is=\"forIn\" _new=\"true\"> <lyte-menu-item lt-prop-disabled=\"{{value.disabled}}\" class=\"lyteAnnotatorMenu_{{key}} {{value.show}}\" data-value=\"{{key}}\">{{value.value}}</lyte-menu-item> </template> </lyte-menu-body> </template> </lyte-menu> </template></template></lyte-annotator-wrapper> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropSidePanelData}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-sidepanel class=\"lyteAnnotatorSidePanel_{{ltPropPanelDirection}}\" tabindex=\"0\" onkeydown=\"{{action('side_nav',event)}}\"> <lyte-sidepanel-resize-handler ontouchstart=\"{{action('move',event)}}\" onmousedown=\"{{action('move',event)}}\">...</lyte-sidepanel-resize-handler> <template items=\"{{ltPropSidePanelData}}\" item=\"item\" index=\"index\" is=\"for\" _new=\"true\"> <div class=\"{{lyteAnnotator(item,item.active,item.direction)}}\" onclick=\"{{action('side_click',item)}}\"> <span class=\"lyteAnnotatorLabel\">{{item.value}}</span> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{item.children}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteAnnotatorChildWrapper {{item.open}}\"> <template items=\"{{item.children}}\" item=\"inner\" index=\"inn_index\" is=\"for\" _new=\"true\"> <div class=\"{{lyteAnnotator(inner,inner.active)}}\" onclick=\"{{action('side_click',inner,item)}}\"> <span class=\"lyteAnnotatorLabel\">{{inner.value}}</span> </div> </template> </div> </template></template></div> </template> </lyte-annotator-sidepanel> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropEditorPanel,'&amp;&amp;',renderFilter)}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-editorpanel class=\"{{showFilter}}\"> <lyte-editor-resize-handler ontouchstart=\"{{action('move',event)}}\" onmousedown=\"{{action('move',event)}}\">...</lyte-editor-resize-handler> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderFill}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"fill\" class=\"lyteAnnotatorFill {{showFill}}\" lt-prop-item=\"{{ltPropEditorPanelData.fill}}\" show=\"{{lbind(openFillPop)}}\" onclick=\"{{action('openPop','Fill')}}\" on-apply=\"{{method(&quot;applyFill&quot;)}}\"></lyte-annotator-item> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderStroke}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"stroke\" class=\"lyteAnnotatorStroke {{showStroke}}\" lt-prop-item=\"{{ltPropEditorPanelData.stroke}}\" show=\"{{lbind(openStrokePop)}}\" onclick=\"{{action('openPop','Stroke')}}\" on-apply=\"{{method(&quot;applyStroke&quot;)}}\"></lyte-annotator-item> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderBorder}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"border\" class=\"lyteAnnotatorBorder {{showBorder}}\" lt-prop-item=\"{{ltPropEditorPanelData.border}}\" show=\"{{lbind(openBorderPop)}}\" onclick=\"{{action('openPop','Border')}}\" on-apply=\"{{method(&quot;applyBorder&quot;)}}\"></lyte-annotator-item> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderFont}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"font\" class=\"lyteAnnotatorFont {{showFont}}\" lt-prop-item=\"{{ltPropEditorPanelData.font}}\" show=\"{{lbind(openFontPop)}}\" onclick=\"{{action('openPop','Font')}}\" on-apply=\"{{method(&quot;applyFont&quot;)}}\"></lyte-annotator-item> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderColor}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"color\" class=\"lyteAnnotatorColor {{showColor}}\" lt-prop-item=\"{{ltPropEditorPanelData.color}}\" show=\"{{lbind(openColorPop)}}\" onclick=\"{{action('openPop','Color')}}\" on-apply=\"{{method(&quot;applyColor&quot;)}}\"></lyte-annotator-item> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderOutline}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"outline\" class=\"lyteAnnotatorOutlet {{showOutline}}\" lt-prop-item=\"{{ltPropEditorPanelData.outline}}\" onclick=\"{{action('toggleOutline',this)}}\"></lyte-annotator-item> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderDashed}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-annotator-item pk=\"true\" type=\"dashed\" class=\"lyteAnnotatorDashed {{showDashed}}\" lt-prop-item=\"{{ltPropEditorPanelData.dashed}}\" show=\"{{lbind(openDashedPop)}}\" onclick=\"{{action('openPop','Dashed')}}\" on-apply=\"{{method(&quot;applyDashed&quot;)}}\"></lyte-annotator-item> </template></template></lyte-annotator-editorpanel> </template></template></div> </template> </lyte-wormhole> </template></template></template>";;
LyteAnnotatorComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"s","p":[1,1,1,1],"c":{"lc_id_0":{"dN":[{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[0],"cn":"default"},{"t":"f","p":[0],"dN":[{"t":"a","p":[1]},{"t":"r","p":[1,1],"dN":[{"t":"tX","p":[1]}],"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0,"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":13,"sibl":[12]},{"t":"cD","p":[1,1,1],"in":12,"sibl":[11]},{"t":"a","p":[1,1,3]},{"t":"s","p":[1,1,3,1,1,1],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":11,"sibl":[10]},{"t":"a","p":[1,1,3,1,1,2]},{"t":"s","p":[1,1,3,1,1,4],"c":{"lc_id_0":{"dN":[{"t":"cD","p":[1,1],"in":5,"sibl":[4],"cn":"lc_id_0"},{"t":"cD","p":[1,3],"in":4,"sibl":[3],"cn":"lc_id_0"},{"t":"cD","p":[1,5],"in":3,"sibl":[2],"cn":"lc_id_0"},{"t":"cD","p":[1,7],"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"cD","p":[1,9],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[5,4,3,2,1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":10,"sibl":[9]},{"t":"s","p":[1,1,3,1,1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":9,"sibl":[8]},{"t":"s","p":[1,1,3,1,1,6],"c":{"lc_id_0":{"dN":[],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":8,"sibl":[7]},{"t":"cD","p":[1,1,3,1,1],"in":7,"sibl":[6]},{"t":"cD","p":[1,1,3,1],"in":6,"sibl":[5]},{"t":"cD","p":[1,1,3],"in":5,"sibl":[4]},{"t":"s","p":[1,1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1,1],"cn":"lc_id_0"},{"t":"a","p":[1,1,3],"cn":"lc_id_0"},{"t":"r","p":[1,1,3,1],"dN":[{"t":"a","p":[1,1,1]},{"t":"fI","p":[1,1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":2,"sibl":[1]},{"t":"cD","p":[1,1],"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0}],"dc":[2,1,0],"hc":true,"trans":true,"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"cD","p":[1,1,3],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"a","p":[1,1,5],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[2,1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":4,"sibl":[3]},{"t":"s","p":[1,1,6],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"r","p":[1,1],"dN":[{"t":"a","p":[1,1]},{"t":"fI","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0}],"dc":[1,0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":3,"sibl":[2]},{"t":"cD","p":[1,1],"in":2,"sibl":[1]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"cD","p":[1,1],"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"a","p":[1,3],"cn":"lc_id_0"},{"t":"f","p":[1,3],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,1,0]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,1,0]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"]}],"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[2,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[1,4],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"cD","p":[1,1],"in":8,"sibl":[7],"cn":"lc_id_0"},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":7,"sibl":[6],"cn":"lc_id_0"},{"t":"s","p":[1,4],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":6,"sibl":[5],"cn":"lc_id_0"},{"t":"s","p":[1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":5,"sibl":[4],"cn":"lc_id_0"},{"t":"s","p":[1,6],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":4,"sibl":[3],"cn":"lc_id_0"},{"t":"s","p":[1,7],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":3,"sibl":[2],"cn":"lc_id_0"},{"t":"s","p":[1,8],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":2,"sibl":[1],"cn":"lc_id_0"},{"t":"s","p":[1,9],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[8,7,6,5,4,3,2,1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0}],"dc":[13,12,10,9,7,6,5,4,3,2,1,0],"hc":true,"trans":true,"in":1,"sibl":[0],"cn":"lc_id_0"},{"t":"cD","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[1,0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteAnnotatorComponent._observedAttributes = [
    "ltPropShow",
    "ltPropSrc",
    "ltPropType",
    "ltPropWrapperClass",
    ...
    "ltPropMarkerData",
    "ltPropSidePanelData",
    "ltPropPanelDirection",
    "ltPropUndo",
    "ltPropQueueUpdateTime",
    "ltPropUndoLimit",
    "ltPropResetQueue",
    "ltPropDrawType",
    "ltPropName",
    "ltPropShapeProperties",
    "ltPropFakeShapeProperties",
    "ltPropResizeHandlers",
    "ltPropEditorPanel",
    "ltPropEditorPanelData",
    "ltPropPopover",
    "ltPropZoom",
    "ltPropZoomOptions",
    "ltPropZoomLevel",
    "ltPropEditorPanelMapping",
    "ltPropSmartGuide",
    "ltPropSmartGuideSupport",
    "ltPropSmartBuffer",
    "ltPropContextMenu",
    "ltPropContextMenuOptions",
    "disableNext",
    "disablePrev",
    "displayValue",
    "isImage",
...
LyteAnnotatorComponent.register("lyte-annotator", {
    hash: "LyteAnnotatorComponent_2",
