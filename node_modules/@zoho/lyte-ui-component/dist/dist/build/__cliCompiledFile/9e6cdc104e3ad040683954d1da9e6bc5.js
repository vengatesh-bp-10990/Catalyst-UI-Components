...
LyteNumberFilterComponent._template = "<template tag-name=\"lyte-number-filter\"> <lyte-dropdown lt-prop-selected=\"{{lbind(selected)}}\" lt-prop-placeholder=\"{{ltPropPlaceholder}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteNumberFilterDropdown\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{isSearch}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-search lt-prop-query-selector=\"{ &quot;scope&quot; : &quot;.lyteNumberFilterDropdown:not(.lyteDropdownHidden)&quot;, &quot;search&quot; : &quot;lyte-drop-item&quot; }\" on-search=\"{{method('search')}}\"></lyte-search> </template></template><lyte-drop-body> <template object=\"{{ltPropOptions}}\" value=\"value\" key=\"key\" is=\"forIn\" _new=\"true\"> <lyte-drop-item data-value=\"{{key}}\">{{value}}</lyte-drop-item> </template> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{isSearch}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"{{if(noResult,'lyteNumberFilterNoResult','lyteNumberFilterNoResult lyteSearchHidden')}}\">{{ltPropNoMatch}}</div> </template></template></lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <div class=\"lyteNumberFilterWrapper\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderFirst}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-number class=\"lyteNumberFilterFirst\" lt-prop=\"{{stringify(ltPropFilterElementProperties.number)}}\" lt-prop-input-wrapper-class=\"{{hideFirst}}\" lt-prop-value=\"{{lbind(first)}}\" lt-prop-min=\"{{ltPropMin}}\" lt-prop-max=\"{{ltPropMax}}\"></lyte-number> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{renderSecond}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-number class=\"lyteNumberFilterSecond\" lt-prop=\"{{stringify(ltPropFilterElementProperties.number)}}\" lt-prop-input-wrapper-class=\"{{hideSecond}}\" lt-prop-value=\"{{lbind(second)}}\"></lyte-number> </template></template></div> </template>";;
...
LyteNumberFilterComponent._observedAttributes = [
    "ltPropCondition",
    "ltPropPlaceholder",
    "ltPropOptions",
    "ltPropNoMatch",
...
LyteNumberFilterComponent.register("lyte-number-filter", {
    hash: "LyteNumberFilterComponent_2",
