import { isEntity, extendEventListeners, /*getConfig,@3055*/ defProps, /*,type, prop, addToInstance*/_lyteInit,_lyteDidConnect, addLink, refreshParentRoute} from "./lyte-utils.js";
...
class Lyte {
  ...
  constructor(config) {
    ...
    this.addLink = function(outlet, style, options, observerFlag) {
      if(self.__instantiated){
        addLink(this,outlet,style,options,observerFlag);
      }
      else{
        self.addEventListener("ready", function(){
          addLink(self,outlet,style,options,observerFlag);
        });
      }
    }
