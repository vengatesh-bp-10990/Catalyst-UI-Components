...
window.stepResize = function(evt) {
...
class LyteStepComponent extends Component {
    constructor() {
        super();
        this._lyteUtilFunctions = [ 'next', 'previous', 'goto', "refreshStep" ];
    }
    ...
    data(arg1) {
        ...
        return Object.assign(super.data({
             ...
             * @version 1.0.0
             */
            ltPropClass: prop("string", { "default": default_values.class || 'lyteStepSlash' }),
            /**
             ...
             * @version 1.0.0
             */
            ltPropSelected: prop("number", { "default": default_values.selected || 0 }),
            /**
             * @componentProperty {boolean} ltPropSkip=true
             * @version 1.0.0
             */
            ltPropSkip: prop("boolean", { "default": default_values.skip == false ? false : true }),
            /**
             ...
             * @version 1.0.0
             */
            ltPropWarningClass: prop("string", { "default": default_values.warningClass || 'lyteWarning' }),
            /**
             * @componentProperty {boolean} ltPropKeepMarked=false
             * @version 1.0.0
             */
            ltPropKeepMarked: prop("boolean", { "default": default_values.keepMarked || false }),
            /**
             ...
             * @version 2.2.6
             */
            ltPropType: prop('string', { default: default_values.type }),
            /**
             * @componentProperty {number} ltPropOffset=0
             * @version 2.2.6
             */
            ltPropOffset: prop('number', { default: default_values.offset || 0 }),
            /**
             * @componentProperty {number} ltPropIndex=0
             * @version 2.2.6
             */
            ltPropIndex: prop('number', { default: default_values.index || 0 }),
            /**
             * @experimental ltPropDataType
             */
            ltPropDataType: prop('array', { default: [] }),
             ...
             * @version 3.1.0
             */
            ltPropAriaValue: prop('string', { default: default_values.ariaValue || 'step' }),

            // system data

            dummyContent: prop('array', { default: [] }),
            widthArr: prop('array', { default: [] }),
            divWidth: prop('number', { default: 0 }),
            forwardWidth: prop('number', { default: 0 }),
            backwardWidth: prop('number', { default: 0 })
        }), arg1);
    }
    ...
    forwardAdd(min, width, divWidth, consWid, newArr, data) {
    ...
    backwardAdd(min, width, divWidth, consWid, newArr, data) {
    ...
    constructBackward(forward, backward) {
    ...
    constructForward(forward, backward) {
        forward = forward || $L('lyte-step-forward').get(0);
        backward = backward || $L('lyte-step-backward').get(0);
        ...
        if (this.getData('ltPropType') == "advanced") {
            ...
            $L.fastdom.measure(function () {
                ...
                if (forward) {
                    ...
                    var compsty = window.getComputedStyle(forward);
                ...
                if (backward) {
                    ...
                    var compsty = window.getComputedStyle(backward);
    ...
    moveTo(number, state, selected, addClass) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            this.$addon.arrayUtils(array, arrOp, i, state2Push);
            if (i >= index) {
                if (array[i] == 'active') {
...
window.addEventListener('resize', window.stepResize, true);
window.addEventListener('orientationchange', window.stepResize, true);
 ...
 *  </lyte-step>
 */
export { LyteStepComponent };

LyteStepComponent.register("lyte-step", {
    hash: "LyteStepComponent_2",
