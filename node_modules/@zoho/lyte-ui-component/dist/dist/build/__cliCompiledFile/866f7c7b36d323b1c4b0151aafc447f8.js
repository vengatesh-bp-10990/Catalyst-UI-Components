...
class LyteSliderComponent extends Component {
    constructor() {
        super();
    }
    ...
    selectedVal(clientRect, nodeClientRect, ltPropHeight, node, left) {
    ...
    minMaxCheck(slideClientRect, handler1Client, width1, flag) {
    ...
    selectedValFind(clientRect, nodeClientRect) {
            this.setData('preventObs', true)
            if(!this.getData('ltPropRangeHandler'))
                {
                    if(this.getData('ltPropDirection').indexOf('Horizontal')==-1)
    ...
    initialValueSet(width, handlerWidth, value) {
    ...
    rangeSliderFill(left1, left2, handlerWidth) {
        return {width : left2 - left1, left : left1 + handlerWidth / 2 }
    }

    keyCheck(event, node, width1, left1, offsetWidth, ltPropWidth) {
    ...
    rangeInitialSet(offsetWidth, index) {
    ...
    data(arg1) {
        ...
        var default_values = window._lyteUiUtils.getDefault( 'lyte-slider' );
        ...
        return Object.assign(super.data({
             ...
             * @version 1.0.0
             */
            ltPropMin:prop("string",{"default": default_values.min || '0'}),
            /**
             ...
             * @version 1.0.0
             */
            ltPropMax:prop("string",{"default": default_values.max || ''}),
            /**
             ...
             * @version 1.0.0
             */
            ltPropScaleInterval:prop("string",{"default": default_values.scaleInterval || ''}),
            /**
             * @componentProperty {string} ltPropStep=''
             * @version 1.0.0
             */
            ltPropStep:prop("string",{"default": default_values.step || ''}),
            /**
             ...
             * @version 1.0.0
             */
            ltPropValue:prop("string",{"default": default_values.value || ''}),
            /**
             * @componentProperty {string} ltPropDiscrete=''
             * @condition ltPropContent []
             * @version 1.0.0
             */
            ltPropDiscrete:prop("string",{"default": default_values.discrete || ''}),
            /**
             ...
             * @version 1.0.0
             */
            ltPropRangeHandler:prop("boolean",{"default": default_values.rangeHandler || false}),
            /**
             * @componentProperty {string} ltPropMinValue=''
             * @version 1.0.0
             */
            ltPropMinValue:prop("string",{"default": default_values.minValue || ''}),
            /**
             * @componentProperty {string} ltPropMaxValue=''
             * @version 1.0.0
             */
            ltPropMaxValue:prop("string",{"default": default_values.maxValue || ''}),
            /**
             ...
             * @version 1.0.0
             */
            ltPropSelectedValue1 : prop('string', {default : ''}),
            /**
             * @componentProperty {string} ltPropSelectedValue2=''
             * @condition ltPropRangeHandler true
             * @version 1.0.0
             */
            ltPropSelectedValue2 : prop('string', {default : ''}),
            /**
             ...
             * @version 1.0.2
             */
            ltPropTooltip : prop( 'boolean', { default : default_values.tooltip == false ? false : true}),
            /**
             * @componentProperty {string} ltPropScaleUnit=''
             * @condition ltPropYield false
             * @version 1.0.2
             */
            ltPropScaleUnit : prop( 'string' , { default : default_values.scaleUnit || '' } ),
            /**
             * @componentProperty {string} ltPropTooltipClass=''
             * @condition ltPropTooltip true
             * @version 1.0.2
             */
            ltPropTooltipClass : prop('string', { default : default_values.tooltipClass || ''}),
             ...
             * @version 1.0.8
             */
            ltPropDigits : prop( 'number', { default : default_values.digits == void 0 ? 2 : default_values.digits } ),
            /**
             * @componentProperty {boolean} ltPropAria
             * @default false
             * @version 3.109.0
             */
            ltPropAria : prop( 'boolean', { default : default_values.aria } ),
            /**
             ...
             * @version 3.109.0
             */
            ltPropHandlerTabIndex : prop( 'number', { default : default_values.handlerTabIndex || 0 } ),
            /**
             * @componentProperty {string} ltPropAriaLabel
             * @default ""
             * @version 3.109.0
             */
            ltPropAriaLabel : prop( 'string', { default : default_values.ariaLabel || '' } ),
             ...
             * @version 3.115.0
             */
            ltPropAriaValueText : prop( 'string', { default : default_values.ariaValueText || '' } ),
             ...
             * @version 3.115.0
             */
            ltPropAriaRangeValueText : prop( 'string', { default : default_values.ariaRangeValueText || '' } ),

            /**
             * @componentProperty {number} ltPropMinDiscrete=0.1
             * @version 3.107.0
             */
            ltPropMinDiscrete : prop( "number", { default : default_values.minDiscrete == void 0 ? 0.1 : default_values.minDiscrete } ),

            ltPropScaleTabindex : prop( 'number', { default : default_values.scaleTabindex || -1 } ),      

            ltPropHandlerId : prop( 'array', { default : default_values.handlerId || [] } ),

            //system data
            preventObs : prop('boolean', { default : false}),
...
LyteSliderComponent._template = "<template tag-name=\"lyte-slider\"> <div class=\"lyteSlide {{if(ltPropDisabled,'lyteSliderDisabled','')}}\"> <div class=\"lyteRangeSlider {{ltPropDirection}}\" onclick=\"{{action('click',event)}}\" tabindex=\"{{ltPropTabIndex}}\" onkeydown=\"{{action('keydown',event)}}\"> <div class=\"lyteSliderFill\"></div> <div id=\"{{ltPropHandlerId[0]}}\" class=\"lyteSliderHandler {{ltPropHandler}} lyteHandler1\" lt-prop-title=\"{{if(expHandlers(ltPropTooltip,'&amp;&amp;',true),if(ltPropRangeHandler,ltPropMinValue,ltPropValue),'')}}\" tabindex=\"{{ltPropHandlerTabIndex}}\" onmousedown=\"{{action('mousedown',event,this)}}\" ontouchstart=\"{{action('mousedown',event,this)}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-tooltip-style=\"{{ltPropTooltipStyle}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\" style=\"border-color: {{ltPropFillColor}}\" role=\"{{lyteUiAttribute('slider',ltPropAria)}}\" aria-valuemin=\"{{lyteUiAttribute(ltPropMin,ltPropAria)}}\" aria-valuemax=\"{{lyteUiAttribute(ltPropMax,ltPropAria,ltPropSelectedValue2)}}\" aria-valuenow=\"{{lyteUiAttribute(ltPropSelectedValue1,ltPropAria)}}\" aria-valuetext=\"{{lyteUiAttribute(ltPropSelectedValue1,ltPropAria,ltPropAriaValueText)}}\" aria-label=\"{{lyteUiAttribute(ltPropSelectedValue1,ltPropAria,ltPropAriaLabel)}}\" aria-orientation=\"{{lyteUiAttribute(orientation,ltPropAria)}}\"></div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropRangeHandler}}\" is=\"case\" lc-id=\"lc_id_0\"> <div id=\"{{ltPropHandlerId[1]}}\" class=\"lyteSliderHandler {{ltPropHandler}} lyteHandler2\" tabindex=\"0\" onmousedown=\"{{action('mousedown',event,this)}}\" ontouchstart=\"{{action('mousedown',event,this)}}\" lt-prop-title=\"{{if(ltPropTooltip,ltPropMaxValue,'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-tooltip-style=\"{{ltPropTooltipStyle}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\" style=\"border-color: {{ltPropFillColor}}\" role=\"{{lyteUiAttribute('slider',ltPropAria)}}\" aria-valuemin=\"{{lyteUiAttribute(ltPropSelectedValue1,ltPropAria)}}\" aria-valuemax=\"{{lyteUiAttribute(ltPropMax,ltPropAria)}}\" aria-valuenow=\"{{lyteUiAttribute(ltPropSelectedValue2,ltPropAria)}}\" aria-valuetext=\"{{lyteUiAttribute(ltPropSelectedValue2,ltPropAria,ltPropAriaRangeValueText)}}\" aria-label=\"{{lyteUiAttribute(ltPropSelectedValue2,ltPropAria,ltPropAriaLabel)}}\" aria-orientation=\"{{lyteUiAttribute(orientation,ltPropAria)}}\"></div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"yield\" lt-prop-scale-value=\"{{scaleVal}}\" lt-prop-scale-style=\"{{divLength}}\"></lyte-yield> </template><template default=\"\"> <div class=\"lyteScaleOption {{ltPropHandler}}\"> <template is=\"for\" items=\"{{divLength}}\" index=\"indexVal\"> <span class=\"lyteScaleLine\" style=\"{{item}}\"> <span></span> <span class=\"lyteScalLable\" tabindex=\"{{ltPropScaleTabindex}}\" role=\"{{lyteUiAttribute('button',ltPropAria)}}\">{{scaleVal[indexVal]}}</span> </span> </template> </div> </template></template></div> </div> </template>";;
LyteSliderComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"a","p":[1,1,3],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'border-color: '","ltPropFillColor"]}}}},{"t":"s","p":[1,1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'border-color: '","ltPropFillColor"]}}},"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":1,"sibl":[0]},{"t":"s","p":[1,1,6],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"i","p":[1],"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"a","p":[1,1],"cn":"default"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1],"a":{"style":{"name":"style","dynamicValue":"item"}}},{"t":"a","p":[1,3]},{"t":"tX","p":[1,3,0]}],"cn":"default"}]},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true},"default":{}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteSliderComponent._observedAttributes = [
    "divLength",
    "scaleVal",
    "ltPropMin",
    "ltPropMax",
    ...
    "ltPropMaxValue",
    "ltPropDisabled",
    "ltPropSelectedValue1",
    "ltPropSelectedValue2",
    "ltPropYield",
    "ltPropTooltipStyle",
    "ltPropTooltip",
    "ltPropScaleUnit",
    ...
    "ltPropAria",
    "ltPropTabIndex",
    "ltPropHandlerTabIndex",
    "ltPropAriaLabel",
    "ltPropAriaValueText",
    "ltPropAriaRangeValueText",
    "ltPropMinDiscrete",
    "ltPropScaleTabindex",
    "ltPropHandlerId",
    "preventObs",
...
export { LyteSliderComponent };

LyteSliderComponent.register("lyte-slider", {
    hash: "LyteSliderComponent_2",
