...
class LyteGridstackComponent extends Component {
    constructor() {
        super();
        this._lyteUtilFunctions = [ "addGrid", "removeGrid", "setProperty", "reRender", "placeholder", "getGridPositions", "getEmptyPos", "updateValue", "topMove" ];
    }
    ...
    didDestroy() {
        ...
        __document[ rel + ( window._lyteUiUtils.isWidget ? "Global" : "" ) ]( 'keydown', data.lyteQuerySelector.keydown );
        __window[ rel ]( 'resize', _this._resizeFunc, true );
        __window[ rel ]( 'orientationchange', _this._resizeFunc, true );        
        __document[ rel + ( window._lyteUiUtils.isWidget ? "Global" : "" ) ]( 'click', _this._click );
    ...
    mouseup(evt) {   
            ...
            if( __selected.length ){
                ...
                for( i = __selected.length-1; i >= 0; i-- ){
                     ...
                     if( $node.hasClass( 'gridSelected' ) ) {
                        ...
                        arrayUtils( occupied, 'remove', 0, occupied.length );
       ...
       evt.type && document[ "removeEventListener" + ( window._lyteUiUtils.isWidget ? "Global" : "" ) ]( isTch ? 'touchend' : 'mouseup', this.upfunc, true )
    }
    ...
    mousebind(event) {
         if( event.target != this && event.button != 2 ) {  
             ...
             if(!event.shiftKey){
                 event.type && document[ "addEventListener" + ( window._lyteUiUtils.isWidget ? "Global" : "" ) ]( isTouch ? 'touchend' : 'mouseup', comp.upfunc, true );
             }
    ...
    set_aria_values(__elem, role, obj) {
        var __data = this.data,
    ...
    didConnectWrk(flag, flag2) {
        $L.fastdom.measure(function(){
            ...
            arrayUtils( iniData, 'remove', 0, iniData.length );
    ...
    data(arg1) {
        ...
        return Object.assign(super.data({
            ...
            */
            ...
            ltPropUpdateParentHeight : prop( 'boolean', { default : default_values.updateParentHeight == void 0 ? true : default_values.updateParentHeight } ),
...
LyteGridstackComponent._template = "<template tag-name=\"lyte-gridstack\"> <lyte-yield yield-name=\"lyteGridStack\"> </lyte-yield> </template>";;
LyteGridstackComponent._dynamicNodes = [{"t":"i","p":[1],"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;

LyteGridstackComponent._observedAttributes = [
    "ltPropScope",
    "ltPropHandler",
    "ltPropMarginLeft",
    "ltPropMarginTop",
    ...
    "ltPropDefaultLength",
    "ltPropDefaultHeight",
    "ltPropDefaultMinLength",
    "ltPropDefaultMinHeight",
    "ltPropDefaultMaxHeight",
    "ltPropDefaultMaxLength",
    "ltPropColumnMode",
    "ltPropColumn",
    "ltPropPrevent",
    "ltPropGridLength",
    "ltPropBestfitType",
    "ltPropForcedReposition",
    "ltPropSquareGrid",
    "ltPropGridSpaceColor",
    "ltPropHitBottom",
    "ltPropGridSelectionClass",
    "ltPropVisibleBoundary",
    "ltPropVisible",
    "ltPropCheckCurrentPosition",
    "ltPropContainment",
    "ltPropMaxGridHeight",
    "ltPropScrollElement",
    "ltPropIgnoreDrag",
    "ltPropMaintainOrder",
    "ltPropScrollValue",
    "ltPropUpdateParentHeight",
    "ltPropIgnoreEmptyBottomMove",
    "ltPropPreventScroll",
    "ltPropAria",
...
LyteGridstackComponent.register("lyte-gridstack", {
    hash: "LyteGridstackComponent_2",
