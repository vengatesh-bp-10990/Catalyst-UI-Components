...
class LyteVoicenoteComponent extends Component {
    ...
    data(arg1) {
		...
		return Object.assign(super.data({
			...
			ltPropAriaAttributes : prop( 'object', { default : default_values.ariaAttributes || {} } ),
			...
			ltPropDataTabindex : prop( 'number', { default : default_values.DataTabindex || 0 } ),

			/**
			 * @componentProperty {number} ltPropStep=5
			 * @version 3.103.0
			 */
			ltPropStep : prop( 'number', { default : default_values.step || 5 } ),
			...
			ltPropPrefetchAutoPlay : prop( 'boolean', { default : default_values.prefetchAutoPlay || false } ),

			previousVolume : prop( 'number' ),
			...
			durationValue : prop( "number", { default : 0 } ),
			datetimeFormat : prop( "string", { default : "" } ),
			elapsedTime : prop( "string", { default : "0.00" } ),
			elapsedTimeValue : prop( "string", { default : 0 } ),
			...
			commonTabindex : prop( 'number', { default : -1 } ),
			reRender : prop( 'boolean', { default : false } ),
			sliderData : prop( 'array' ) 
		}), arg1);		
	}
    ...
    static observers(arg1) {
        return Object.assign(super.observers({
            ...
            vol_obs : function( arg ){
                objectUtils( this.data.sliderData[ 0 ], 'add', 'value', arg.newValue );
...
LyteVoicenoteComponent._observedAttributes = [
    ...
    "ltPropPopover",
    "ltPropPlaybackRate",
    "ltPropPlaybackOptions",
    "ltPropPrefetch",
    "ltPropPrefetchOptions",
    "ltPropRefresh",
    "ltPropLoadingMessage",
    "ltPropDurationHandling",
    "ltPropAria",
...
LyteVoicenoteComponent.register("lyte-voicenote", {
    hash: "LyteVoicenoteComponent_2",
