...
:@{rootSelector} {
	--lyte-calendar-popup-bg: @themeBodyBackground;
	...
	--lyte-calendar-text-color: @commonTextColor2;
	--lyte-calendar-horizontal-cell-spacing: 8px;
	--lyte-calendar-selected-elem-bg: @themeActiveElementBg;
	...
	--lyte-calendar-zindex: @Level4zIndex;
