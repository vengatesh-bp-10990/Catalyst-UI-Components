...
@import "../themes/default/ui-elements/progressbar/progressbar.variables.less";
...
@import "../config.less";
@import (optional) "../themes/@{progressbar}/ui-elements/progressbar/progressbar.variables.less";
...
@import (multiple,optional) "../themes/@{progressbar}/global/@{direction}.less";

/* Loading final tweaks to your variables */
@import (optional) "../overrides/ui-elements/progressbar.variables.less";
...
@keyframes move {
	...
	100% {
	   background-position: .keyframesMove[@bg-pos];
    }
}
...
.lyteProgressBar.lyteCircle circle:first-child {
    .circleProgressBarCircle();
    stroke: @stroke;
}
.lyteCircle .ltProgressFillCircle {
	.lyteProgressFillCircleMixin();
	stroke: @stroke;
}
.lyteProgressCompleted.lyteCircle .ltProgressFillCircle {
	.lyteProgressFillCircleCompletedMixin();
	stroke: @stroke;
}
...
.lyteProgressBarWithLineSeparator .lyteProgressStatusStack:first-child {
	.lyteProgressBarWithLineSeparatorStackFirstChildMixin();
	border-radius: @border-radius;
}
.lyteProgressBarWithLineSeparator .lyteProgressStatusStack:last-child {
	.lyteProgressBarWithLineSeparatorStackLastChildMixin();
	border-radius: @border-radius;
}
.lyteProgressBarWithLineSeparator .lyteProgressStatusStack:only-child {
	.lyteProgressBarWithLineSeparatorStackOnlyChildMixin();
	border-radius: @border-radius;
}
.lyteProgressBarLineSeparator {
	.lyteProgressBarLineSeparatorMixin();
	width: @w;
	height: @h;
	padding: @padding;
	background: @bg;
...
.lyteProgressBar .lyteProgressStatusVertical {
	.lyteProgressBarStatusVerticalMixin();
	border-radius: @border-radius;
	background: @bg;
	width: @w;
	position: absolute;
...
.lyteProgressStatusVertical.up {
	.lyteProgressStatusVerticalUpMixin();
	bottom: @bottom;
}
.lyteProgressStatusVertical.down {
	.lyteProgressStatusVerticalDownMixin();
	top: @top;
}
.lyteProgressStatusVertical .lyteProgressPercentage {
	.lyteProgressStatusVerticalPercentageMixin();
	top: @top;
	transform: @transform;
}
...
@import (optional) "../themes/@{progressbar}/ui-elements/progressbar/progressbar.styles.less";




/* import custom css - final tweaks by the user */
@import (optional) "../overrides/ui-elements/progressbar.overrides.less";
