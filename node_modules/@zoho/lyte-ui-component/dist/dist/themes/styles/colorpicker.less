...
@import "../themes/default/ui-elements/colorpicker/colorpicker.variables.less";
...
@import "../config.less";
@import (optional) "../themes/@{colorpicker}/ui-elements/colorpicker/colorpicker.variables.less";
...
@import (multiple,optional) "../themes/@{colorpicker}/global/@{direction}.less";

/* Loading final tweaks to your variables */
@import (optional) "../overrides/ui-elements/colorpicker.variables.less";
...
.lyteColorPicker__showhidecontainer {
	.ColorPicker__showhidecontainer();
	overflow: hidden;
	padding: @padding;
	position: relative;
...
.lyteColorPicker__default {
    .ColorPicker__default();
    width: @w;
	display: flex;
	flex-direction: column;
}
.lyteColorPicker__nocolorbutton {
    .ColorPicker__nocolorbutton();
    padding: @padding;
...
.lyteColorPickerUsedColors {
	.lyteColorPickerUsedColorsMixin();
	margin: @margin;
	padding: @padding;
}
.lyteColorPicker__paletteheading {
	.ColorPicker__paletteheading();
	cursor: default;
    color: @color;
	margin-bottom: @margin-bottom;
}
.lyteColorPicker__defaultpaletteheading {
	.ColorPicker__defaultpaletteheading();
	cursor: default;
    color: @color;
	margin: @margin;
}
...
.lyteColorPicker__sliderDiv {
    .ColorPicker__sliderDiv();
    display: flex;
	align-items: center;
    margin: @margin;
}
.colorSlider_hue {
    .colorSlider_hue_mixin();
    margin-bottom: @margin-bottom;
}
...
.showValue .lyteInputBox.lyteInputFocus.lyteCp__Invalid .lyteField {
	.lyteCpInvalidInputFieldMixin();
	border: @border;
}
.lyteCp__Invalid input {
	.lyteCpInvalidInputMixin();
	background: @bg;
}
...
@import (optional) "../themes/@{colorpicker}/ui-elements/colorpicker/colorpicker.styles.less";




/* import custom css - final tweaks by the user */
@import (optional) "../overrides/ui-elements/colorpicker.overrides.less";
