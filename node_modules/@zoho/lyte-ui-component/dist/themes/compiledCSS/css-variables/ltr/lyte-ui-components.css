...
.lyteDateRPTempSelected:focus-visible {
  outline: 2px solid var(--lyte-daterangepicker-date-focus-outline-color);
  outline-offset: -2px;
}
...
.lyteSequentialFlow lyte-connect-item.lyteSequentialCustomType,
...
.lyteSequentialFlow .lyteConnectEmpty:before {
  ...
  position: absolute;
  transform: translate(-50%, -50%);
  -webkit-mask: var(--lyte-sprite-image) no-repeat -20px -59px;
  mask: var(--lyte-sprite-image) no-repeat -20px -59px;
  background-color: #000;
  background-image: none;
  width: 9px;
  height: 9px;
...
.lyteSequentialFlow lyte-textbox.lyteSequentialTextboxShow {
  border: 1px solid #275DE9;
  background-color: #275DE9;
}
.lyteSequentialFlow .lyteSequentialPlaceholderText::before,
.lyteSequentialFlow .lyteSequentialTextboxShow::before {
  background-color: #fff;
}
.lyteConnectionFakeContainer,
.lyteConnectionContainer {
...
.lyteSequentialCustomType lyte-sequential-icon lyte-yield {
  width: 25px;
  height: 25px;
  font-size: 0;
  display: flex;
...
.lyteSequentialCustomType lyte-sequential-icon lyte-yield::after {
  content: "";
  display: inline-block;
  -webkit-mask: var(--lyte-sprite-image) no-repeat -20px -59px;
  mask: var(--lyte-sprite-image) no-repeat -20px -59px;
...
.lyteSequentialLoopType > lyte-sequential-icon lyte-yield,
.lyteSequentialTryCatchType > lyte-sequential-icon lyte-yield,
.lyteSequentialBranchingType > lyte-sequential-icon lyte-yield {
  display: flex;
  flex-direction: column;
  align-items: center;
  max-width: 300px;
}
.lyteSequentialLoopType > lyte-sequential-icon lyte-yield .lyteSequentialflowIcon,
.lyteSequentialTryCatchType > lyte-sequential-icon lyte-yield .lyteSequentialflowIcon,
.lyteSequentialBranchingType > lyte-sequential-icon lyte-yield .lyteSequentialflowIcon {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 35px;
...
.lyteSequentialLoopType > lyte-sequential-icon lyte-yield .lyteSequentialflowIcon {
  ...
  border-radius: 4px;
  background: #F0E0FF;
  box-shadow: 0px 0px 0px 0px #275DE91A;
}
.lyteSequentialLoopType > lyte-sequential-icon lyte-yield:before,
.lyteSequentialLoopType > lyte-sequential-icon lyte-yield:after {
  content: '';
  position: absolute;
  width: inherit;
  height: inherit;
...
.lyteSequentialFlow .lyteConnectTextbox.lyteSequentialTextboxShow {
  visibility: unset;
}
.lyteSequentialflowIcon + span {
  position: relative;
  overflow: hidden;
  text-overflow: ellipsis;
  -webkit-line-clamp: 2;
...
.lyteSequentialFlow .lyteSequentialPosAbs {
  position: absolute;
}
.lyteSequentialFlow .lyteSequentialOpacityHide {
  opacity: 0;
}
.lyteSequentialFlow .lyteSequentialDragClone {
  transform: translateX(-50%);
}
.lyteSequentialFlow .lyteSequentialDroppableAnimate {
  transition: height 0.2s ease-out, padding-top 0.2s ease-out, padding-bottom 0.2s ease-out, margin-top 0.2s ease-out, margin-bottom 0.2s ease-out;
...
.lyteCirSliderHandler {
  display: inline-block;
  background-color: var(--lyte-circular-slider-handler-bg-color);
  border: 2px solid var(--lyte-circular-slider-handler-border-color);
  width: 14px;
  height: 14px;
  position: absolute;
  left: 100%;
...
.lyteCircularSliderDisabled .lyteCirSliderOuterCircle {
  stroke: var(--lyte-circular-slider-disabled-outer-circle-stroke-color);
}
.lyteCircularSliderDisabled .lyteCirSliderStrokeCircle {
  stroke: var(--lyte-circular-slider-disabled-inner-circle-stroke-color);
}
.lyteCircularSliderDisabled .lyteCirSliderHandler {
  border: 1px solid var(--lyte-circular-slider-disabled-handler-border-color);
  pointer-events: none;
  cursor: not-allowed;
}
...
.lyteCircularSliderDrag .lyteCirSliderHandler {
  box-shadow: 1px 1px 5px 0px var(--lyte-circular-slider-handler-box-shadow-color);
  outline: none;
}
.lyteCircularSliderDrag .lyteCirSliderHandler {
  cursor: grabbing;
...
.lyteCircularSliderValue {
  ...
  font-size: 16px;
  fill: var(--lyte-circular-slider-value-color);
  user-select: none;
}
