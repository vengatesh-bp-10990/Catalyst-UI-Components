:root {
  --lyte-daterangepicker-bg: #fff;
  --lyte-daterangepicker-inrange-bg: #e6f3fd;
  --lyte-daterangepicker-selelem-bg: #5ba1e5;
  --lyte-daterangepicker-inrange-text-color: #111;
  ...
  --lyte-daterangepicker-inrange-hover-text-color: #111;
