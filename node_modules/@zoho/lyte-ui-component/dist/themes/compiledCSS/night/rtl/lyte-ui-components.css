...
.lyteStatusIcon {
  background: url(../../images/sprite_lyte_night.svg);
  width: 28px;
  height: 28px;
  margin-left: 10px;
  display: block;
...
.lyteDateInputCalendarIcon {
  -webkit-mask: url(../../images/sprite_lyte_night.svg) no-repeat -224px -81px;
  mask: url(../../images/sprite_lyte_night.svg) no-repeat -224px -81px;
  width: 16px;
  height: 17px;
...
.lyteTableFixed {
  z-index: 8;
  box-shadow: -3px 0 7px -2px rgba(255, 255, 255, 0.1);
}
...
.lyteRatingSmiley.five lyte-rate-icon:nth-child(2) {
  background-position: -99px -275px;
}
...
.lrcSwitchLikeEmpty {
  background-position: -268px -232px;
}
...
.lyteExpTableFixedColHeader {
  z-index: 1;
  box-shadow: 3px 0 5px 0px rgba(255, 255, 255, 0.1);
  position: absolute;
  background: #333;
  border-left: 1px solid #6f6f6f;
}
...
.lyteTimePickerIncIcon {
  display: block;
  -webkit-mask: url(../../images/sprite_lyte_night.svg) no-repeat -14px -2px;
  mask: url(../../images/sprite_lyte_night.svg) no-repeat -14px -2px;
  background-color: #5B5D5F;
  width: 9px;
  height: 5px;
}
...
.lyteAvatarLoading {
  height: 200%;
  width: 200%;
  background: linear-gradient(to bottom left, #555 0%, #666 25%, #555 50%, #666 75%, #555 100%);
...
.lyteSequentialFlow .lyteConnectEmpty:before {
  ...
  position: absolute;
  transform: translate(-50%, -50%);
  -webkit-mask: url(../../images/sprite_lyte_night.svg) no-repeat -20px -59px;
  mask: url(../../images/sprite_lyte_night.svg) no-repeat -20px -59px;
  background-color: #000;
  background-image: none;
  width: 9px;
  height: 9px;
...
.lyteMIWrapper .lyteCloseIcon::after {
  content: "";
  -webkit-mask: url(../../images/sprite_lyte_night.svg) no-repeat -3px -15px;
  mask: url(../../images/sprite_lyte_night.svg) no-repeat -3px -15px;
  background-color: #fff;
  width: 6px;
  height: 6px;
  display: inline-block;
...
.lyteNotificationCloseIcon {
  -webkit-mask: url(../../images/sprite_lyte_night.svg) no-repeat -323px -161px;
  mask: url(../../images/sprite_lyte_night.svg) no-repeat -323px -161px;
  background-color: #666;
  width: 12px;
  height: 12px;
  cursor: pointer;
