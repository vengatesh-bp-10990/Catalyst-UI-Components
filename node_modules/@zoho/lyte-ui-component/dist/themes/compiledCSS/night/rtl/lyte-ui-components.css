...
.lyteStatusIcon {
  background: url(../../../compiledCSS/images/sprite_lyte_night.svg);
  width: 28px;
  height: 28px;
  margin-left: 10px;
  display: block;
...
.lyteImagePlayerPlayIcon::after {
  content: "";
  -webkit-mask-image: url(../../../compiledCSS/images/sprite_lyte_video.svg);
  -webkit-mask-position: -210px -5px;
  mask-image: url(../../../compiledCSS/images/sprite_lyte_video.svg);
...
.lyteDateInputCalendarIcon {
  -webkit-mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -224px -81px;
  mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -224px -81px;
  width: 16px;
  height: 17px;
...
#lyteCPImgDiv {
  height: 160px;
  background-image: url(../../../../compiledCSS/images/lyteCPbgGradient.png);
...
.lyteColorPicker__transparentbg {
  border-radius: 6px;
  background: url(../../../../compiledCSS/images/lyteCP_op_slider_bg.png);
}
...
.lyteTimePickerIncIcon {
  display: block;
  -webkit-mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -14px -2px;
  mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -14px -2px;
  background-color: #5B5D5F;
  width: 9px;
  height: 5px;
}
...
.lyteVideoIcons {
  ...
  display: block;
  cursor: pointer;
  background-image: url(../../../compiledCSS/images/sprite_lyte_video.svg);
}
.lyteVideoPlayIcon {
...
.lyteSequentialFlow .lyteConnectEmpty:before {
  ...
  position: absolute;
  transform: translate(-50%, -50%);
  -webkit-mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -20px -59px;
  mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -20px -59px;
  background-color: #000;
  background-image: none;
  width: 9px;
  height: 9px;
...
.lyteMIWrapper .lyteCloseIcon::after {
  content: "";
  -webkit-mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -3px -15px;
  mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -3px -15px;
  background-color: #fff;
  width: 6px;
  height: 6px;
  display: inline-block;
...
.lyteNotificationCloseIcon {
  -webkit-mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -323px -161px;
  mask: url(../../../compiledCSS/images/sprite_lyte_night.svg) no-repeat -323px -161px;
  background-color: #666;
  width: 12px;
  height: 12px;
  cursor: pointer;
