...
@import "../themes/default/ui-elements/daterangepicker/daterangepicker.variables.less";
...
@import "../config.less";
@import (optional) "../themes/@{daterangepicker}/ui-elements/daterangepicker/daterangepicker.variables.less";

/* rtl files loading */

@import (multiple,optional) "../themes/default/global/@{direction}.less";

@import (multiple,optional) "../themes/@{daterangepicker}/global/@{direction}.less";


/* Loading final tweaks to your variables */
@import (optional) "../overrides/ui-elements/daterangepicker.variables.less";
...
.lyteDateRangePickerRow .lyteCalendarPopup {
	.DateRangePickerRowCalendarPopupMixin();
	box-shadow: none;
	border: none;
	background: @bg;
}
.lyteDateRangePickerRow lyte-dropdown lyte-drop-button {
	.DateRangePickerRowDropButtonMixin();
	background: @bg;
}
...
.lyteDateRangePickerRow .lyteCalToday {
	.lyteDateRangePickerRowCalTodayMixin();
	background: @bg;
}
...
.lyteDateRPLastDateSelected {
    .DRPSelectedEndPoints();
    color: @color;
}
.lyteDateRPTempSelected:hover {
	.DateRPTempSelectedHover();
	background: @bg;
	color: @color;
	border-radius: @border-radius;
}
...
.lyteDateRPLastDateSelected:focus-visible::before {
	.lyteDateRPTempFirstAndLastDateSelectedFocusVisibleMixin();
	outline: @outline;
	z-index: @z-index;
}
...
.lyteDateRPLastDateSelected:focus-visible .lyteCalDateSpan {
	.lyteDateRPTempFirstAndLastDateSelectedFocusVisibleDateSpanMixin();
	position: relative;
	z-index: @z-index;
}
...
@import (optional) "../themes/@{daterangepicker}/ui-elements/daterangepicker/daterangepicker.styles.less";




/* import custom css - final tweaks by the user */
@import (optional) "../overrides/ui-elements/daterangepicker.overrides.less";
