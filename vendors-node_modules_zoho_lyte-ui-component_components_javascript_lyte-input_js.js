  ...
  mousemove(event) {
        ...
        while(nodeName1 && nodeName1.tagName != 'BODY' && nodeName1 != document && nodeName1.tagName != 'HTML' ){
            ...
            if( title ){
                  ...
                  nodeName1.tooltip.config = _lyte_dom_modules_lyte_dom_utils_js__WEBPACK_IMPORTED_MODULE_1___default().extend( { reuse : false, position : '', appearance : 'callout', margin : 0, showdelay : 0, hidedelay : 0, maxdisplaytime : 5000, keeptooltip : false, aria :  false || this.data.ltPropAria, hideOnClick : true, startClass : "", endClass : "", animationClass : "", maxAnimationLimit : 2000 }, this.data.ltPropTooltipConfig || {} );
