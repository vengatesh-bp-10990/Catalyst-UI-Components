...
LyteRadiobuttonComponent._template = "<template tag-name=\"lyte-radiobutton\" @turbo-supported=\"\" @unbound=\"{{lyteUnbound}}\"> <template _new=\"true\" value=\"{{ltPropType}}\" is=\"switch\">      <template case=\"default\" is=\"case\"></template><template case=\"primary\" is=\"case\"></template><template case=\"secondary\" is=\"case\"> <label class=\"{{radioclass}}\" onmouseup=\"{{action('mup',event)}}\"> <input tabindex=\"{{ltPropTabindex}}\" id=\"{{ltPropId}}\" aria-labelledby=\"{{randomId}}\" onkeypress=\"{{action('preventPropagation',event)}}\" type=\"radio\" name=\"{{ltPropName}}\" value=\"{{ltPropValue}}\" data-tabindex=\"{{ltPropDataTabindex}}\" class=\"lyteHide\" onclick=\"{{action('valueChanged',event)}}\" disabled=\"{{expHandlers(ltPropDisabled,'||',ltPropReadOnly)}}\" checked=\"{{ltPropChecked}}\"> <span class=\"{{ltPropClass}}\"> <span class=\"lyteRadioCheck\"> </span> </span> <span class=\"{{ltPropLabelClass}}\" id=\"{{randomId}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"yield\"></lyte-yield> </template><template default=\"\"> {{ltPropLabel}} </template></template> </span> </label> </template><template case=\"switch\" is=\"case\"> <label class=\"\" onmouseup=\"{{action('mup',event)}}\"> <input tabindex=\"{{ltPropTabindex}}\" id=\"{{ltPropId}}\" aria-labelledby=\"{{randomId}}\" onkeypress=\"{{action('preventPropagation',event)}}\" type=\"radio\" name=\"{{ltPropName}}\" value=\"{{ltPropValue}}\" data-tabindex=\"{{ltPropDataTabindex}}\" checked=\"{{ltPropChecked}}\" disabled=\"{{expHandlers(ltPropDisabled,'||',ltPropReadonly)}}\" class=\"lyteHide on-off-sw\" onclick=\"{{action('valueChanged',event)}}\"> <span class=\"{{ltPropClass}}\"> <span class=\"on-btn\"></span> </span> <span class=\"{{ltPropLabelClass}}\" id=\"{{randomId}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"yield\"></lyte-yield> </template><template default=\"\"> {{ltPropLabel}} </template></template> </span> </label> </template><template case=\"slider\" is=\"case\"> <label class=\"lyteRadioSliderLabel\" onmouseup=\"{{action('mup',event)}}\"> <input tabindex=\"{{ltPropTabindex}}\" id=\"{{ltPropId}}\" aria-labelledby=\"{{randomId}}\" onkeypress=\"{{action('preventPropagation',event)}}\" type=\"radio\" name=\"{{ltPropName}}\" data-tabindex=\"{{ltPropDataTabindex}}\" value=\"{{ltPropValue}}\" checked=\"{{ltPropChecked}}\" disabled=\"{{expHandlers(ltPropDisabled,'||',ltPropReadonly)}}\" class=\"lyteHide\" onclick=\"{{action('valueChanged',event)}}\"> <span class=\"{{ltPropClass}}\"> <span class=\"{{ltPropLabelClass}}\" id=\"{{randomId}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"yield\"></lyte-yield> </template><template default=\"\"> {{ltPropLabel}} </template></template> </span> </span> </label> </template><template case=\"checkbox\" is=\"case\"> <label class=\"{{radioclass}}\" onmouseup=\"{{action('mup',event)}}\"> <input tabindex=\"{{ltPropTabindex}}\" id=\"{{ltPropId}}\" aria-labelledby=\"{{randomId}}\" onkeypress=\"{{action('preventPropagation',event)}}\" type=\"radio\" name=\"{{ltPropName}}\" value=\"{{ltPropValue}}\" data-tabindex=\"{{ltPropDataTabindex}}\" class=\"lyteHide\" onclick=\"{{action('valueChanged',event)}}\" disabled=\"{{expHandlers(ltPropDisabled,'||',ltPropReadOnly)}}\" checked=\"{{ltPropChecked}}\"> <span class=\"{{ltPropClass}}\"> <span class=\"lyteRadioCheck\"> </span> </span> <span class=\"{{ltPropLabelClass}}\" onclick=\"{{action('checkboxClick',this,event)}}\" id=\"{{randomId}}\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{ltPropYield}}\" is=\"case\" lc-id=\"lc_id_0\"> <lyte-yield yield-name=\"yield\"></lyte-yield> </template><template default=\"\"> {{ltPropLabel}} </template></template> </span> </label> </template></template> </template>";;
