...
import { Component, objectUtils } from "../../../../@slyte/component/index.js";
            ...
            for (var i = window.LytePopup.components.length - 1; i >= 0; i--) {
                ...
                if (window.LytePopup.components[i].$node.tagName == "LYTE-POPOVER" && window.LytePopup.components[i].childComp.style.visibility == "visible" && !dontClose) {
                    ...
                    if ((popover && popover.component.getData('visible') && popover.component.getData('ltPropCloseOnBodyClick') && !popover.component.getData('dragRunning')) && ((!$L(event.target).closest('lyte-input')[0]) || (!popover.component.getData('ltPropIgnoreInput')) && !closeBoolean)) {
                        if (window._lyteUiUtils.popupStack.globalStack[window._lyteUiUtils.popupStack.globalStack.length - 1].parentElement === window.LytePopup.components[i].$node) {
    ...
    window.addEventListener('scroll', function (event) {    //This is for closing the dropdown when an outside area is clicked(CODE HELP)
        ...
        for (var i = window.LytePopup.components.length - 1; i >= 0; i--) {
            if (window.LytePopup.components[i].$node && window.LytePopup.components[i].$node.nodeName == "LYTE-POPOVER" && window.LytePopup.components[i].childComp.style.visibility == "visible") {
                ...
                if (window.LytePopup.components[i].data.ltPropCloseOnScroll && (!$L(event.target).closest('.popoverWrapper')[0])) {
                    if ($L(event.target).closest('lyte-drop-box')[0] && $L(event.target).closest('lyte-drop-box')[0].origindd.closest('.lytePopover')) {
                        return
                    }
                    window.LytePopup.components[i].event = event
...
class LytePopoverComponent extends Component {
    constructor() {
        super();
        this._lyteUtilFunctions = ['alignPopover', 'calculateOffset', 'trapFocus'];
    }
    ...
    data(arg1) {
        return Object.assign(super.data({
             ...
             * @out
             */
            "ltPropShow": prop("boolean", { "default": false, in: true, out: true }),
             ...
             * @in
             */
            "ltPropType": prop("string", { "default": "callout", in: true, out: false }),
             ...
             * @in
             */
            "ltPropFreeze": prop("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropShowCloseButton": prop("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropCloseOnEscape": prop("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropOriginElem": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropPosition": prop("string", { "default": "bottom", in: true, out: false }),
             ...
             * @in
             */
            "ltPropPlacement": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropDimmer": prop("object", { "default": {}, in: true, out: false }),
             ...
             * @in 
             */
            "ltPropAllowMultiple": prop("boolean", { "default": false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropScrollable": prop("boolean", { "default": false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropMaxHeight": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropMaxWidth": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropWidth": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropHeight": prop("string", { "default": "auto", in: true, out: false }),
             ...
             * @in
             */
            "ltPropWrapperClass": prop("string", { "default": "", in: true, out: false }),
            /**
             ...
             * @in
             */
            "ltPropBoundary": prop("object", { "default": {}, in: true, out: false }),
             ...
             * @in
             */
            "ltPropCloseOnBodyClick": prop("boolean", { "default": true, in: true, out: false }),
             ...
             * @in
             */
            "ltPropDuration": prop("number", { "default": 400, in: true, out: false }),
            /**
             ...
             * @out
             */
            "ltPropOffset": prop("object", { "default": {}, in: true, out: true }),
            ...
            /**
              ...
              * @in
            */
            "ltPropOffsetFromTarget": prop("object", { "default": {}, in: true, out: false }),
             ...
             * @out
             */
            "ltPropBindToBody": prop("boolean", { "default": false, in: true, out: true }),
             ...
             * @in
             */
            "ltPropHeaderPadding": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropContentPadding": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropFooterPadding": prop("string", { "default": "", in: true, out: false }),
             ...
             * @in
             */
            "ltPropAnimation": prop("string", { "default": "fade", in: true, out: false }),
            /**
             ...
             * @in
             */
            "ltPropWindowSpacing": prop("object", { in: true, out: false }),
             ...
             * @in
             */
            "ltPropForceScroll": prop('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropAutoAlign": prop('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropAria": prop('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropAriaAttributes": prop('object', { default: {}, in: true, out: false }),
             ...
             * @in
             */
            "ltPropPreventFocus": prop('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropStopClick": prop('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropIgnoreBoundary": prop('boolean', { default: false, in: true, out: false }),
             ...
             * @in
             */
            "ltPropMargin": prop('object', { in: true, out: false }),
            ...
            "ltPropCloseOnScroll": prop('boolean', {
                default: false, in: true, out: false
            }),
             ...
             * @in
             */
            "ltPropAutoPlacement": prop('boolean', {
                default: false, in: true, out: false
            }),
            ...
            "duringAutoPlacement": prop('object', {
                default: {
                    height: '',
                    width: ''
                }
    ...
    handleMove(e) {
        ...
        if (e.type == "mousedown") {
            window._lyteUiUtils.addGlobalEventListener('mousemove', e.currentTarget.parentEle.handleDrag, true);
            window._lyteUiUtils.addGlobalEventListener('mouseup', e.currentTarget.parentEle.stopDrag, true);
        }
        else if (e.type == "touchstart") {
    ...
    stopDrag(e) {
        ...
        while (targetElem && targetElem !== document) {
            if (targetElem.parentEle) {
                if (e.type == "mouseup") {
                    window._lyteUiUtils.removeGlobalEventListener('mousemove', targetElem.parentEle.handleDrag, true);
                    window._lyteUiUtils.removeGlobalEventListener('mouseup', targetElem.parentEle.stopDrag, true);
    ...
    computeOffsetImpl(event, reAlign) {
        ...
        $L.fastdom.measure(function () {
            if (this.$node.ltProp("showCopy")) {
                if (this.$node.ltProp('originElem') != "" || !(lyteSelf.$registry.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset')))) {
                    var ele = this.$node.ltProp('originElem') ? document.querySelector(this.$node.ltProp('originElem')) : null;
                    if (!ele && lyteSelf.$registry.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset'))) {
                    ...
                    if (lyteSelf.$registry.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset'))) {  //If origin element is present and there is no ltPropOffset
                    ...
                    if (noPlaceAvailable && this.getData('ltPropAutoPlacement')) {
                        objectUtils(this.getData('duringAutoPlacement'), 'width', 'add', this.getData('width'))
                        objectUtils(this.getData('duringAutoPlacement'), 'height', 'add', this.getData('height'))
                        // offObj.offsetLeft = bodyWidth - modalElePosition.width - 10;
    ...
    setOpacityAndVisibility() {
        ...
        window._lyteUiUtils.dispatchEvent('lytePopupOpened', this.$node, this.actualModalDiv)
    ...
    onBeforeCloseHandling(event) {
        ...
        if (result === undefined || result) {
            ...
            if (this.getData('ltPropDuration') == undefined) {
                ...
                window._lyteUiUtils.dispatchEvent('lytePopupClosed', this.$node, this.actualModalDiv)
        ...
        if (result === undefined || result) {
            ...
            $L.fastdom.measure(function () {
                ...
                if (this.getData('ltPropHostElement') !== "") {
                    ...
                    scrollParent = this.$node.ltProp('originElem') ? window.LytePopup.getScrollParent($L(this.getData('ltPropHostElement'))[0].shadowRoot.querySelector(this.getData('ltPropOriginElem'))) : null;
            ...
            showToggled: function () {
                ...
                if (this.$node.ltProp("show") && !this.$node.ltProp("showCopy")) {
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('left')) {
                        objectUtils(this.getData('windowSpacing'), 'add', 'left', this.getData('ltPropWindowSpacing').left)
                    }
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('right')) {
                        objectUtils(this.getData('windowSpacing'), 'add', 'right', this.getData('ltPropWindowSpacing').right)
                    }
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('bottom')) {
                        objectUtils(this.getData('windowSpacing'), 'add', 'bottom', this.getData('ltPropWindowSpacing').bottom)
                    }
                    if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('top')) {
                        objectUtils(this.getData('windowSpacing'), 'add', 'top', this.getData('ltPropWindowSpacing').top)
                    }
...
if (document.readyState === "complete" || document.readyState === "interactive") {
    ...
    window._lyteUiUtils.addGlobalEventListener("DOMContentLoaded", function (event) {
