...
class LyteTableComponent extends includeMixins([LyteTableUtilsMixin, LyteTableSortableMixin], Component) {
    ...
    data(arg1) {
        ...
        return Object.assign(super.data({
             ...
             * @version 3.53.0
             */
            ltPropSortDummyColumnClass : prop( 'string', { default : default_values.sortDummyColumnClass || "" } ),
            ...
            ltPropResizeAria : prop( 'object', { default : default_values.resizeAria || { "role" : "button", "aria-live" : "assertive" } } ),
            /**
             ...
             * @version 3.103.0
             */
            ltPropCellAria : prop( 'object', { default : default_values.cellAria || { "aria-live" : "assertive" } }  ),

            ltPropCellIntersection : prop( 'boolean', { default : false } ),
            ltPropScrollElement : prop( 'string' ),
            ltPropSanitizer : prop( 'object', { default : { force : false } } ),
            ltPropResizeFixedColumn : prop( 'boolean', { default : false } ),

            ltPropCustomCopy : prop( 'boolean', { default : false } ),
            ...
            visibleStatus : prop( 'object', { default : {} } ),
            fixedColumnLength : prop( 'number', { default : 0 } ),
            fixedColumnStatus : prop( 'object' )
        }), arg1);
    }
