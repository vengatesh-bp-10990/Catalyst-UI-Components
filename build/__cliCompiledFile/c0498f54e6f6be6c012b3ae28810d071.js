...
LyteUiComponentComponentRegistry.registerHelper('lyteTThasChildHelper' , function(obj){
	if((!obj.children || obj.children.length < 1) && !obj.hasChild){
		return 'lyteTreeTableLeafNode'
	}
})

LyteUiComponentComponentRegistry.registerHelper('lyteTTIconHelper' , function(obj){
	if(obj){
...
LyteUiComponentComponentRegistry.registerHelper('lyteUiColorboxAddClass',function(wrapperClass,elem){	
...
LyteUiComponentComponentRegistry.registerHelper('lyteUiReturnValueBy',function(content,key){
	if(key || key == 0){
		return content[key]
	}
	else{
...
LyteUiComponentComponentRegistry.registerHelper('lyteUiGetValue',function(object, key){
	return object[key]
});
...
LyteUiComponentComponentRegistry.registerHelper("lyteTreeSubGroupHelper" , function(obj){
...
LyteUiComponentComponentRegistry.registerHelper('lyteDataTreeKeywordParsing' , function(elem){
	if(elem === null){
		return 'null'
	}
	if(elem === undefined){
...
LyteUiComponentComponentRegistry.registerHelper('lyteUiProgressbarLabel',function(label,percentage,showPercentage,ShowValue){ //used in progressbar
 	if(label){
 		return label;
 	}
...
LyteUiComponentComponentRegistry.registerHelper('lyteUiCapitalizeName', function(name){
...
LyteUiComponentComponentRegistry.registerHelper("lyteUiGetChkboxGrpId", function () {
...
LyteUiComponentComponentRegistry.registerHelper("lyteUiGetMultiDropNMoreId", function () {
	var dropButtonId = this.$node.getData('multiDropId');
	return ('lyteNMoreTagFor' + dropButtonId)
});

LyteUiComponentComponentRegistry.registerHelper("lyteUiGetDropdownLabelId", function () {
...
LyteUiComponentComponentRegistry.registerHelper("lyteUiGetComboboxLabelId", function () {
...
LyteUiComponentComponentRegistry.registerHelper("lyteUiGetTextId", function () {
	if (this.$node.id) {
		var id = this.$node.id;
		return id;
	}
