  ...
  static actions(arg1) {
    return Object.assign(super.actions({
      ...
      onSearchInput(event, lyteElement) {
        let val = lyteElement ? lyteElement.getData('ltPropValue') : (event && event.target ? event.target.value : '');
