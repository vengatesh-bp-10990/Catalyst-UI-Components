...
import './popover/lyte-beta-popover.js';
...
class LyteHovercardComponent extends Component {
  constructor() {
    super();
    this._lyteUtilFunctions = ["alignHovercard","calculateOffset"];
  }
    ...
    return Object.assign(super.data({
       ...
       */
        ...
        */
        ...
        "ltPropCloseOnScroll" : prop('boolean', {default: true}),
        "ltPropUseBetaPopover" : prop('boolean', { default : false}),
        'mousePosition' : prop( 'array', { 'default' : [] } ),
        'mouseover' : prop( 'boolean', { 'default' : false } ),
        'originEle' : prop( 'string', { 'default' : ''}),
        'popoverTagName' : prop('string', {'default':'lyte-popover'})
    }), arg1);   
  }

  init() {
    if( window._lyteUiUtils.isWidget ){
      this.setData('ltPropAutoShow', false)
    } 
        ...
        if (mutation.type === 'childList') {
          for(let i =0; i < mutation.removedNodes.length; i++){
            ...
            if (removedNode === originElement) {
                ...
                window._lyteUiUtils.lyteHovercard && window._lyteUiUtils.lyteHovercard[ this.getData('ltPropOriginElem') ] && delete window._lyteUiUtils.lyteHovercard[ this.getData('ltPropOriginElem') ]
  ...
  removeHoverCard(popover, originElem, event, popoverWormhole, target) {
    var res = true
  ...
  static observers(arg1) {
    return Object.assign(super.observers({
      ...
      originEleObs : function(arg){
        ...
        if( arg.oldValue && window._lyteUiUtils.lyteHovercard){
