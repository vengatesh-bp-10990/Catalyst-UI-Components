...
LyteNavigatorComponent._template = "<template tag-name=\"lyte-navigator\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropType,'==',&quot;default&quot;)}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteNavigator\" onclick=\"{{action('clickEvent',event)}}\" role=\"navigation\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropYield,'==',false)}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteDoubleBack lyteIconDoubleBack\" role=\"button\" aria-label=\"start\"></div> <div class=\"lyteSingleBack lyteIconSingleBack\" role=\"button\" aria-label=\"previous\"></div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropShowOnlyIcon,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteNavigatorMidPoint\">{{startRecord}} <span class=\"lyteNavigatorText\">{{ltPropMiddleText}}</span> {{endRecord}}</div> </template></template><div class=\"lyteSingleFront lyteIconSingleFront\" role=\"button\" aria-label=\"next\"></div> <div class=\"lyteDoubleFront lyteIconDoubleFront\" role=\"button\" aria-label=\"end\"></div> </template><template default=\"\"> <lyte-yield yield-name=\"navigatorYield\" start-record=\"{{startRecord}}\" end-record=\"{{endRecord}}\"></lyte-yield> </template></template></div> </template></template><template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropType,'==',&quot;simple&quot;)}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lyteNavigator\" onclick=\"{{action('clickEvent',event)}}\" role=\"navigation\"> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropYield,'==',false)}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lytepagination\"> <div class=\"lyteNavArrow lyteDoubleBack hover\" role=\"button\" aria-label=\"start\"></div> <div class=\"lyteNavArrow lyteSingleBack hover\" role=\"button\" aria-label=\"previous\"> </div> <template is=\"switch\" l-c=\"true\" _new=\"true\"><template case=\"{{expHandlers(ltPropShowOnlyIcon,'!')}}\" is=\"case\" lc-id=\"lc_id_0\"> <div class=\"lytepage\"> <template is=\"for\" items=\"{{paginationRange}}\" item=\"page\" indexval=\"pageno\"> <div data-value=\"{{page}}\" class=\"lytesimple\" role=\"button\" aria-label=\"{{page}}\">{{unescape(page)}}</div> </template> </div> </template></template><div class=\"lyteNavArrow lyteSingleFront hover\" role=\"button\" aria-label=\"next\"> </div> <div class=\"lyteNavArrow lyteDoubleFront hover\" role=\"button\" aria-label=\"end\"></div> </div> </template><template default=\"\"> <lyte-yield yield-name=\"navigatorYield\" pagination-range=\"{{paginationRange}}\"></lyte-yield> </template></template></div> </template></template></template>";;
LyteNavigatorComponent._dynamicNodes = [{"t":"s","p":[1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"s","p":[5],"c":{"lc_id_0":{"dN":[{"t":"tX","p":[1,0],"cn":"lc_id_0"},{"t":"tX","p":[1,2,0],"cn":"lc_id_0"},{"t":"tX","p":[1,4],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"i","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"s","p":[2],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"s","p":[1,1],"c":{"lc_id_0":{"dN":[{"t":"s","p":[1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{"dN":[{"t":"a","p":[1],"cn":"default"},{"t":"i","p":[1],"in":0,"cn":"default"}]},"dc":{"lc_id_0":{},"default":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0,"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{"dc":[0],"hc":true,"trans":true}},"hd":true,"co":["lc_id_0"],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[1,0]}];;

LyteNavigatorComponent._observedAttributes = [
    "ltPropPerpage",
    "ltPropValue",
    "ltPropRecords",
    "ltPropMoreRecords",
...
LyteNavigatorComponent.register("lyte-navigator", {
    hash: "LyteNavigatorComponent_4",
